...
To use the OAuth feature, you can refer to [public-oauth.md](https://github.com/twilio/twilio-go/advanced-examples/public-oauth.md) for an example of how to implement it in your application.
