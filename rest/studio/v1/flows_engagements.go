...
func (c *ApiService) CreateEngagement(FlowSid string, params *CreateEngagementParams) (*StudioV1Engagement, error) {
	return c.CreateEngagementWithContext(context.TODO(), FlowSid, params)
}
func (c *ApiService) CreateEngagementWithContext(ctx context.Context, FlowSid string, params *CreateEngagementParams) (*StudioV1Engagement, error) {
...
func (c *ApiService) DeleteEngagement(FlowSid string, Sid string) error {
	return c.DeleteEngagementWithContext(context.TODO(), FlowSid, Sid)
}
func (c *ApiService) DeleteEngagementWithContext(ctx context.Context, FlowSid string, Sid string) error {
...
func (c *ApiService) FetchEngagement(FlowSid string, Sid string) (*StudioV1Engagement, error) {
	return c.FetchEngagementWithContext(context.TODO(), FlowSid, Sid)
}
func (c *ApiService) FetchEngagementWithContext(ctx context.Context, FlowSid string, Sid string) (*StudioV1Engagement, error) {
	path := "/v1/Flows/{FlowSid}/Engagements/{Sid}"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageEngagement(FlowSid string, params *ListEngagementParams, pageToken, pageNumber string) (*ListEngagementResponse, error) {
	return c.PageEngagementWithContext(context.TODO(), FlowSid, params, pageToken, pageNumber)
}

// Retrieve a single page of Engagement records from the API. Request is executed immediately.
func (c *ApiService) PageEngagementWithContext(ctx context.Context, FlowSid string, params *ListEngagementParams, pageToken, pageNumber string) (*ListEngagementResponse, error) {
	path := "/v1/Flows/{FlowSid}/Engagements"
...
func (c *ApiService) ListEngagement(FlowSid string, params *ListEngagementParams) ([]StudioV1Engagement, error) {
	return c.ListEngagementWithContext(context.TODO(), FlowSid, params)
}

// Lists Engagement records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListEngagementWithContext(ctx context.Context, FlowSid string, params *ListEngagementParams) ([]StudioV1Engagement, error) {
	response, errors := c.StreamEngagementWithContext(ctx, FlowSid, params)
...
func (c *ApiService) StreamEngagement(FlowSid string, params *ListEngagementParams) (chan StudioV1Engagement, chan error) {
	return c.StreamEngagementWithContext(context.TODO(), FlowSid, params)
}

// Streams Engagement records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamEngagementWithContext(ctx context.Context, FlowSid string, params *ListEngagementParams) (chan StudioV1Engagement, chan error) {
	if params == nil {
	...
	response, err := c.PageEngagementWithContext(ctx, FlowSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamEngagementWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamEngagementWithContext(ctx context.Context, response *ListEngagementResponse, params *ListEngagementParams, recordChannel chan StudioV1Engagement, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListEngagementResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListEngagementResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
