...
// CreateEngagementWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateEngagementWithMetadata(FlowSid string, params *CreateEngagementParams) (*metadata.ResourceMetadata[StudioV1Engagement], error) {
	path := "/v1/Flows/{FlowSid}/Engagements"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[StudioV1Engagement](
...
// DeleteEngagementWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteEngagementWithMetadata(FlowSid string, Sid string) (*metadata.ResourceMetadata[bool], error) {
	path := "/v1/Flows/{FlowSid}/Engagements/{Sid}"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// FetchEngagementWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchEngagementWithMetadata(FlowSid string, Sid string) (*metadata.ResourceMetadata[StudioV1Engagement], error) {
	path := "/v1/Flows/{FlowSid}/Engagements/{Sid}"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// PageEngagementWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageEngagementWithMetadata(FlowSid string, params *ListEngagementParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListEngagementResponse], error) {
	path := "/v1/Flows/{FlowSid}/Engagements"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListEngagementResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListEngagementWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListEngagementWithMetadata(FlowSid string, params *ListEngagementParams) (*metadata.ResourceMetadata[[]StudioV1Engagement], error) {
	response, errors := c.StreamEngagementWithMetadata(FlowSid, params)
...
// StreamEngagementWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamEngagementWithMetadata(FlowSid string, params *ListEngagementParams) (*metadata.ResourceMetadata[chan StudioV1Engagement], chan error) {
	if params == nil {
		params = &ListEngagementParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageEngagementWithMetadata(FlowSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamEngagement(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan StudioV1Engagement](
