...
func (c *ApiService) CreateExecutionWithMetadata(FlowSid string, params *CreateExecutionParams) (*metadata.ResourceMetadata[StudioV1Execution], error) {
	path := "/v1/Flows/{FlowSid}/Executions"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[StudioV1Execution](
...
func (c *ApiService) FetchExecutionWithMetadata(FlowSid string, Sid string) (*metadata.ResourceMetadata[StudioV1Execution], error) {
	path := "/v1/Flows/{FlowSid}/Executions/{Sid}"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListExecutionWithMetadata(FlowSid string, params *ListExecutionParams) (*metadata.ResourceMetadata[[]StudioV1Execution], error) {
...
func (c *ApiService) StreamExecutionWithMetadata(FlowSid string, params *ListExecutionParams) (*metadata.ResourceMetadata[chan StudioV1Execution], chan error) {
	if params == nil {
		params = &ListExecutionParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan StudioV1Execution](
...
func (c *ApiService) UpdateExecutionWithMetadata(FlowSid string, Sid string, params *UpdateExecutionParams) (*metadata.ResourceMetadata[StudioV1Execution], error) {
	path := "/v1/Flows/{FlowSid}/Executions/{Sid}"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
