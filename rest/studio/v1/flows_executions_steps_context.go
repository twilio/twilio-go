...
func (c *ApiService) FetchExecutionStepContextWithContext(ctx context.Context, FlowSid string, ExecutionSid string, StepSid string) (*StudioV1ExecutionStepContext, error) {
