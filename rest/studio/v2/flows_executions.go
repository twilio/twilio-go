...
func (c *ApiService) CreateExecutionWithContext(ctx context.Context, FlowSid string, params *CreateExecutionParams) (*StudioV2Execution, error) {
...
func (c *ApiService) FetchExecutionWithContext(ctx context.Context, FlowSid string, Sid string) (*StudioV2Execution, error) {
	path := "/v2/Flows/{FlowSid}/Executions/{Sid}"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Execution records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListExecutionWithContext(ctx context.Context, FlowSid string, params *ListExecutionParams) ([]StudioV2Execution, error) {
...
// Streams Execution records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamExecutionWithContext(ctx context.Context, FlowSid string, params *ListExecutionParams) (chan StudioV2Execution, chan error) {
	if params == nil {
...
func (c *ApiService) streamExecutionWithContext(ctx context.Context, response *ListExecutionResponse, params *ListExecutionParams, recordChannel chan StudioV2Execution, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateExecutionWithContext(ctx context.Context, FlowSid string, Sid string, params *UpdateExecutionParams) (*StudioV2Execution, error) {
	path := "/v2/Flows/{FlowSid}/Executions/{Sid}"
	path = strings.Replace(path, "{"+"FlowSid"+"}", FlowSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
