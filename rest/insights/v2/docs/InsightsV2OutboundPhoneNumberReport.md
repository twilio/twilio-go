...
**CallStatePercentage** | Pointer to [**InsightsV2OutboundPhoneNumberReportCallStatePercentage**](InsightsV2OutboundPhoneNumberReportCallStatePercentage.md) |  |
...
**AnsweringMachineDetection** | Pointer to [**InsightsV2OutboundPhoneNumberReportAnsweringMachineDetection**](InsightsV2OutboundPhoneNumberReportAnsweringMachineDetection.md) |  |
