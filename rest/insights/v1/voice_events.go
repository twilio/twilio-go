...
func (c *ApiService) EventPage(CallSid string, params *ListEventParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Voice/{CallSid}/Events"
	path = strings.Replace(path, "{"+"CallSid"+"}", CallSid, -1)
...
func (c *ApiService) EventStream(CallSid string, params *ListEventParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EventPage(CallSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) EventList(CallSid string, params *ListEventParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EventPage(CallSid, params, "", "", fmt.Sprint(limits.PageSize))
