...
func (c *ApiService) ListCredential(params *ListCredentialParams, limit int) ([]NotifyV1Credential, error) {
...
func (c *ApiService) StreamCredential(params *ListCredentialParams, limit int) (chan NotifyV1Credential, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
