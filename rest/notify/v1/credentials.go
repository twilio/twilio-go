...
//
func (c *ApiService) CreateCredentialWithCtx(ctx context.Context, params *CreateCredentialParams) (*NotifyV1Credential, error) {
	path := "/v1/Credentials"
...
//
func (c *ApiService) FetchCredentialWithCtx(ctx context.Context, Sid string) (*NotifyV1Credential, error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Credential records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListCredentialWithCtx(ctx context.Context, params *ListCredentialParams) ([]NotifyV1Credential, error) {
...
// Streams Credential records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamCredentialWithCtx(ctx context.Context, params *ListCredentialParams) (chan NotifyV1Credential, chan error) {
	if params == nil {
...
func (c *ApiService) streamCredential(ctx context.Context, response *ListCredentialResponse, params *ListCredentialParams, recordChannel chan NotifyV1Credential, errorChannel chan error) {
	curRecord := 1
...
//
func (c *ApiService) UpdateCredentialWithCtx(ctx context.Context, Sid string, params *UpdateCredentialParams) (*NotifyV1Credential, error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
