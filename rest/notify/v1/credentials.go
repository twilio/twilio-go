...
func (c *ApiService) CreateCredentialWithMetadata(params *CreateCredentialParams) (*metadata.ResourceMetadata[NotifyV1Credential], error) {
	path := "/v1/Credentials"
	...
	metadataWrapper := metadata.NewResourceMetadata[NotifyV1Credential](
...
func (c *ApiService) FetchCredentialWithMetadata(Sid string) (*metadata.ResourceMetadata[NotifyV1Credential], error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListCredentialWithMetadata(params *ListCredentialParams) (*metadata.ResourceMetadata[[]NotifyV1Credential], error) {
...
func (c *ApiService) StreamCredentialWithMetadata(params *ListCredentialParams) (*metadata.ResourceMetadata[chan NotifyV1Credential], chan error) {
	if params == nil {
		params = &ListCredentialParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan NotifyV1Credential](
...
func (c *ApiService) UpdateCredentialWithMetadata(Sid string, params *UpdateCredentialParams) (*metadata.ResourceMetadata[NotifyV1Credential], error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
