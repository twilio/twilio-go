...
func (c *ApiService) ExportCustomJobPage(ResourceType string, params *ListExportCustomJobParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Exports/{ResourceType}/Jobs"
	path = strings.Replace(path, "{"+"ResourceType"+"}", ResourceType, -1)
...
func (c *ApiService) ExportCustomJobStream(ResourceType string, params *ListExportCustomJobParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ExportCustomJobPage(ResourceType, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) ExportCustomJobList(ResourceType string, params *ListExportCustomJobParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ExportCustomJobPage(ResourceType, params, "", "", fmt.Sprint(limits.PageSize))
