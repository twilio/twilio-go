...
**UserName** | **string** | Unique username, MUST be same as primary email address |[optional] 
**DisplayName** | **string** | User friendly display name |[optional] 
**Name** | [**IamScimName**](IamScimName.md) |  |[optional] 
**Emails** | [**[]IamScimEmailAddress**](IamScimEmailAddress.md) | Email address list of the user. Primary email must be defined if there are more than 1 email. Primary email must match the username. |[optional] 
...
**Meta** | [**IamScimMeta**](IamScimMeta.md) |  |[optional] 
