...
func (c *ApiService) ListEvent(params *ListEventParams, limit *int) ([]*ListEventResponse, error) {
...
func (c *ApiService) StreamEvent(params *ListEventParams, limit *int) (chan *ListEventResponse, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
