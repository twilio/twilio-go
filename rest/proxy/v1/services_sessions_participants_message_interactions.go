...
func (c *ApiService) MessageInteractionPage(ServiceSid string, SessionSid string, ParticipantSid string, params *ListMessageInteractionParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Services/{ServiceSid}/Sessions/{SessionSid}/Participants/{ParticipantSid}/MessageInteractions"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"SessionSid"+"}", SessionSid, -1)
	path = strings.Replace(path, "{"+"ParticipantSid"+"}", ParticipantSid, -1)
...
func (c *ApiService) MessageInteractionStream(ServiceSid string, SessionSid string, ParticipantSid string, params *ListMessageInteractionParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.MessageInteractionPage(ServiceSid, SessionSid, ParticipantSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) MessageInteractionList(ServiceSid string, SessionSid string, ParticipantSid string, params *ListMessageInteractionParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.MessageInteractionPage(ServiceSid, SessionSid, ParticipantSid, params, "", "", fmt.Sprint(limits.PageSize))
