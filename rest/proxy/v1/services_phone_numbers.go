...
func (c *ApiService) CreatePhoneNumberWithMetadata(ServiceSid string, params *CreatePhoneNumberParams) (*metadata.ResourceMetadata[ProxyV1PhoneNumber], error) {
	path := "/v1/Services/{ServiceSid}/PhoneNumbers"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ProxyV1PhoneNumber](
...
func (c *ApiService) FetchPhoneNumberWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[ProxyV1PhoneNumber], error) {
	path := "/v1/Services/{ServiceSid}/PhoneNumbers/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListPhoneNumberWithMetadata(ServiceSid string, params *ListPhoneNumberParams) (*metadata.ResourceMetadata[[]ProxyV1PhoneNumber], error) {
...
func (c *ApiService) StreamPhoneNumberWithMetadata(ServiceSid string, params *ListPhoneNumberParams) (*metadata.ResourceMetadata[chan ProxyV1PhoneNumber], chan error) {
	if params == nil {
		params = &ListPhoneNumberParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ProxyV1PhoneNumber](
...
func (c *ApiService) UpdatePhoneNumberWithMetadata(ServiceSid string, Sid string, params *UpdatePhoneNumberParams) (*metadata.ResourceMetadata[ProxyV1PhoneNumber], error) {
	path := "/v1/Services/{ServiceSid}/PhoneNumbers/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
