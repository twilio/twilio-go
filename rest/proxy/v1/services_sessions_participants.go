...
func (c *ApiService) CreateParticipant(ServiceSid string, SessionSid string, params *CreateParticipantParams) (*ProxyV1Participant, error) {
	return c.CreateParticipantWithCtx(context.TODO(), ServiceSid, SessionSid, params)
}

// Add a new Participant to the Session
func (c *ApiService) CreateParticipantWithCtx(ctx context.Context, ServiceSid string, SessionSid string, params *CreateParticipantParams) (*ProxyV1Participant, error) {
...
func (c *ApiService) DeleteParticipant(ServiceSid string, SessionSid string, Sid string) error {
	return c.DeleteParticipantWithCtx(context.TODO(), ServiceSid, SessionSid, Sid)
}

// Delete a specific Participant. This is a soft-delete. The participant remains associated with the session and cannot be re-added. Participants are only permanently deleted when the [Session](https://www.twilio.com/docs/proxy/api/session) is deleted.
func (c *ApiService) DeleteParticipantWithCtx(ctx context.Context, ServiceSid string, SessionSid string, Sid string) error {
...
func (c *ApiService) FetchParticipant(ServiceSid string, SessionSid string, Sid string) (*ProxyV1Participant, error) {
	return c.FetchParticipantWithCtx(context.TODO(), ServiceSid, SessionSid, Sid)
}

// Fetch a specific Participant.
func (c *ApiService) FetchParticipantWithCtx(ctx context.Context, ServiceSid string, SessionSid string, Sid string) (*ProxyV1Participant, error) {
	path := "/v1/Services/{ServiceSid}/Sessions/{SessionSid}/Participants/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"SessionSid"+"}", SessionSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageParticipant(ServiceSid string, SessionSid string, params *ListParticipantParams, pageToken, pageNumber string) (*ListParticipantResponse, error) {
	return c.PageParticipantWithCtx(context.TODO(), ServiceSid, SessionSid, params, pageToken, pageNumber)
}

// Retrieve a single page of Participant records from the API. Request is executed immediately.
func (c *ApiService) PageParticipantWithCtx(ctx context.Context, ServiceSid string, SessionSid string, params *ListParticipantParams, pageToken, pageNumber string) (*ListParticipantResponse, error) {
	path := "/v1/Services/{ServiceSid}/Sessions/{SessionSid}/Participants"
...
func (c *ApiService) ListParticipant(ServiceSid string, SessionSid string, params *ListParticipantParams) ([]ProxyV1Participant, error) {
	return c.ListParticipantWithCtx(context.TODO(), ServiceSid, SessionSid, params)
}

// Lists Participant records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListParticipantWithCtx(ctx context.Context, ServiceSid string, SessionSid string, params *ListParticipantParams) ([]ProxyV1Participant, error) {
	response, errors := c.StreamParticipantWithCtx(ctx, ServiceSid, SessionSid, params)
...
func (c *ApiService) StreamParticipant(ServiceSid string, SessionSid string, params *ListParticipantParams) (chan ProxyV1Participant, chan error) {
	return c.StreamParticipantWithCtx(context.TODO(), ServiceSid, SessionSid, params)
}

// Streams Participant records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamParticipantWithCtx(ctx context.Context, ServiceSid string, SessionSid string, params *ListParticipantParams) (chan ProxyV1Participant, chan error) {
	if params == nil {
	...
	response, err := c.PageParticipantWithCtx(ctx, ServiceSid, SessionSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamParticipant(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamParticipant(ctx context.Context, response *ListParticipantResponse, params *ListParticipantParams, recordChannel chan ProxyV1Participant, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithCtx(ctx, c.baseURL, response, c.getNextListParticipantResponse)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListParticipantResponse(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
