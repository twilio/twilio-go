...
// CreateOriginationUrlWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateOriginationUrlWithMetadata(TrunkSid string, params *CreateOriginationUrlParams) (*metadata.ResourceMetadata[TrunkingV1OriginationUrl], error) {
	path := "/v1/Trunks/{TrunkSid}/OriginationUrls"
	path = strings.Replace(path, "{"+"TrunkSid"+"}", TrunkSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[TrunkingV1OriginationUrl](
...
// DeleteOriginationUrlWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteOriginationUrlWithMetadata(TrunkSid string, Sid string) (*metadata.ResourceMetadata[bool], error) {
	path := "/v1/Trunks/{TrunkSid}/OriginationUrls/{Sid}"
	path = strings.Replace(path, "{"+"TrunkSid"+"}", TrunkSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// FetchOriginationUrlWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchOriginationUrlWithMetadata(TrunkSid string, Sid string) (*metadata.ResourceMetadata[TrunkingV1OriginationUrl], error) {
	path := "/v1/Trunks/{TrunkSid}/OriginationUrls/{Sid}"
	path = strings.Replace(path, "{"+"TrunkSid"+"}", TrunkSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// PageOriginationUrlWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageOriginationUrlWithMetadata(TrunkSid string, params *ListOriginationUrlParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListOriginationUrlResponse], error) {
	path := "/v1/Trunks/{TrunkSid}/OriginationUrls"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListOriginationUrlResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListOriginationUrlWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListOriginationUrlWithMetadata(TrunkSid string, params *ListOriginationUrlParams) (*metadata.ResourceMetadata[[]TrunkingV1OriginationUrl], error) {
	response, errors := c.StreamOriginationUrlWithMetadata(TrunkSid, params)
...
// StreamOriginationUrlWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamOriginationUrlWithMetadata(TrunkSid string, params *ListOriginationUrlParams) (*metadata.ResourceMetadata[chan TrunkingV1OriginationUrl], chan error) {
	if params == nil {
		params = &ListOriginationUrlParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageOriginationUrlWithMetadata(TrunkSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamOriginationUrl(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan TrunkingV1OriginationUrl](
...
// UpdateOriginationUrlWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) UpdateOriginationUrlWithMetadata(TrunkSid string, Sid string, params *UpdateOriginationUrlParams) (*metadata.ResourceMetadata[TrunkingV1OriginationUrl], error) {
	path := "/v1/Trunks/{TrunkSid}/OriginationUrls/{Sid}"
	path = strings.Replace(path, "{"+"TrunkSid"+"}", TrunkSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
