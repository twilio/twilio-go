...
// CreateRecordingSettingsWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateRecordingSettingsWithMetadata(params *CreateRecordingSettingsParams) (*metadata.ResourceMetadata[VideoV1RecordingSettings], error) {
	path := "/v1/RecordingSettings/Default"
	...
	metadataWrapper := metadata.NewResourceMetadata[VideoV1RecordingSettings](
...
// FetchRecordingSettingsWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchRecordingSettingsWithMetadata() (*metadata.ResourceMetadata[VideoV1RecordingSettings], error) {
	path := "/v1/RecordingSettings/Default"
