...
func (c *ApiService) CompositionPage(params *ListCompositionParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Compositions"
...
func (c *ApiService) CompositionStream(params *ListCompositionParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.CompositionPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) CompositionList(params *ListCompositionParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.CompositionPage(params, "", "", fmt.Sprint(limits.PageSize))
