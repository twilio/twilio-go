...
func (c *ApiService) RoomParticipantPage(RoomSid string, params *ListRoomParticipantParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/v1/Rooms/{RoomSid}/Participants"
	path = strings.Replace(path, "{"+"RoomSid"+"}", RoomSid, -1)
...
func (c *ApiService) RoomParticipantStream(RoomSid string, params *ListRoomParticipantParams, limit int) (chan map[string]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
	page, err := c.RoomParticipantPage(RoomSid, params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) RoomParticipantList(RoomSid string, params *ListRoomParticipantParams, limit int) ([]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
