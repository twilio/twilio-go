...
func (c *ApiService) RoomParticipantPage(RoomSid string, params *ListRoomParticipantParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Rooms/{RoomSid}/Participants"
	path = strings.Replace(path, "{"+"RoomSid"+"}", RoomSid, -1)
...
func (c *ApiService) RoomParticipantStream(RoomSid string, params *ListRoomParticipantParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.RoomParticipantPage(RoomSid, params, "", "", fmt.Sprint(limits.PageSize))
	return c.requestHandler.Stream(page, limits.Limit, limits.PageLimit)
}

//Lists RoomParticipant records from the API as a list. Unlike stream, this operation is eager and will loads 'limit' records into memory before returning.
func (c *ApiService) RoomParticipantList(RoomSid string, params *ListRoomParticipantParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.RoomParticipantPage(RoomSid, params, "", "", fmt.Sprint(limits.PageSize))
