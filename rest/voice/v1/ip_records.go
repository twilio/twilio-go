...
func (c *ApiService) IpRecordPage(params *ListIpRecordParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/IpRecords"
...
func (c *ApiService) IpRecordStream(params *ListIpRecordParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.IpRecordPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) IpRecordList(params *ListIpRecordParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.IpRecordPage(params, "", "", fmt.Sprint(limits.PageSize))
