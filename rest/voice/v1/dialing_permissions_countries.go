...
func (c *ApiService) DialingPermissionsCountryPage(params *ListDialingPermissionsCountryParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/DialingPermissions/Countries"
...
func (c *ApiService) DialingPermissionsCountryStream(params *ListDialingPermissionsCountryParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.DialingPermissionsCountryPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) DialingPermissionsCountryList(params *ListDialingPermissionsCountryParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.DialingPermissionsCountryPage(params, "", "", fmt.Sprint(limits.PageSize))
