...
func (c *ApiService) FetchVoiceCountryWithMetadata(IsoCountry string) (*metadata.ResourceMetadata[PricingV2VoiceCountryInstance], error) {
	path := "/v2/Voice/Countries/{IsoCountry}"
	path = strings.Replace(path, "{"+"IsoCountry"+"}", IsoCountry, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[PricingV2VoiceCountryInstance](
...
func (c *ApiService) ListVoiceCountryWithMetadata(params *ListVoiceCountryParams) (*metadata.ResourceMetadata[[]PricingV2VoiceCountry], error) {
	...
	metadataWrapper := metadata.NewResourceMetadata[[]PricingV2VoiceCountry](
		records,
...
func (c *ApiService) StreamVoiceCountryWithMetadata(params *ListVoiceCountryParams) (*metadata.ResourceMetadata[chan PricingV2VoiceCountry], chan error) {
	if params == nil {
		params = &ListVoiceCountryParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan PricingV2VoiceCountry](
