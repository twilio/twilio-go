...
func (c *ApiService) FetchTrunkingNumber(DestinationNumber string, params *FetchTrunkingNumberParams) (*PricingV2TrunkingNumber, error) {
	return c.FetchTrunkingNumberWithContext(context.TODO(), DestinationNumber, params)
}
func (c *ApiService) FetchTrunkingNumberWithContext(ctx context.Context, DestinationNumber string, params *FetchTrunkingNumberParams) (*PricingV2TrunkingNumber, error) {
