...
func (params *ListInstalledAddOnExtensionParams) SetPageSize(PageSize int64) *ListInstalledAddOnExtensionParams {
	params.PageSize = &PageSize
	return params
}
func (params *ListInstalledAddOnExtensionParams) SetLimit(Limit int64) *ListInstalledAddOnExtensionParams {
	params.Limit = &Limit
	return params
}
