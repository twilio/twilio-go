...
func (c *ApiService) BundlePage(params *ListBundleParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v2/RegulatoryCompliance/Bundles"
...
func (c *ApiService) BundleStream(params *ListBundleParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.BundlePage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) BundleList(params *ListBundleParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.BundlePage(params, "", "", fmt.Sprint(limits.PageSize))
