...
// Fetch a specific End-User Type Instance.
func (c *ApiService) FetchEndUserTypeWithCtx(ctx context.Context, Sid string) (*NumbersV2EndUserType, error) {
...
// Lists EndUserType records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListEndUserTypeWithCtx(ctx context.Context, params *ListEndUserTypeParams) ([]NumbersV2EndUserType, error) {
...
// Streams EndUserType records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamEndUserTypeWithCtx(ctx context.Context, params *ListEndUserTypeParams) (chan NumbersV2EndUserType, chan error) {
	if params == nil {
...
func (c *ApiService) streamEndUserType(ctx context.Context, response *ListEndUserTypeResponse, params *ListEndUserTypeParams, recordChannel chan NumbersV2EndUserType, errorChannel chan error) {
	curRecord := 1
