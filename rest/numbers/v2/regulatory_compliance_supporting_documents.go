...
func (c *ApiService) SupportingDocumentPage(params *ListSupportingDocumentParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v2/RegulatoryCompliance/SupportingDocuments"
...
func (c *ApiService) SupportingDocumentStream(params *ListSupportingDocumentParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.SupportingDocumentPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) SupportingDocumentList(params *ListSupportingDocumentParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.SupportingDocumentPage(params, "", "", fmt.Sprint(limits.PageSize))
