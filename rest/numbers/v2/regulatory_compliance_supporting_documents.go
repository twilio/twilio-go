...
func (c *ApiService) CreateSupportingDocumentWithMetadata(params *CreateSupportingDocumentParams) (*metadata.ResourceMetadata[NumbersV2SupportingDocument], error) {
	path := "/v2/RegulatoryCompliance/SupportingDocuments"
	...
	metadataWrapper := metadata.NewResourceMetadata[NumbersV2SupportingDocument](
...
func (c *ApiService) FetchSupportingDocumentWithMetadata(Sid string) (*metadata.ResourceMetadata[NumbersV2SupportingDocument], error) {
	path := "/v2/RegulatoryCompliance/SupportingDocuments/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListSupportingDocumentWithMetadata(params *ListSupportingDocumentParams) (*metadata.ResourceMetadata[[]NumbersV2SupportingDocument], error) {
...
func (c *ApiService) StreamSupportingDocumentWithMetadata(params *ListSupportingDocumentParams) (*metadata.ResourceMetadata[chan NumbersV2SupportingDocument], chan error) {
	if params == nil {
		params = &ListSupportingDocumentParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan NumbersV2SupportingDocument](
...
func (c *ApiService) UpdateSupportingDocumentWithMetadata(Sid string, params *UpdateSupportingDocumentParams) (*metadata.ResourceMetadata[NumbersV2SupportingDocument], error) {
	path := "/v2/RegulatoryCompliance/SupportingDocuments/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
