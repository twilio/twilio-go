...
------------ | ------------- | ------------- | -------------
**RoutingTableSid** | **string** | The unique identifier of the Sender ID Country. |
**IsoCountry** | **string** | The ISO country code. |
**DateCreated** | [**time.Time**](time.Time.md) | The date and time when the country routing table was created. |
