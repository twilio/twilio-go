...
------------ | ------------- | ------------- | -------------
**Sid** | **string** | The unique identifier of the Short Code Application. |[optional] 
**ApplicationRequirementsSid** | **string** | The Application Requirements SID. |[optional] 
**ApplicationRequirementsVersion** | **int** | The version of the application requirements. |[optional] 
**AccountSid** | **string** | The Account SID associated with the application. |[optional] 
**BundleSid** | **string** | The Bundle SID for regulatory compliance. |[optional] 
**Reviewer** | **string** | The reviewer of the application. |[optional] 
**ZendeskTicketId** | **string** | The Zendesk ticket ID associated with the application. |[optional] 
**FriendlyName** | **string** | The friendly name of the application. |[optional] 
...
**UpdatedBy** | **string** | The identity of the user who last updated the application. |[optional] 
