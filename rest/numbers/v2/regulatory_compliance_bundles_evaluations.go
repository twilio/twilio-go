...
func (c *ApiService) EvaluationPage(BundleSid string, params *ListEvaluationParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v2/RegulatoryCompliance/Bundles/{BundleSid}/Evaluations"
	path = strings.Replace(path, "{"+"BundleSid"+"}", BundleSid, -1)
...
func (c *ApiService) EvaluationStream(BundleSid string, params *ListEvaluationParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EvaluationPage(BundleSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) EvaluationList(BundleSid string, params *ListEvaluationParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EvaluationPage(BundleSid, params, "", "", fmt.Sprint(limits.PageSize))
