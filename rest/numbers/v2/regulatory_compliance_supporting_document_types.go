...
func (c *ApiService) FetchSupportingDocumentTypeWithContext(ctx context.Context, Sid string) (*NumbersV2SupportingDocumentType, error) {
...
// Lists SupportingDocumentType records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListSupportingDocumentTypeWithContext(ctx context.Context, params *ListSupportingDocumentTypeParams) ([]NumbersV2SupportingDocumentType, error) {
...
// Streams SupportingDocumentType records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamSupportingDocumentTypeWithContext(ctx context.Context, params *ListSupportingDocumentTypeParams) (chan NumbersV2SupportingDocumentType, chan error) {
	if params == nil {
...
func (c *ApiService) streamSupportingDocumentTypeWithContext(ctx context.Context, response *ListSupportingDocumentTypeResponse, params *ListSupportingDocumentTypeParams, recordChannel chan NumbersV2SupportingDocumentType, errorChannel chan error) {
	curRecord := 1
