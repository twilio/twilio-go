...
func (c *ApiService) EndUserPage(params *ListEndUserParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v2/RegulatoryCompliance/EndUsers"
...
func (c *ApiService) EndUserStream(params *ListEndUserParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EndUserPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) EndUserList(params *ListEndUserParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EndUserPage(params, "", "", fmt.Sprint(limits.PageSize))
