...
func (c *ApiService) SubscribedEventPage(SubscriptionSid string, params *ListSubscribedEventParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/v1/Subscriptions/{SubscriptionSid}/SubscribedEvents"
	path = strings.Replace(path, "{"+"SubscriptionSid"+"}", SubscriptionSid, -1)
...
func (c *ApiService) SubscribedEventStream(SubscriptionSid string, params *ListSubscribedEventParams, limit int) (chan map[string]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
	page, err := c.SubscribedEventPage(SubscriptionSid, params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) SubscribedEventList(SubscriptionSid string, params *ListSubscribedEventParams, limit int) ([]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
