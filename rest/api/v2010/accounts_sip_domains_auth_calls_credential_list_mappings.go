...
func (c *ApiService) PageSipAuthCallsCredentialListMapping(DomainSid string, params *ListSipAuthCallsCredentialListMappingParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/Auth/Calls/CredentialListMappings.json"
...
func (c *ApiService) ListSipAuthCallsCredentialListMapping(DomainSid string, params *ListSipAuthCallsCredentialListMappingParams) (ListSipAuthCallsCredentialListMapping200Response, error) {
	response, errors := c.StreamSipAuthCallsCredentialListMapping(DomainSid, params)

	records := make(ListSipAuthCallsCredentialListMapping200Response, 0)
...
func (c *ApiService) StreamSipAuthCallsCredentialListMapping(DomainSid string, params *ListSipAuthCallsCredentialListMappingParams) (chan ListSipAuthCallsCredentialListMapping200Response, chan error) {
	if params == nil {
		params = &ListSipAuthCallsCredentialListMappingParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListSipAuthCallsCredentialListMapping200Response, 1)
...
func (c *ApiService) streamSipAuthCallsCredentialListMapping(response *, params *ListSipAuthCallsCredentialListMappingParams, recordChannel chan ListSipAuthCallsCredentialListMapping200Response, errorChannel chan error) {
	curRecord := 1
