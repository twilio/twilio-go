...
// CreateSipCredentialListWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateSipCredentialListWithMetadata(params *CreateSipCredentialListParams) (*metadata.ResourceMetadata[ApiV2010SipCredentialList], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
	...
	metadataWrapper := metadata.NewResourceMetadata[ApiV2010SipCredentialList](
...
// DeleteSipCredentialListWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteSipCredentialListWithMetadata(Sid string, params *DeleteSipCredentialListParams) (*metadata.ResourceMetadata[bool], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
// FetchSipCredentialListWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchSipCredentialListWithMetadata(Sid string, params *FetchSipCredentialListParams) (*metadata.ResourceMetadata[ApiV2010SipCredentialList], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
// PageSipCredentialListWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageSipCredentialListWithMetadata(params *ListSipCredentialListParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListSipCredentialListResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListSipCredentialListResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListSipCredentialListWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListSipCredentialListWithMetadata(params *ListSipCredentialListParams) (*metadata.ResourceMetadata[[]ApiV2010SipCredentialList], error) {
	response, errors := c.StreamSipCredentialListWithMetadata(params)
...
// StreamSipCredentialListWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamSipCredentialListWithMetadata(params *ListSipCredentialListParams) (*metadata.ResourceMetadata[chan ApiV2010SipCredentialList], chan error) {
	if params == nil {
		params = &ListSipCredentialListParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageSipCredentialListWithMetadata(params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamSipCredentialList(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010SipCredentialList](
...
// UpdateSipCredentialListWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) UpdateSipCredentialListWithMetadata(Sid string, params *UpdateSipCredentialListParams) (*metadata.ResourceMetadata[ApiV2010SipCredentialList], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
