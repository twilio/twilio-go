...
func (c *ApiService) PageSipDomain(params *ListSipDomainParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/SIP/Domains.json"
...
func (c *ApiService) ListSipDomain(params *ListSipDomainParams) (ListSipDomain200Response, error) {
	response, errors := c.StreamSipDomain(params)

	records := make(ListSipDomain200Response, 0)
...
func (c *ApiService) StreamSipDomain(params *ListSipDomainParams) (chan ListSipDomain200Response, chan error) {
	if params == nil {
		params = &ListSipDomainParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListSipDomain200Response, 1)
...
func (c *ApiService) streamSipDomain(response *, params *ListSipDomainParams, recordChannel chan ListSipDomain200Response, errorChannel chan error) {
	curRecord := 1
