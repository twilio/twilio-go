...
func (c *ApiService) IncomingPhoneNumberMobilePage(params *ListIncomingPhoneNumberMobileParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) IncomingPhoneNumberMobileStream(params *ListIncomingPhoneNumberMobileParams, limit int) (chan map[string]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
	page, err := c.IncomingPhoneNumberMobilePage(params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) IncomingPhoneNumberMobileList(params *ListIncomingPhoneNumberMobileParams, limit int) ([]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
