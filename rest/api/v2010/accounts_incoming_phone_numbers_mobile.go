...
func (c *ApiService) PageIncomingPhoneNumberMobile(params *ListIncomingPhoneNumberMobileParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json"
...
func (c *ApiService) ListIncomingPhoneNumberMobile(params *ListIncomingPhoneNumberMobileParams) (ListIncomingPhoneNumberMobile200Response, error) {
	response, errors := c.StreamIncomingPhoneNumberMobile(params)

	records := make(ListIncomingPhoneNumberMobile200Response, 0)
...
func (c *ApiService) StreamIncomingPhoneNumberMobile(params *ListIncomingPhoneNumberMobileParams) (chan ListIncomingPhoneNumberMobile200Response, chan error) {
	if params == nil {
		params = &ListIncomingPhoneNumberMobileParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListIncomingPhoneNumberMobile200Response, 1)
...
func (c *ApiService) streamIncomingPhoneNumberMobile(response *, params *ListIncomingPhoneNumberMobileParams, recordChannel chan ListIncomingPhoneNumberMobile200Response, errorChannel chan error) {
	curRecord := 1
