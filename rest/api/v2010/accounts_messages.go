...
func (c *ApiService) MessagePage(params *ListMessageParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Messages.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) MessageStream(params *ListMessageParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.MessagePage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) MessageList(params *ListMessageParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.MessagePage(params, "", "", fmt.Sprint(limits.PageSize))
