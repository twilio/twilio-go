...
func (c *ApiService) PageMessage(params *ListMessageParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Messages.json"
...
func (c *ApiService) ListMessage(params *ListMessageParams) (ListMessage200Response, error) {
	response, errors := c.StreamMessage(params)

	records := make(ListMessage200Response, 0)
...
func (c *ApiService) StreamMessage(params *ListMessageParams) (chan ListMessage200Response, chan error) {
	if params == nil {
		params = &ListMessageParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListMessage200Response, 1)
...
func (c *ApiService) streamMessage(response *, params *ListMessageParams, recordChannel chan ListMessage200Response, errorChannel chan error) {
	curRecord := 1
