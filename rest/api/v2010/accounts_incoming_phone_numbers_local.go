...
// CreateIncomingPhoneNumberLocalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateIncomingPhoneNumberLocalWithMetadata(params *CreateIncomingPhoneNumberLocalParams) (*metadata.ResourceMetadata[ApiV2010IncomingPhoneNumberLocal], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
	...
	metadataWrapper := metadata.NewResourceMetadata[ApiV2010IncomingPhoneNumberLocal](
...
// PageIncomingPhoneNumberLocalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageIncomingPhoneNumberLocalWithMetadata(params *ListIncomingPhoneNumberLocalParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListIncomingPhoneNumberLocalResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListIncomingPhoneNumberLocalResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListIncomingPhoneNumberLocalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListIncomingPhoneNumberLocalWithMetadata(params *ListIncomingPhoneNumberLocalParams) (*metadata.ResourceMetadata[[]ApiV2010IncomingPhoneNumberLocal], error) {
	response, errors := c.StreamIncomingPhoneNumberLocalWithMetadata(params)
...
// StreamIncomingPhoneNumberLocalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamIncomingPhoneNumberLocalWithMetadata(params *ListIncomingPhoneNumberLocalParams) (*metadata.ResourceMetadata[chan ApiV2010IncomingPhoneNumberLocal], chan error) {
	if params == nil {
		params = &ListIncomingPhoneNumberLocalParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageIncomingPhoneNumberLocalWithMetadata(params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamIncomingPhoneNumberLocal(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010IncomingPhoneNumberLocal](
