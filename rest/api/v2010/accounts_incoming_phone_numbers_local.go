...
func (c *ApiService) PageIncomingPhoneNumberLocal(params *ListIncomingPhoneNumberLocalParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json"
...
func (c *ApiService) ListIncomingPhoneNumberLocal(params *ListIncomingPhoneNumberLocalParams) (ListIncomingPhoneNumberLocal200Response, error) {
	response, errors := c.StreamIncomingPhoneNumberLocal(params)

	records := make(ListIncomingPhoneNumberLocal200Response, 0)
...
func (c *ApiService) StreamIncomingPhoneNumberLocal(params *ListIncomingPhoneNumberLocalParams) (chan ListIncomingPhoneNumberLocal200Response, chan error) {
	if params == nil {
		params = &ListIncomingPhoneNumberLocalParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListIncomingPhoneNumberLocal200Response, 1)
...
func (c *ApiService) streamIncomingPhoneNumberLocal(response *, params *ListIncomingPhoneNumberLocalParams, recordChannel chan ListIncomingPhoneNumberLocal200Response, errorChannel chan error) {
	curRecord := 1
