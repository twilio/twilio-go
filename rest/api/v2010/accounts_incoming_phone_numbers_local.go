...
func (c *ApiService) IncomingPhoneNumberLocalPage(params *ListIncomingPhoneNumberLocalParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) IncomingPhoneNumberLocalStream(params *ListIncomingPhoneNumberLocalParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.IncomingPhoneNumberLocalPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) IncomingPhoneNumberLocalList(params *ListIncomingPhoneNumberLocalParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.IncomingPhoneNumberLocalPage(params, "", "", fmt.Sprint(limits.PageSize))
