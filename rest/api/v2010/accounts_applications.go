...
func (c *ApiService) PageApplication(params *ListApplicationParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Applications.json"
...
func (c *ApiService) ListApplication(params *ListApplicationParams) (ListApplication200Response, error) {
	response, errors := c.StreamApplication(params)

	records := make(ListApplication200Response, 0)
...
func (c *ApiService) StreamApplication(params *ListApplicationParams) (chan ListApplication200Response, chan error) {
	if params == nil {
		params = &ListApplicationParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListApplication200Response, 1)
...
func (c *ApiService) streamApplication(response *, params *ListApplicationParams, recordChannel chan ListApplication200Response, errorChannel chan error) {
	curRecord := 1
