...
func (c *ApiService) PageSipIpAccessControlList(params *ListSipIpAccessControlListParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/SIP/IpAccessControlLists.json"
...
func (c *ApiService) ListSipIpAccessControlList(params *ListSipIpAccessControlListParams) (ListSipIpAccessControlList200Response, error) {
	response, errors := c.StreamSipIpAccessControlList(params)

	records := make(ListSipIpAccessControlList200Response, 0)
...
func (c *ApiService) StreamSipIpAccessControlList(params *ListSipIpAccessControlListParams) (chan ListSipIpAccessControlList200Response, chan error) {
	if params == nil {
		params = &ListSipIpAccessControlListParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListSipIpAccessControlList200Response, 1)
...
func (c *ApiService) streamSipIpAccessControlList(response *, params *ListSipIpAccessControlListParams, recordChannel chan ListSipIpAccessControlList200Response, errorChannel chan error) {
	curRecord := 1
