...
func (c *ApiService) SipIpAccessControlListPage(params *ListSipIpAccessControlListParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/IpAccessControlLists.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) SipIpAccessControlListStream(params *ListSipIpAccessControlListParams, limit int) (chan map[string]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.SipIpAccessControlListPage(params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) SipIpAccessControlListList(params *ListSipIpAccessControlListParams, limit int) ([]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.SipIpAccessControlListPage(params, "", "")
	if err != nil {
		return nil, err
