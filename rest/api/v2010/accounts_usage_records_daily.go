...
func (c *ApiService) PageUsageRecordDaily(params *ListUsageRecordDailyParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListUsageRecordDaily(params *ListUsageRecordDailyParams) (ListUsageRecordDaily200Response, error) {
	response, errors := c.StreamUsageRecordDaily(params)

	records := make(ListUsageRecordDaily200Response, 0)
...
func (c *ApiService) StreamUsageRecordDaily(params *ListUsageRecordDailyParams) (chan ListUsageRecordDaily200Response, chan error) {
	if params == nil {
		params = &ListUsageRecordDailyParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageRecordDaily200Response, 1)
...
func (c *ApiService) streamUsageRecordDaily(response *, params *ListUsageRecordDailyParams, recordChannel chan ListUsageRecordDaily200Response, errorChannel chan error) {
	curRecord := 1
