...
func (c *ApiService) UsageRecordDailyPage(params *ListUsageRecordDailyParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Usage/Records/Daily.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) UsageRecordDailyStream(params *ListUsageRecordDailyParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.UsageRecordDailyPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) UsageRecordDailyList(params *ListUsageRecordDailyParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.UsageRecordDailyPage(params, "", "", fmt.Sprint(limits.PageSize))
