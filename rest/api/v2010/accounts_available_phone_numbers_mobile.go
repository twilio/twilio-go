...
func (c *ApiService) ListAvailablePhoneNumberMobile(CountryCode string, params *ListAvailablePhoneNumberMobileParams) (*ListAvailablePhoneNumberMobileResponse, error) {
...
func (c *ApiService) AccountsAvailablePhoneNumbersMobilePage(CountryCode string, params *ListAvailablePhoneNumberMobileParams, pageToken string, pageNumber string) (*ListAvailablePhoneNumberMobileResponse, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Mobile.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
//Lists AccountsAvailablePhoneNumbersMobile records from the API as a list. Unlike stream, this operation is eager and will loads 'limit' records into memory before returning.
func (c *ApiService) AccountsAvailablePhoneNumbersMobileList(CountryCode string, params *ListAvailablePhoneNumberMobileParams, limit int) ([]ListAvailablePhoneNumberMobileResponse, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListAvailablePhoneNumberMobile(CountryCode, params)
	if err != nil {
		return nil, err
	}
	...
	ret := make([]ListAvailablePhoneNumberMobileResponse, len(resp))
...
//Streams AccountsAvailablePhoneNumbersMobile records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) AccountsAvailablePhoneNumbersMobileStream(CountryCode string, params *ListAvailablePhoneNumberMobileParams, limit int) (chan interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListAvailablePhoneNumberMobile(CountryCode, params)
	if err != nil {
		return nil, err
