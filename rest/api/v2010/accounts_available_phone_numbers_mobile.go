...
func (c *ApiService) PageAvailablePhoneNumberMobile(CountryCode string, params *ListAvailablePhoneNumberMobileParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListAvailablePhoneNumberMobile(CountryCode string, params *ListAvailablePhoneNumberMobileParams) (ListAvailablePhoneNumberMobile200Response, error) {
	response, errors := c.StreamAvailablePhoneNumberMobile(CountryCode, params)

	records := make(ListAvailablePhoneNumberMobile200Response, 0)
...
func (c *ApiService) StreamAvailablePhoneNumberMobile(CountryCode string, params *ListAvailablePhoneNumberMobileParams) (chan ListAvailablePhoneNumberMobile200Response, chan error) {
	if params == nil {
		params = &ListAvailablePhoneNumberMobileParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListAvailablePhoneNumberMobile200Response, 1)
...
func (c *ApiService) streamAvailablePhoneNumberMobile(response *, params *ListAvailablePhoneNumberMobileParams, recordChannel chan ListAvailablePhoneNumberMobile200Response, errorChannel chan error) {
	curRecord := 1
