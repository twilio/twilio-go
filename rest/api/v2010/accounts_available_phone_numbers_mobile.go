...
// PageAvailablePhoneNumberMobileWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageAvailablePhoneNumberMobileWithMetadata(CountryCode string, params *ListAvailablePhoneNumberMobileParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListAvailablePhoneNumberMobileResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Mobile.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListAvailablePhoneNumberMobileResponse](
		*ps,             // The page object
...
// ListAvailablePhoneNumberMobileWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListAvailablePhoneNumberMobileWithMetadata(CountryCode string, params *ListAvailablePhoneNumberMobileParams) (*metadata.ResourceMetadata[[]ApiV2010AvailablePhoneNumberMobile], error) {
	response, errors := c.StreamAvailablePhoneNumberMobileWithMetadata(CountryCode, params)
	...
	metadataWrapper := metadata.NewResourceMetadata[[]ApiV2010AvailablePhoneNumberMobile](
		records,
...
// StreamAvailablePhoneNumberMobileWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamAvailablePhoneNumberMobileWithMetadata(CountryCode string, params *ListAvailablePhoneNumberMobileParams) (*metadata.ResourceMetadata[chan ApiV2010AvailablePhoneNumberMobile], chan error) {
	if params == nil {
		params = &ListAvailablePhoneNumberMobileParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageAvailablePhoneNumberMobileWithMetadata(CountryCode, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamAvailablePhoneNumberMobile(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010AvailablePhoneNumberMobile](
