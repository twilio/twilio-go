...
func (c *ApiService) PageQueue(params *ListQueueParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Queues.json"
...
func (c *ApiService) ListQueue(params *ListQueueParams) (ListQueue200Response, error) {
	response, errors := c.StreamQueue(params)

	records := make(ListQueue200Response, 0)
...
func (c *ApiService) StreamQueue(params *ListQueueParams) (chan ListQueue200Response, chan error) {
	if params == nil {
		params = &ListQueueParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListQueue200Response, 1)
...
func (c *ApiService) streamQueue(response *, params *ListQueueParams, recordChannel chan ListQueue200Response, errorChannel chan error) {
	curRecord := 1
