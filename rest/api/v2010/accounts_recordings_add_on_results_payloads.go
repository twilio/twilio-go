...
func (c *ApiService) DeleteRecordingAddOnResultPayload(ReferenceSid string, AddOnResultSid string, Sid string, params *DeleteRecordingAddOnResultPayloadParams) error {
	return c.DeleteRecordingAddOnResultPayloadWithContext(context.TODO(), ReferenceSid, AddOnResultSid, Sid, params)
}
func (c *ApiService) DeleteRecordingAddOnResultPayloadWithContext(ctx context.Context, ReferenceSid string, AddOnResultSid string, Sid string, params *DeleteRecordingAddOnResultPayloadParams) error {
...
func (c *ApiService) FetchRecordingAddOnResultPayload(ReferenceSid string, AddOnResultSid string, Sid string, params *FetchRecordingAddOnResultPayloadParams) (*ApiV2010RecordingAddOnResultPayload, error) {
	return c.FetchRecordingAddOnResultPayloadWithContext(context.TODO(), ReferenceSid, AddOnResultSid, Sid, params)
}
func (c *ApiService) FetchRecordingAddOnResultPayloadWithContext(ctx context.Context, ReferenceSid string, AddOnResultSid string, Sid string, params *FetchRecordingAddOnResultPayloadParams) (*ApiV2010RecordingAddOnResultPayload, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Recordings/{ReferenceSid}/AddOnResults/{AddOnResultSid}/Payloads/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) PageRecordingAddOnResultPayload(ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams, pageToken, pageNumber string) (*ListRecordingAddOnResultPayloadResponse, error) {
	return c.PageRecordingAddOnResultPayloadWithContext(context.TODO(), ReferenceSid, AddOnResultSid, params, pageToken, pageNumber)
}

// Retrieve a single page of RecordingAddOnResultPayload records from the API. Request is executed immediately.
func (c *ApiService) PageRecordingAddOnResultPayloadWithContext(ctx context.Context, ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams, pageToken, pageNumber string) (*ListRecordingAddOnResultPayloadResponse, error) {
...
func (c *ApiService) ListRecordingAddOnResultPayload(ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams) ([]ApiV2010RecordingAddOnResultPayload, error) {
	return c.ListRecordingAddOnResultPayloadWithContext(context.TODO(), ReferenceSid, AddOnResultSid, params)
}

// Lists RecordingAddOnResultPayload records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListRecordingAddOnResultPayloadWithContext(ctx context.Context, ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams) ([]ApiV2010RecordingAddOnResultPayload, error) {
	response, errors := c.StreamRecordingAddOnResultPayloadWithContext(ctx, ReferenceSid, AddOnResultSid, params)
...
func (c *ApiService) StreamRecordingAddOnResultPayload(ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams) (chan ApiV2010RecordingAddOnResultPayload, chan error) {
	return c.StreamRecordingAddOnResultPayloadWithContext(context.TODO(), ReferenceSid, AddOnResultSid, params)
}

// Streams RecordingAddOnResultPayload records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamRecordingAddOnResultPayloadWithContext(ctx context.Context, ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams) (chan ApiV2010RecordingAddOnResultPayload, chan error) {
	if params == nil {
	...
	response, err := c.PageRecordingAddOnResultPayloadWithContext(ctx, ReferenceSid, AddOnResultSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamRecordingAddOnResultPayloadWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamRecordingAddOnResultPayloadWithContext(ctx context.Context, response *ListRecordingAddOnResultPayloadResponse, params *ListRecordingAddOnResultPayloadParams, recordChannel chan ApiV2010RecordingAddOnResultPayload, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListRecordingAddOnResultPayloadResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListRecordingAddOnResultPayloadResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
