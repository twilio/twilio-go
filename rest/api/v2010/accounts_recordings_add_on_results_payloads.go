...
func (c *ApiService) PageRecordingAddOnResultPayload(ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListRecordingAddOnResultPayload(ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams) (ListRecordingAddOnResultPayload200Response, error) {
	response, errors := c.StreamRecordingAddOnResultPayload(ReferenceSid, AddOnResultSid, params)

	records := make(ListRecordingAddOnResultPayload200Response, 0)
...
func (c *ApiService) StreamRecordingAddOnResultPayload(ReferenceSid string, AddOnResultSid string, params *ListRecordingAddOnResultPayloadParams) (chan ListRecordingAddOnResultPayload200Response, chan error) {
	if params == nil {
		params = &ListRecordingAddOnResultPayloadParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListRecordingAddOnResultPayload200Response, 1)
...
func (c *ApiService) streamRecordingAddOnResultPayload(response *, params *ListRecordingAddOnResultPayloadParams, recordChannel chan ListRecordingAddOnResultPayload200Response, errorChannel chan error) {
	curRecord := 1
