...
func (c *ApiService) ListAvailablePhoneNumberTollFree(CountryCode string, params *ListAvailablePhoneNumberTollFreeParams) (*ListAvailablePhoneNumberTollFreeResponse, error) {
...
func (c *ApiService) AvailablePhoneNumberTollFreePage(CountryCode string, params *ListAvailablePhoneNumberTollFreeParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/TollFree.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) AvailablePhoneNumberTollFreeStream(CountryCode string, params *ListAvailablePhoneNumberTollFreeParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AvailablePhoneNumberTollFreePage(CountryCode, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) AvailablePhoneNumberTollFreeList(CountryCode string, params *ListAvailablePhoneNumberTollFreeParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AvailablePhoneNumberTollFreePage(CountryCode, params, "", "", fmt.Sprint(limits.PageSize))
