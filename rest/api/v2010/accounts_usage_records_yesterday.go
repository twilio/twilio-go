...
func (c *ApiService) PageUsageRecordYesterday(params *ListUsageRecordYesterdayParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListUsageRecordYesterday(params *ListUsageRecordYesterdayParams) (ListUsageRecordYesterday200Response, error) {
	response, errors := c.StreamUsageRecordYesterday(params)

	records := make(ListUsageRecordYesterday200Response, 0)
...
func (c *ApiService) StreamUsageRecordYesterday(params *ListUsageRecordYesterdayParams) (chan ListUsageRecordYesterday200Response, chan error) {
	if params == nil {
		params = &ListUsageRecordYesterdayParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageRecordYesterday200Response, 1)
...
func (c *ApiService) streamUsageRecordYesterday(response *, params *ListUsageRecordYesterdayParams, recordChannel chan ListUsageRecordYesterday200Response, errorChannel chan error) {
	curRecord := 1
