...
// PageUsageRecordYesterdayWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageUsageRecordYesterdayWithMetadata(params *ListUsageRecordYesterdayParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListUsageRecordYesterdayResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Usage/Records/Yesterday.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListUsageRecordYesterdayResponse](
		*ps,             // The page object
...
// ListUsageRecordYesterdayWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListUsageRecordYesterdayWithMetadata(params *ListUsageRecordYesterdayParams) (*metadata.ResourceMetadata[[]ApiV2010UsageRecordYesterday], error) {
	response, errors := c.StreamUsageRecordYesterdayWithMetadata(params)
	...
	metadataWrapper := metadata.NewResourceMetadata[[]ApiV2010UsageRecordYesterday](
		records,
...
// StreamUsageRecordYesterdayWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamUsageRecordYesterdayWithMetadata(params *ListUsageRecordYesterdayParams) (*metadata.ResourceMetadata[chan ApiV2010UsageRecordYesterday], chan error) {
	if params == nil {
		params = &ListUsageRecordYesterdayParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageUsageRecordYesterdayWithMetadata(params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamUsageRecordYesterday(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010UsageRecordYesterday](
