...
func (c *ApiService) ListAvailablePhoneNumberLocal(CountryCode string, params *ListAvailablePhoneNumberLocalParams, limit *int) ([]*ListAvailablePhoneNumberLocalResponse, error) {
	...
	curRecord := 0
	var records []*ListAvailablePhoneNumberLocalResponse

	for response != nil {
		records = append(records, response)

		var record interface{}
		if record, err = client.GetNext(response, &curRecord, limit, c.getNextListAvailablePhoneNumberLocalResponse); record == nil || err != nil {
			return records, err
		}
...
func (c *ApiService) StreamAvailablePhoneNumberLocal(CountryCode string, params *ListAvailablePhoneNumberLocalParams, limit *int) (chan *ListAvailablePhoneNumberLocalResponse, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
	...
	channel := make(chan *ListAvailablePhoneNumberLocalResponse, 1)
