...
func (c *ApiService) PageAvailablePhoneNumberLocal(CountryCode string, params *ListAvailablePhoneNumberLocalParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListAvailablePhoneNumberLocal(CountryCode string, params *ListAvailablePhoneNumberLocalParams) (ListAvailablePhoneNumberLocal200Response, error) {
	response, errors := c.StreamAvailablePhoneNumberLocal(CountryCode, params)

	records := make(ListAvailablePhoneNumberLocal200Response, 0)
...
func (c *ApiService) StreamAvailablePhoneNumberLocal(CountryCode string, params *ListAvailablePhoneNumberLocalParams) (chan ListAvailablePhoneNumberLocal200Response, chan error) {
	if params == nil {
		params = &ListAvailablePhoneNumberLocalParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListAvailablePhoneNumberLocal200Response, 1)
...
func (c *ApiService) streamAvailablePhoneNumberLocal(response *, params *ListAvailablePhoneNumberLocalParams, recordChannel chan ListAvailablePhoneNumberLocal200Response, errorChannel chan error) {
	curRecord := 1
