...
// PageAvailablePhoneNumberLocalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageAvailablePhoneNumberLocalWithMetadata(CountryCode string, params *ListAvailablePhoneNumberLocalParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListAvailablePhoneNumberLocalResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Local.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListAvailablePhoneNumberLocalResponse](
		*ps,             // The page object
...
func (c *ApiService) ListAvailablePhoneNumberLocal(CountryCode string, params *ListAvailablePhoneNumberLocalParams) ([]ApiV2010AvailablePhoneNumberLocal, error) {
	response, errors := c.StreamAvailablePhoneNumberLocal(CountryCode, params)
...
// ListAvailablePhoneNumberLocalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListAvailablePhoneNumberLocalWithMetadata(CountryCode string, params *ListAvailablePhoneNumberLocalParams) (*metadata.ResourceMetadata[[]ApiV2010AvailablePhoneNumberLocal], error) {
	response, errors := c.StreamAvailablePhoneNumberLocalWithMetadata(CountryCode, params)
	...
	metadataWrapper := metadata.NewResourceMetadata[[]ApiV2010AvailablePhoneNumberLocal](
		records,
...
func (c *ApiService) StreamAvailablePhoneNumberLocal(CountryCode string, params *ListAvailablePhoneNumberLocalParams) (chan ApiV2010AvailablePhoneNumberLocal, chan error) {
	...
	recordChannel := make(chan ApiV2010AvailablePhoneNumberLocal, 1)
	...
	if err != nil {
		...
		go c.streamAvailablePhoneNumberLocal(response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

// StreamAvailablePhoneNumberLocalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamAvailablePhoneNumberLocalWithMetadata(CountryCode string, params *ListAvailablePhoneNumberLocalParams) (*metadata.ResourceMetadata[chan ApiV2010AvailablePhoneNumberLocal], chan error) {
	if params == nil {
		params = &ListAvailablePhoneNumberLocalParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageAvailablePhoneNumberLocalWithMetadata(CountryCode, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamAvailablePhoneNumberLocal(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010AvailablePhoneNumberLocal](
...
func (c *ApiService) streamAvailablePhoneNumberLocal(response *ListAvailablePhoneNumberLocalResponse, params *ListAvailablePhoneNumberLocalParams, recordChannel chan ApiV2010AvailablePhoneNumberLocal, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNext(c.baseURL, response, c.getNextListAvailablePhoneNumberLocalResponse)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
