...
func (c *ApiService) MemberPage(QueueSid string, params *ListMemberParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Queues/{QueueSid}/Members.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) MemberStream(QueueSid string, params *ListMemberParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.MemberPage(QueueSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) MemberList(QueueSid string, params *ListMemberParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.MemberPage(QueueSid, params, "", "", fmt.Sprint(limits.PageSize))
