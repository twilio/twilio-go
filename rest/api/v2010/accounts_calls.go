...
func (c *ApiService) CreateCall(params *CreateCallParams) (*ApiV2010Call, error) {
	return c.CreateCallWithContext(context.TODO(), params)
}
func (c *ApiService) CreateCallWithContext(ctx context.Context, params *CreateCallParams) (*ApiV2010Call, error) {
...
func (c *ApiService) DeleteCall(Sid string, params *DeleteCallParams) error {
	return c.DeleteCallWithContext(context.TODO(), Sid, params)
}
func (c *ApiService) DeleteCallWithContext(ctx context.Context, Sid string, params *DeleteCallParams) error {
...
func (c *ApiService) FetchCall(Sid string, params *FetchCallParams) (*ApiV2010Call, error) {
	return c.FetchCallWithContext(context.TODO(), Sid, params)
}
func (c *ApiService) FetchCallWithContext(ctx context.Context, Sid string, params *FetchCallParams) (*ApiV2010Call, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Calls/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) PageCall(params *ListCallParams, pageToken, pageNumber string) (*ListCallResponse, error) {
	return c.PageCallWithContext(context.TODO(), params, pageToken, pageNumber)
}

// Retrieve a single page of Call records from the API. Request is executed immediately.
func (c *ApiService) PageCallWithContext(ctx context.Context, params *ListCallParams, pageToken, pageNumber string) (*ListCallResponse, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Calls.json"
...
func (c *ApiService) ListCall(params *ListCallParams) ([]ApiV2010Call, error) {
	return c.ListCallWithContext(context.TODO(), params)
}

// Lists Call records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListCallWithContext(ctx context.Context, params *ListCallParams) ([]ApiV2010Call, error) {
	response, errors := c.StreamCallWithContext(ctx, params)
...
func (c *ApiService) StreamCall(params *ListCallParams) (chan ApiV2010Call, chan error) {
	return c.StreamCallWithContext(context.TODO(), params)
}

// Streams Call records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamCallWithContext(ctx context.Context, params *ListCallParams) (chan ApiV2010Call, chan error) {
	if params == nil {
	...
	response, err := c.PageCallWithContext(ctx, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamCallWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamCallWithContext(ctx context.Context, response *ListCallResponse, params *ListCallParams, recordChannel chan ApiV2010Call, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListCallResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListCallResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
...
func (c *ApiService) UpdateCall(Sid string, params *UpdateCallParams) (*ApiV2010Call, error) {
	return c.UpdateCallWithContext(context.TODO(), Sid, params)
}
func (c *ApiService) UpdateCallWithContext(ctx context.Context, Sid string, params *UpdateCallParams) (*ApiV2010Call, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Calls/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
