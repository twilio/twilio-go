...
func (c *ApiService) PageCall(params *ListCallParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Calls.json"
...
func (c *ApiService) ListCall(params *ListCallParams) (ListCall200Response, error) {
	response, errors := c.StreamCall(params)

	records := make(ListCall200Response, 0)
...
func (c *ApiService) StreamCall(params *ListCallParams) (chan ListCall200Response, chan error) {
	if params == nil {
		params = &ListCallParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListCall200Response, 1)
...
func (c *ApiService) streamCall(response *, params *ListCallParams, recordChannel chan ListCall200Response, errorChannel chan error) {
	curRecord := 1
