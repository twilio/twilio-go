...
func (c *ApiService) PageCallRecording(CallSid string, params *ListCallRecordingParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Recordings.json"
...
func (c *ApiService) ListCallRecording(CallSid string, params *ListCallRecordingParams) (ListCallRecording200Response, error) {
	response, errors := c.StreamCallRecording(CallSid, params)

	records := make(ListCallRecording200Response, 0)
...
func (c *ApiService) StreamCallRecording(CallSid string, params *ListCallRecordingParams) (chan ListCallRecording200Response, chan error) {
	if params == nil {
		params = &ListCallRecordingParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListCallRecording200Response, 1)
...
func (c *ApiService) streamCallRecording(response *, params *ListCallRecordingParams, recordChannel chan ListCallRecording200Response, errorChannel chan error) {
	curRecord := 1
