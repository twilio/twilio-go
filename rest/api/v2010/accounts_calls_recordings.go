...
func (params *CreateCallRecordingParams) SetPlayBeep(PlayBeep bool) *CreateCallRecordingParams {
...
func (params *UpdateCallRecordingParams) SetPlayBeep(PlayBeep bool) *UpdateCallRecordingParams {
	params.PlayBeep = &PlayBeep
	return params
}
