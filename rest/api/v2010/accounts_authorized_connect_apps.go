...
func (c *ApiService) AuthorizedConnectAppPage(params *ListAuthorizedConnectAppParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/AuthorizedConnectApps.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) AuthorizedConnectAppStream(params *ListAuthorizedConnectAppParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AuthorizedConnectAppPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) AuthorizedConnectAppList(params *ListAuthorizedConnectAppParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AuthorizedConnectAppPage(params, "", "", fmt.Sprint(limits.PageSize))
