...
func (c *ApiService) PageParticipant(ConferenceSid string, params *ListParticipantParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Conferences/{ConferenceSid}/Participants.json"
...
func (c *ApiService) ListParticipant(ConferenceSid string, params *ListParticipantParams) (ListParticipant200Response, error) {
	response, errors := c.StreamParticipant(ConferenceSid, params)

	records := make(ListParticipant200Response, 0)
...
func (c *ApiService) StreamParticipant(ConferenceSid string, params *ListParticipantParams) (chan ListParticipant200Response, chan error) {
	if params == nil {
		params = &ListParticipantParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListParticipant200Response, 1)
...
func (c *ApiService) streamParticipant(response *, params *ListParticipantParams, recordChannel chan ListParticipant200Response, errorChannel chan error) {
	curRecord := 1
