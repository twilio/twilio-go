...
func (c *ApiService) PageIncomingPhoneNumberAssignedAddOn(ResourceSid string, params *ListIncomingPhoneNumberAssignedAddOnParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/{ResourceSid}/AssignedAddOns.json"
...
func (c *ApiService) ListIncomingPhoneNumberAssignedAddOn(ResourceSid string, params *ListIncomingPhoneNumberAssignedAddOnParams) (ListIncomingPhoneNumberAssignedAddOn200Response, error) {
	response, errors := c.StreamIncomingPhoneNumberAssignedAddOn(ResourceSid, params)

	records := make(ListIncomingPhoneNumberAssignedAddOn200Response, 0)
...
func (c *ApiService) StreamIncomingPhoneNumberAssignedAddOn(ResourceSid string, params *ListIncomingPhoneNumberAssignedAddOnParams) (chan ListIncomingPhoneNumberAssignedAddOn200Response, chan error) {
	if params == nil {
		params = &ListIncomingPhoneNumberAssignedAddOnParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListIncomingPhoneNumberAssignedAddOn200Response, 1)
...
func (c *ApiService) streamIncomingPhoneNumberAssignedAddOn(response *, params *ListIncomingPhoneNumberAssignedAddOnParams, recordChannel chan ListIncomingPhoneNumberAssignedAddOn200Response, errorChannel chan error) {
	curRecord := 1
