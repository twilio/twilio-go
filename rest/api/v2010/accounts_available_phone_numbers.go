...
func (c *ApiService) AvailablePhoneNumberCountryPage(params *ListAvailablePhoneNumberCountryParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) AvailablePhoneNumberCountryStream(params *ListAvailablePhoneNumberCountryParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AvailablePhoneNumberCountryPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) AvailablePhoneNumberCountryList(params *ListAvailablePhoneNumberCountryParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AvailablePhoneNumberCountryPage(params, "", "", fmt.Sprint(limits.PageSize))
