...
// FetchAvailablePhoneNumberCountryWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchAvailablePhoneNumberCountryWithMetadata(CountryCode string, params *FetchAvailablePhoneNumberCountryParams) (*metadata.ResourceMetadata[ApiV2010AvailablePhoneNumberCountry], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
	...
	metadataWrapper := metadata.NewResourceMetadata[ApiV2010AvailablePhoneNumberCountry](
...
// PageAvailablePhoneNumberCountryWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageAvailablePhoneNumberCountryWithMetadata(params *ListAvailablePhoneNumberCountryParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListAvailablePhoneNumberCountryResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListAvailablePhoneNumberCountryResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListAvailablePhoneNumberCountryWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListAvailablePhoneNumberCountryWithMetadata(params *ListAvailablePhoneNumberCountryParams) (*metadata.ResourceMetadata[[]ApiV2010AvailablePhoneNumberCountry], error) {
	response, errors := c.StreamAvailablePhoneNumberCountryWithMetadata(params)
...
// StreamAvailablePhoneNumberCountryWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamAvailablePhoneNumberCountryWithMetadata(params *ListAvailablePhoneNumberCountryParams) (*metadata.ResourceMetadata[chan ApiV2010AvailablePhoneNumberCountry], chan error) {
	if params == nil {
		params = &ListAvailablePhoneNumberCountryParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageAvailablePhoneNumberCountryWithMetadata(params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamAvailablePhoneNumberCountry(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010AvailablePhoneNumberCountry](
