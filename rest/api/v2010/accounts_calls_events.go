...
func (c *ApiService) CallEventPage(CallSid string, params *ListCallEventParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Events.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) CallEventStream(CallSid string, params *ListCallEventParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.CallEventPage(CallSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) CallEventList(CallSid string, params *ListCallEventParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.CallEventPage(CallSid, params, "", "", fmt.Sprint(limits.PageSize))
