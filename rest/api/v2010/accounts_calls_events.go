...
func (c *ApiService) PageCallEvent(CallSid string, params *ListCallEventParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListCallEvent(CallSid string, params *ListCallEventParams) (ListCallEvent200Response, error) {
	response, errors := c.StreamCallEvent(CallSid, params)

	records := make(ListCallEvent200Response, 0)
...
func (c *ApiService) StreamCallEvent(CallSid string, params *ListCallEventParams) (chan ListCallEvent200Response, chan error) {
	if params == nil {
		params = &ListCallEventParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListCallEvent200Response, 1)
...
func (c *ApiService) streamCallEvent(response *, params *ListCallEventParams, recordChannel chan ListCallEvent200Response, errorChannel chan error) {
	curRecord := 1
