...
func (c *ApiService) PageNotification(params *ListNotificationParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListNotification(params *ListNotificationParams) (ListNotification200Response, error) {
	response, errors := c.StreamNotification(params)

	records := make(ListNotification200Response, 0)
...
func (c *ApiService) StreamNotification(params *ListNotificationParams) (chan ListNotification200Response, chan error) {
	if params == nil {
		params = &ListNotificationParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListNotification200Response, 1)
...
func (c *ApiService) streamNotification(response *, params *ListNotificationParams, recordChannel chan ListNotification200Response, errorChannel chan error) {
	curRecord := 1
