...
func (c *ApiService) NotificationPage(params *ListNotificationParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Notifications.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) NotificationStream(params *ListNotificationParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.NotificationPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) NotificationList(params *ListNotificationParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.NotificationPage(params, "", "", fmt.Sprint(limits.PageSize))
