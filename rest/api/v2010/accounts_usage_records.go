...
func (c *ApiService) PageUsageRecord(params *ListUsageRecordParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListUsageRecord(params *ListUsageRecordParams) (ListUsageRecord200Response, error) {
	response, errors := c.StreamUsageRecord(params)

	records := make(ListUsageRecord200Response, 0)
...
func (c *ApiService) StreamUsageRecord(params *ListUsageRecordParams) (chan ListUsageRecord200Response, chan error) {
	if params == nil {
		params = &ListUsageRecordParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageRecord200Response, 1)
...
func (c *ApiService) streamUsageRecord(response *, params *ListUsageRecordParams, recordChannel chan ListUsageRecord200Response, errorChannel chan error) {
	curRecord := 1
