...
// Lists UsageRecord records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListUsageRecordWithContext(ctx context.Context, params *ListUsageRecordParams) ([]ApiV2010UsageRecord, error) {
...
// Streams UsageRecord records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamUsageRecordWithContext(ctx context.Context, params *ListUsageRecordParams) (chan ApiV2010UsageRecord, chan error) {
	if params == nil {
...
func (c *ApiService) streamUsageRecordWithContext(ctx context.Context, response *ListUsageRecordResponse, params *ListUsageRecordParams, recordChannel chan ApiV2010UsageRecord, errorChannel chan error) {
	curRecord := 1
