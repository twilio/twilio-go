...
func (c *ApiService) ListUsageRecordWithMetadata(params *ListUsageRecordParams) (*metadata.ResourceMetadata[[]ApiV2010UsageRecord], error) {
	...
	metadataWrapper := metadata.NewResourceMetadata[[]ApiV2010UsageRecord](
		records,
...
func (c *ApiService) StreamUsageRecordWithMetadata(params *ListUsageRecordParams) (*metadata.ResourceMetadata[chan ApiV2010UsageRecord], chan error) {
	if params == nil {
		params = &ListUsageRecordParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010UsageRecord](
