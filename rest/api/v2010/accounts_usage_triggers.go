...
func (c *ApiService) PageUsageTrigger(params *ListUsageTriggerParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Usage/Triggers.json"
...
func (c *ApiService) ListUsageTrigger(params *ListUsageTriggerParams) (ListUsageTrigger200Response, error) {
	response, errors := c.StreamUsageTrigger(params)

	records := make(ListUsageTrigger200Response, 0)
...
func (c *ApiService) StreamUsageTrigger(params *ListUsageTriggerParams) (chan ListUsageTrigger200Response, chan error) {
	if params == nil {
		params = &ListUsageTriggerParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageTrigger200Response, 1)
...
func (c *ApiService) streamUsageTrigger(response *, params *ListUsageTriggerParams, recordChannel chan ListUsageTrigger200Response, errorChannel chan error) {
	curRecord := 1
