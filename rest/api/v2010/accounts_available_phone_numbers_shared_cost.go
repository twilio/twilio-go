...
func (c *ApiService) AvailablePhoneNumberSharedCostPage(CountryCode string, params *ListAvailablePhoneNumberSharedCostParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/SharedCost.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) AvailablePhoneNumberSharedCostStream(CountryCode string, params *ListAvailablePhoneNumberSharedCostParams, limit int) (chan map[string]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
	page, err := c.AvailablePhoneNumberSharedCostPage(CountryCode, params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) AvailablePhoneNumberSharedCostList(CountryCode string, params *ListAvailablePhoneNumberSharedCostParams, limit int) ([]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
