...
func (c *ApiService) AddressPage(params *ListAddressParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Addresses.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) AddressStream(params *ListAddressParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AddressPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) AddressList(params *ListAddressParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AddressPage(params, "", "", fmt.Sprint(limits.PageSize))
