...
func (c *ApiService) PageAddress(params *ListAddressParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Addresses.json"
...
func (c *ApiService) ListAddress(params *ListAddressParams) (ListAddress200Response, error) {
	response, errors := c.StreamAddress(params)

	records := make(ListAddress200Response, 0)
...
func (c *ApiService) StreamAddress(params *ListAddressParams) (chan ListAddress200Response, chan error) {
	if params == nil {
		params = &ListAddressParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListAddress200Response, 1)
...
func (c *ApiService) streamAddress(response *, params *ListAddressParams, recordChannel chan ListAddress200Response, errorChannel chan error) {
	curRecord := 1
