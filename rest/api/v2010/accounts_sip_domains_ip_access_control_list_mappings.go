...
// CreateSipIpAccessControlListMappingWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateSipIpAccessControlListMappingWithMetadata(DomainSid string, params *CreateSipIpAccessControlListMappingParams) (*metadata.ResourceMetadata[ApiV2010SipIpAccessControlListMapping], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/IpAccessControlListMappings.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
	...
	metadataWrapper := metadata.NewResourceMetadata[ApiV2010SipIpAccessControlListMapping](
...
// DeleteSipIpAccessControlListMappingWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteSipIpAccessControlListMappingWithMetadata(DomainSid string, Sid string, params *DeleteSipIpAccessControlListMappingParams) (*metadata.ResourceMetadata[bool], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/IpAccessControlListMappings/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
// FetchSipIpAccessControlListMappingWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchSipIpAccessControlListMappingWithMetadata(DomainSid string, Sid string, params *FetchSipIpAccessControlListMappingParams) (*metadata.ResourceMetadata[ApiV2010SipIpAccessControlListMapping], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/IpAccessControlListMappings/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
// PageSipIpAccessControlListMappingWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageSipIpAccessControlListMappingWithMetadata(DomainSid string, params *ListSipIpAccessControlListMappingParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListSipIpAccessControlListMappingResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/IpAccessControlListMappings.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListSipIpAccessControlListMappingResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListSipIpAccessControlListMappingWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListSipIpAccessControlListMappingWithMetadata(DomainSid string, params *ListSipIpAccessControlListMappingParams) (*metadata.ResourceMetadata[[]ApiV2010SipIpAccessControlListMapping], error) {
	response, errors := c.StreamSipIpAccessControlListMappingWithMetadata(DomainSid, params)
...
// StreamSipIpAccessControlListMappingWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamSipIpAccessControlListMappingWithMetadata(DomainSid string, params *ListSipIpAccessControlListMappingParams) (*metadata.ResourceMetadata[chan ApiV2010SipIpAccessControlListMapping], chan error) {
	if params == nil {
		params = &ListSipIpAccessControlListMappingParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageSipIpAccessControlListMappingWithMetadata(DomainSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamSipIpAccessControlListMapping(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010SipIpAccessControlListMapping](
