...
func (c *ApiService) PageSipAuthCallsIpAccessControlListMapping(DomainSid string, params *ListSipAuthCallsIpAccessControlListMappingParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/Auth/Calls/IpAccessControlListMappings.json"
...
func (c *ApiService) ListSipAuthCallsIpAccessControlListMapping(DomainSid string, params *ListSipAuthCallsIpAccessControlListMappingParams) (ListSipAuthCallsIpAccessControlListMapping200Response, error) {
	response, errors := c.StreamSipAuthCallsIpAccessControlListMapping(DomainSid, params)

	records := make(ListSipAuthCallsIpAccessControlListMapping200Response, 0)
...
func (c *ApiService) StreamSipAuthCallsIpAccessControlListMapping(DomainSid string, params *ListSipAuthCallsIpAccessControlListMappingParams) (chan ListSipAuthCallsIpAccessControlListMapping200Response, chan error) {
	if params == nil {
		params = &ListSipAuthCallsIpAccessControlListMappingParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListSipAuthCallsIpAccessControlListMapping200Response, 1)
...
func (c *ApiService) streamSipAuthCallsIpAccessControlListMapping(response *, params *ListSipAuthCallsIpAccessControlListMappingParams, recordChannel chan ListSipAuthCallsIpAccessControlListMapping200Response, errorChannel chan error) {
	curRecord := 1
