...
func (c *ApiService) PageShortCode(params *ListShortCodeParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListShortCode(params *ListShortCodeParams) (ListShortCode200Response, error) {
	response, errors := c.StreamShortCode(params)

	records := make(ListShortCode200Response, 0)
...
func (c *ApiService) StreamShortCode(params *ListShortCodeParams) (chan ListShortCode200Response, chan error) {
	if params == nil {
		params = &ListShortCodeParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListShortCode200Response, 1)
...
func (c *ApiService) streamShortCode(response *, params *ListShortCodeParams, recordChannel chan ListShortCode200Response, errorChannel chan error) {
	curRecord := 1
