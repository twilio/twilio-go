...
func (c *ApiService) KeyPage(params *ListKeyParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Keys.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) KeyStream(params *ListKeyParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.KeyPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) KeyList(params *ListKeyParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.KeyPage(params, "", "", fmt.Sprint(limits.PageSize))
