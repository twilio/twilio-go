...
func (c *ApiService) PageKey(params *ListKeyParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/Keys.json"
...
func (c *ApiService) ListKey(params *ListKeyParams) (ListKey200Response, error) {
	response, errors := c.StreamKey(params)

	records := make(ListKey200Response, 0)
...
func (c *ApiService) StreamKey(params *ListKeyParams) (chan ListKey200Response, chan error) {
	if params == nil {
		params = &ListKeyParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListKey200Response, 1)
...
func (c *ApiService) streamKey(response *, params *ListKeyParams, recordChannel chan ListKey200Response, errorChannel chan error) {
	curRecord := 1
