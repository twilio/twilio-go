...
func (params *ListUsageRecordMonthlyParams) SetPageSize(PageSize int64) *ListUsageRecordMonthlyParams {
	params.PageSize = &PageSize
	return params
}
func (params *ListUsageRecordMonthlyParams) SetLimit(Limit int64) *ListUsageRecordMonthlyParams {
	params.Limit = &Limit
	return params
}
...
func (c *ApiService) streamUsageRecordMonthly(response *ListUsageRecordMonthlyResponse, params *ListUsageRecordMonthlyParams, recordChannel chan ApiV2010UsageRecordMonthly, errorChannel chan error) {
	...
	for response != nil {
		...
		record, err := client.GetNext(c.baseURL, response, c.getNextListUsageRecordMonthlyResponse)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
