...
func (c *ApiService) PageUsageRecordMonthly(params *ListUsageRecordMonthlyParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListUsageRecordMonthly(params *ListUsageRecordMonthlyParams) (ListUsageRecordMonthly200Response, error) {
	response, errors := c.StreamUsageRecordMonthly(params)

	records := make(ListUsageRecordMonthly200Response, 0)
...
func (c *ApiService) StreamUsageRecordMonthly(params *ListUsageRecordMonthlyParams) (chan ListUsageRecordMonthly200Response, chan error) {
	if params == nil {
		params = &ListUsageRecordMonthlyParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageRecordMonthly200Response, 1)
	...
	if err != nil {
		...
		go c.streamUsageRecordMonthly(response, params, recordChannel, errorChannel)
	}
...
func (c *ApiService) streamUsageRecordMonthly(response *, params *ListUsageRecordMonthlyParams, recordChannel chan ListUsageRecordMonthly200Response, errorChannel chan error) {
	curRecord := 1
