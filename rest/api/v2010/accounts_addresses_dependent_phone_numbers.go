...
func (c *ApiService) DependentPhoneNumberPage(AddressSid string, params *ListDependentPhoneNumberParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Addresses/{AddressSid}/DependentPhoneNumbers.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) DependentPhoneNumberStream(AddressSid string, params *ListDependentPhoneNumberParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.DependentPhoneNumberPage(AddressSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) DependentPhoneNumberList(AddressSid string, params *ListDependentPhoneNumberParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.DependentPhoneNumberPage(AddressSid, params, "", "", fmt.Sprint(limits.PageSize))
