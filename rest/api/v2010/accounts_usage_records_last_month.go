...
func (c *ApiService) PageUsageRecordLastMonth(params *ListUsageRecordLastMonthParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListUsageRecordLastMonth(params *ListUsageRecordLastMonthParams) (ListUsageRecordLastMonth200Response, error) {
	response, errors := c.StreamUsageRecordLastMonth(params)

	records := make(ListUsageRecordLastMonth200Response, 0)
...
func (c *ApiService) StreamUsageRecordLastMonth(params *ListUsageRecordLastMonthParams) (chan ListUsageRecordLastMonth200Response, chan error) {
	if params == nil {
		params = &ListUsageRecordLastMonthParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageRecordLastMonth200Response, 1)
...
func (c *ApiService) streamUsageRecordLastMonth(response *, params *ListUsageRecordLastMonthParams, recordChannel chan ListUsageRecordLastMonth200Response, errorChannel chan error) {
	curRecord := 1
