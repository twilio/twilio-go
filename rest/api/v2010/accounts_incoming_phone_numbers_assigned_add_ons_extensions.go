...
func (c *ApiService) IncomingPhoneNumberAssignedAddOnExtensionPage(ResourceSid string, AssignedAddOnSid string, params *ListIncomingPhoneNumberAssignedAddOnExtensionParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/{ResourceSid}/AssignedAddOns/{AssignedAddOnSid}/Extensions.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) IncomingPhoneNumberAssignedAddOnExtensionStream(ResourceSid string, AssignedAddOnSid string, params *ListIncomingPhoneNumberAssignedAddOnExtensionParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.IncomingPhoneNumberAssignedAddOnExtensionPage(ResourceSid, AssignedAddOnSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) IncomingPhoneNumberAssignedAddOnExtensionList(ResourceSid string, AssignedAddOnSid string, params *ListIncomingPhoneNumberAssignedAddOnExtensionParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.IncomingPhoneNumberAssignedAddOnExtensionPage(ResourceSid, AssignedAddOnSid, params, "", "", fmt.Sprint(limits.PageSize))
