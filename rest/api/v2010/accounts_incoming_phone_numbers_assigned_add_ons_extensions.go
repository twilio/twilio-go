...
func (c *ApiService) PageIncomingPhoneNumberAssignedAddOnExtension(ResourceSid string, AssignedAddOnSid string, params *ListIncomingPhoneNumberAssignedAddOnExtensionParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListIncomingPhoneNumberAssignedAddOnExtension(ResourceSid string, AssignedAddOnSid string, params *ListIncomingPhoneNumberAssignedAddOnExtensionParams) (ListIncomingPhoneNumberAssignedAddOnExtension200Response, error) {
	response, errors := c.StreamIncomingPhoneNumberAssignedAddOnExtension(ResourceSid, AssignedAddOnSid, params)

	records := make(ListIncomingPhoneNumberAssignedAddOnExtension200Response, 0)
...
func (c *ApiService) StreamIncomingPhoneNumberAssignedAddOnExtension(ResourceSid string, AssignedAddOnSid string, params *ListIncomingPhoneNumberAssignedAddOnExtensionParams) (chan ListIncomingPhoneNumberAssignedAddOnExtension200Response, chan error) {
	if params == nil {
		params = &ListIncomingPhoneNumberAssignedAddOnExtensionParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListIncomingPhoneNumberAssignedAddOnExtension200Response, 1)
...
func (c *ApiService) streamIncomingPhoneNumberAssignedAddOnExtension(response *, params *ListIncomingPhoneNumberAssignedAddOnExtensionParams, recordChannel chan ListIncomingPhoneNumberAssignedAddOnExtension200Response, errorChannel chan error) {
	curRecord := 1
