...
func (c *ApiService) PageRecording(params *ListRecordingParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListRecording(params *ListRecordingParams) (ListRecording200Response, error) {
	response, errors := c.StreamRecording(params)

	records := make(ListRecording200Response, 0)
...
func (c *ApiService) StreamRecording(params *ListRecordingParams) (chan ListRecording200Response, chan error) {
	if params == nil {
		params = &ListRecordingParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListRecording200Response, 1)
...
func (c *ApiService) streamRecording(response *, params *ListRecordingParams, recordChannel chan ListRecording200Response, errorChannel chan error) {
	curRecord := 1
