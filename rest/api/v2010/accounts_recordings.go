...
func (c *ApiService) DeleteRecording(Sid string, params *DeleteRecordingParams) error {
	return c.DeleteRecordingWithContext(context.TODO(), Sid, params)
}
func (c *ApiService) DeleteRecordingWithContext(ctx context.Context, Sid string, params *DeleteRecordingParams) error {
...
func (c *ApiService) FetchRecording(Sid string, params *FetchRecordingParams) (*ApiV2010Recording, error) {
	return c.FetchRecordingWithContext(context.TODO(), Sid, params)
}
func (c *ApiService) FetchRecordingWithContext(ctx context.Context, Sid string, params *FetchRecordingParams) (*ApiV2010Recording, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Recordings/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) PageRecording(params *ListRecordingParams, pageToken, pageNumber string) (*ListRecordingResponse, error) {
	return c.PageRecordingWithContext(context.TODO(), params, pageToken, pageNumber)
}

// Retrieve a single page of Recording records from the API. Request is executed immediately.
func (c *ApiService) PageRecordingWithContext(ctx context.Context, params *ListRecordingParams, pageToken, pageNumber string) (*ListRecordingResponse, error) {
...
func (c *ApiService) ListRecording(params *ListRecordingParams) ([]ApiV2010Recording, error) {
	return c.ListRecordingWithContext(context.TODO(), params)
}

// Lists Recording records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListRecordingWithContext(ctx context.Context, params *ListRecordingParams) ([]ApiV2010Recording, error) {
	response, errors := c.StreamRecordingWithContext(ctx, params)
...
func (c *ApiService) StreamRecording(params *ListRecordingParams) (chan ApiV2010Recording, chan error) {
	return c.StreamRecordingWithContext(context.TODO(), params)
}

// Streams Recording records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamRecordingWithContext(ctx context.Context, params *ListRecordingParams) (chan ApiV2010Recording, chan error) {
	if params == nil {
	...
	response, err := c.PageRecordingWithContext(ctx, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamRecordingWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamRecordingWithContext(ctx context.Context, response *ListRecordingResponse, params *ListRecordingParams, recordChannel chan ApiV2010Recording, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListRecordingResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListRecordingResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
