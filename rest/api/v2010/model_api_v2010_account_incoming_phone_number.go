...
type ApiV2010AccountIncomingPhoneNumber struct {
	...
	AddressRequirements  *IncomingPhoneNumberAddressRequirement `json:"address_requirements,omitempty"`
	...
	EmergencyStatus      *IncomingPhoneNumberEmergencyStatus    `json:"emergency_status,omitempty"`
	...
	VoiceReceiveMode     *IncomingPhoneNumberVoiceReceiveMode   `json:"voice_receive_mode,omitempty"`
