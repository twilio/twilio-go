...
func (c *ApiService) PageSipCredentialListMapping(DomainSid string, params *ListSipCredentialListMappingParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/CredentialListMappings.json"
...
func (c *ApiService) ListSipCredentialListMapping(DomainSid string, params *ListSipCredentialListMappingParams) (ListSipCredentialListMapping200Response, error) {
	response, errors := c.StreamSipCredentialListMapping(DomainSid, params)

	records := make(ListSipCredentialListMapping200Response, 0)
...
func (c *ApiService) StreamSipCredentialListMapping(DomainSid string, params *ListSipCredentialListMappingParams) (chan ListSipCredentialListMapping200Response, chan error) {
	if params == nil {
		params = &ListSipCredentialListMappingParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListSipCredentialListMapping200Response, 1)
...
func (c *ApiService) streamSipCredentialListMapping(response *, params *ListSipCredentialListMappingParams, recordChannel chan ListSipCredentialListMapping200Response, errorChannel chan error) {
	curRecord := 1
