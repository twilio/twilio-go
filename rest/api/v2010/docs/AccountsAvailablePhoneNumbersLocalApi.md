# AccountsAvailablePhoneNumbersLocalApi

All URIs are relative to *https://api.twilio.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**ListAvailablePhoneNumberLocal**](AccountsAvailablePhoneNumbersLocalApi.md#ListAvailablePhoneNumberLocal) | **Get** /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Local.json | 



## ListAvailablePhoneNumberLocal

> ListAvailablePhoneNumberLocal200Response ListAvailablePhoneNumberLocal(ctx, CountryCodeoptional)
...
[**ListAvailablePhoneNumberLocal200Response**](ListAvailablePhoneNumberLocal200Response.md)
