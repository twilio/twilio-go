...
func (c *ApiService) PageIncomingPhoneNumberTollFree(params *ListIncomingPhoneNumberTollFreeParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json"
...
func (c *ApiService) ListIncomingPhoneNumberTollFree(params *ListIncomingPhoneNumberTollFreeParams) (ListIncomingPhoneNumberTollFree200Response, error) {
	response, errors := c.StreamIncomingPhoneNumberTollFree(params)

	records := make(ListIncomingPhoneNumberTollFree200Response, 0)
...
func (c *ApiService) StreamIncomingPhoneNumberTollFree(params *ListIncomingPhoneNumberTollFreeParams) (chan ListIncomingPhoneNumberTollFree200Response, chan error) {
	if params == nil {
		params = &ListIncomingPhoneNumberTollFreeParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListIncomingPhoneNumberTollFree200Response, 1)
...
func (c *ApiService) streamIncomingPhoneNumberTollFree(response *, params *ListIncomingPhoneNumberTollFreeParams, recordChannel chan ListIncomingPhoneNumberTollFree200Response, errorChannel chan error) {
	curRecord := 1
