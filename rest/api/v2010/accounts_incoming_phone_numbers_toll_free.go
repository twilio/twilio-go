...
func (c *ApiService) ListIncomingPhoneNumberTollFree(params *ListIncomingPhoneNumberTollFreeParams) (*ListIncomingPhoneNumberTollFreeResponse, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) IncomingPhoneNumberTollFreePage(params *ListIncomingPhoneNumberTollFreeParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) IncomingPhoneNumberTollFreeStream(params *ListIncomingPhoneNumberTollFreeParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.IncomingPhoneNumberTollFreePage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) IncomingPhoneNumberTollFreeList(params *ListIncomingPhoneNumberTollFreeParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.IncomingPhoneNumberTollFreePage(params, "", "", fmt.Sprint(limits.PageSize))
