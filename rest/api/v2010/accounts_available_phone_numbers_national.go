...
func (c *ApiService) AvailablePhoneNumberNationalPage(CountryCode string, params *ListAvailablePhoneNumberNationalParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/National.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) AvailablePhoneNumberNationalStream(CountryCode string, params *ListAvailablePhoneNumberNationalParams, limit int) (chan map[string]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
	page, err := c.AvailablePhoneNumberNationalPage(CountryCode, params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) AvailablePhoneNumberNationalList(CountryCode string, params *ListAvailablePhoneNumberNationalParams, limit int) ([]interface{}, error) {
	if params.PageSize == nil {
		params.SetPageSize(0)
	}
	params.SetPageSize(c.requestHandler.ReadLimits(*params.PageSize, limit))
