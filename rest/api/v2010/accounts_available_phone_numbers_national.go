...
// PageAvailablePhoneNumberNationalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageAvailablePhoneNumberNationalWithMetadata(CountryCode string, params *ListAvailablePhoneNumberNationalParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListAvailablePhoneNumberNationalResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/National.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListAvailablePhoneNumberNationalResponse](
		*ps,             // The page object
...
// ListAvailablePhoneNumberNationalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListAvailablePhoneNumberNationalWithMetadata(CountryCode string, params *ListAvailablePhoneNumberNationalParams) (*metadata.ResourceMetadata[[]ApiV2010AvailablePhoneNumberNational], error) {
	response, errors := c.StreamAvailablePhoneNumberNationalWithMetadata(CountryCode, params)
	...
	metadataWrapper := metadata.NewResourceMetadata[[]ApiV2010AvailablePhoneNumberNational](
		records,
...
// StreamAvailablePhoneNumberNationalWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamAvailablePhoneNumberNationalWithMetadata(CountryCode string, params *ListAvailablePhoneNumberNationalParams) (*metadata.ResourceMetadata[chan ApiV2010AvailablePhoneNumberNational], chan error) {
	if params == nil {
		params = &ListAvailablePhoneNumberNationalParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageAvailablePhoneNumberNationalWithMetadata(CountryCode, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamAvailablePhoneNumberNational(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010AvailablePhoneNumberNational](
