...
func (c *ApiService) PageAvailablePhoneNumberNational(CountryCode string, params *ListAvailablePhoneNumberNationalParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListAvailablePhoneNumberNational(CountryCode string, params *ListAvailablePhoneNumberNationalParams) (ListAvailablePhoneNumberNational200Response, error) {
	response, errors := c.StreamAvailablePhoneNumberNational(CountryCode, params)

	records := make(ListAvailablePhoneNumberNational200Response, 0)
...
func (c *ApiService) StreamAvailablePhoneNumberNational(CountryCode string, params *ListAvailablePhoneNumberNationalParams) (chan ListAvailablePhoneNumberNational200Response, chan error) {
	if params == nil {
		params = &ListAvailablePhoneNumberNationalParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListAvailablePhoneNumberNational200Response, 1)
...
func (c *ApiService) streamAvailablePhoneNumberNational(response *, params *ListAvailablePhoneNumberNationalParams, recordChannel chan ListAvailablePhoneNumberNational200Response, errorChannel chan error) {
	curRecord := 1
