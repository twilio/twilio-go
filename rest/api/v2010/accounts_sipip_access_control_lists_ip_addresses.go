...
func (c *ApiService) PageSipIpAddress(IpAccessControlListSid string, params *ListSipIpAddressParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/SIP/IpAccessControlLists/{IpAccessControlListSid}/IpAddresses.json"
...
func (c *ApiService) ListSipIpAddress(IpAccessControlListSid string, params *ListSipIpAddressParams) (ListSipIpAddress200Response, error) {
	response, errors := c.StreamSipIpAddress(IpAccessControlListSid, params)

	records := make(ListSipIpAddress200Response, 0)
...
func (c *ApiService) StreamSipIpAddress(IpAccessControlListSid string, params *ListSipIpAddressParams) (chan ListSipIpAddress200Response, chan error) {
	if params == nil {
		params = &ListSipIpAddressParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListSipIpAddress200Response, 1)
...
func (c *ApiService) streamSipIpAddress(response *, params *ListSipIpAddressParams, recordChannel chan ListSipIpAddress200Response, errorChannel chan error) {
	curRecord := 1
