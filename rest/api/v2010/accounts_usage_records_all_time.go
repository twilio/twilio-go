...
func (c *ApiService) PageUsageRecordAllTime(params *ListUsageRecordAllTimeParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListUsageRecordAllTime(params *ListUsageRecordAllTimeParams) (ListUsageRecordAllTime200Response, error) {
	response, errors := c.StreamUsageRecordAllTime(params)

	records := make(ListUsageRecordAllTime200Response, 0)
...
func (c *ApiService) StreamUsageRecordAllTime(params *ListUsageRecordAllTimeParams) (chan ListUsageRecordAllTime200Response, chan error) {
	if params == nil {
		params = &ListUsageRecordAllTimeParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageRecordAllTime200Response, 1)
...
func (c *ApiService) streamUsageRecordAllTime(response *, params *ListUsageRecordAllTimeParams, recordChannel chan ListUsageRecordAllTime200Response, errorChannel chan error) {
	curRecord := 1
