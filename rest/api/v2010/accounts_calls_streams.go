...
// CreateStreamWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateStreamWithMetadata(CallSid string, params *CreateStreamParams) (*metadata.ResourceMetadata[ApiV2010Stream], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Streams.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
	...
	metadataWrapper := metadata.NewResourceMetadata[ApiV2010Stream](
...
// UpdateStreamWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) UpdateStreamWithMetadata(CallSid string, Sid string, params *UpdateStreamParams) (*metadata.ResourceMetadata[ApiV2010Stream], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Streams/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
