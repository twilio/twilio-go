...
// DeleteConnectAppWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteConnectAppWithMetadata(Sid string, params *DeleteConnectAppParams) (*metadata.ResourceMetadata[bool], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/ConnectApps/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
// FetchConnectAppWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchConnectAppWithMetadata(Sid string, params *FetchConnectAppParams) (*metadata.ResourceMetadata[ApiV2010ConnectApp], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/ConnectApps/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
	...
	metadataWrapper := metadata.NewResourceMetadata[ApiV2010ConnectApp](
...
// PageConnectAppWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageConnectAppWithMetadata(params *ListConnectAppParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListConnectAppResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/ConnectApps.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListConnectAppResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListConnectAppWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListConnectAppWithMetadata(params *ListConnectAppParams) (*metadata.ResourceMetadata[[]ApiV2010ConnectApp], error) {
	response, errors := c.StreamConnectAppWithMetadata(params)
...
// StreamConnectAppWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamConnectAppWithMetadata(params *ListConnectAppParams) (*metadata.ResourceMetadata[chan ApiV2010ConnectApp], chan error) {
	if params == nil {
		params = &ListConnectAppParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageConnectAppWithMetadata(params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamConnectApp(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010ConnectApp](
...
// UpdateConnectAppWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) UpdateConnectAppWithMetadata(Sid string, params *UpdateConnectAppParams) (*metadata.ResourceMetadata[ApiV2010ConnectApp], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/ConnectApps/{Sid}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
