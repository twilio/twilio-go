...
func (c *ApiService) ConnectAppPage(params *ListConnectAppParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/ConnectApps.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) ConnectAppStream(params *ListConnectAppParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ConnectAppPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) ConnectAppList(params *ListConnectAppParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ConnectAppPage(params, "", "", fmt.Sprint(limits.PageSize))
