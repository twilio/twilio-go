...
func (c *ApiService) PageIncomingPhoneNumber(params *ListIncomingPhoneNumberParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers.json"
...
func (c *ApiService) ListIncomingPhoneNumber(params *ListIncomingPhoneNumberParams) (ListIncomingPhoneNumber200Response, error) {
	response, errors := c.StreamIncomingPhoneNumber(params)

	records := make(ListIncomingPhoneNumber200Response, 0)
...
func (c *ApiService) StreamIncomingPhoneNumber(params *ListIncomingPhoneNumberParams) (chan ListIncomingPhoneNumber200Response, chan error) {
	if params == nil {
		params = &ListIncomingPhoneNumberParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListIncomingPhoneNumber200Response, 1)
...
func (c *ApiService) streamIncomingPhoneNumber(response *, params *ListIncomingPhoneNumberParams, recordChannel chan ListIncomingPhoneNumber200Response, errorChannel chan error) {
	curRecord := 1
