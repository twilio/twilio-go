...
func (c *ApiService) IncomingPhoneNumberPage(params *ListIncomingPhoneNumberParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) IncomingPhoneNumberStream(params *ListIncomingPhoneNumberParams, limit int) (chan map[string]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.IncomingPhoneNumberPage(params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) IncomingPhoneNumberList(params *ListIncomingPhoneNumberParams, limit int) ([]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.IncomingPhoneNumberPage(params, "", "")
	if err != nil {
		return nil, err
