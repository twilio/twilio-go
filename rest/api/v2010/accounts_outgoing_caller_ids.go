...
func (c *ApiService) PageOutgoingCallerId(params *ListOutgoingCallerIdParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/OutgoingCallerIds.json"
...
func (c *ApiService) ListOutgoingCallerId(params *ListOutgoingCallerIdParams) (ListOutgoingCallerId200Response, error) {
	response, errors := c.StreamOutgoingCallerId(params)

	records := make(ListOutgoingCallerId200Response, 0)
...
func (c *ApiService) StreamOutgoingCallerId(params *ListOutgoingCallerIdParams) (chan ListOutgoingCallerId200Response, chan error) {
	if params == nil {
		params = &ListOutgoingCallerIdParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListOutgoingCallerId200Response, 1)
...
func (c *ApiService) streamOutgoingCallerId(response *, params *ListOutgoingCallerIdParams, recordChannel chan ListOutgoingCallerId200Response, errorChannel chan error) {
	curRecord := 1
