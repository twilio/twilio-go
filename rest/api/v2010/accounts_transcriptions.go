...
func (c *ApiService) PageTranscription(params *ListTranscriptionParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListTranscription(params *ListTranscriptionParams) (ListTranscription200Response, error) {
	response, errors := c.StreamTranscription(params)

	records := make(ListTranscription200Response, 0)
...
func (c *ApiService) StreamTranscription(params *ListTranscriptionParams) (chan ListTranscription200Response, chan error) {
	if params == nil {
		params = &ListTranscriptionParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListTranscription200Response, 1)
...
func (c *ApiService) streamTranscription(response *, params *ListTranscriptionParams, recordChannel chan ListTranscription200Response, errorChannel chan error) {
	curRecord := 1
