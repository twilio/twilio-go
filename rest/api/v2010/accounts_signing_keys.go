...
func (c *ApiService) PageSigningKey(params *ListSigningKeyParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/SigningKeys.json"
...
func (c *ApiService) ListSigningKey(params *ListSigningKeyParams) (ListSigningKey200Response, error) {
	response, errors := c.StreamSigningKey(params)

	records := make(ListSigningKey200Response, 0)
...
func (c *ApiService) StreamSigningKey(params *ListSigningKeyParams) (chan ListSigningKey200Response, chan error) {
	if params == nil {
		params = &ListSigningKeyParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListSigningKey200Response, 1)
...
func (c *ApiService) streamSigningKey(response *, params *ListSigningKeyParams, recordChannel chan ListSigningKey200Response, errorChannel chan error) {
	curRecord := 1
