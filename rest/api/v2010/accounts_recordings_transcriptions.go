...
func (c *ApiService) PageRecordingTranscription(RecordingSid string, params *ListRecordingTranscriptionParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListRecordingTranscription(RecordingSid string, params *ListRecordingTranscriptionParams) (ListRecordingTranscription200Response, error) {
	response, errors := c.StreamRecordingTranscription(RecordingSid, params)

	records := make(ListRecordingTranscription200Response, 0)
...
func (c *ApiService) StreamRecordingTranscription(RecordingSid string, params *ListRecordingTranscriptionParams) (chan ListRecordingTranscription200Response, chan error) {
	if params == nil {
		params = &ListRecordingTranscriptionParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListRecordingTranscription200Response, 1)
...
func (c *ApiService) streamRecordingTranscription(response *, params *ListRecordingTranscriptionParams, recordChannel chan ListRecordingTranscription200Response, errorChannel chan error) {
	curRecord := 1
