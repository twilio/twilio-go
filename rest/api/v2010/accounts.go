...
func (c *ApiService) ListAccount(params *ListAccountParams, limit *int) ([]*ListAccountResponse, error) {
	...
	curRecord := 0
	var records []*ListAccountResponse
...
func (c *ApiService) StreamAccount(params *ListAccountParams, limit *int) (chan *ListAccountResponse, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
	...
	channel := make(chan *ListAccountResponse, 1)
