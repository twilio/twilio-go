...
func (c *ApiService) PageAccount(params *ListAccountParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts.json"
...
func (c *ApiService) ListAccount(params *ListAccountParams) (ListAccount200Response, error) {
	response, errors := c.StreamAccount(params)

	records := make(ListAccount200Response, 0)
...
func (c *ApiService) StreamAccount(params *ListAccountParams) (chan ListAccount200Response, chan error) {
	if params == nil {
		params = &ListAccountParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListAccount200Response, 1)
...
func (c *ApiService) streamAccount(response *, params *ListAccountParams, recordChannel chan ListAccount200Response, errorChannel chan error) {
	curRecord := 1
