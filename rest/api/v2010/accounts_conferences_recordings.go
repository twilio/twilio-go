...
func (c *ApiService) ConferenceRecordingPage(ConferenceSid string, params *ListConferenceRecordingParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/2010-04-01/Accounts/{AccountSid}/Conferences/{ConferenceSid}/Recordings.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
...
func (c *ApiService) ConferenceRecordingStream(ConferenceSid string, params *ListConferenceRecordingParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ConferenceRecordingPage(ConferenceSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) ConferenceRecordingList(ConferenceSid string, params *ListConferenceRecordingParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ConferenceRecordingPage(ConferenceSid, params, "", "", fmt.Sprint(limits.PageSize))
