...
func (c *ApiService) PageUsageRecordYearly(params *ListUsageRecordYearlyParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListUsageRecordYearly(params *ListUsageRecordYearlyParams) (ListUsageRecordYearly200Response, error) {
	response, errors := c.StreamUsageRecordYearly(params)

	records := make(ListUsageRecordYearly200Response, 0)
...
func (c *ApiService) StreamUsageRecordYearly(params *ListUsageRecordYearlyParams) (chan ListUsageRecordYearly200Response, chan error) {
	if params == nil {
		params = &ListUsageRecordYearlyParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageRecordYearly200Response, 1)
...
func (c *ApiService) streamUsageRecordYearly(response *, params *ListUsageRecordYearlyParams, recordChannel chan ListUsageRecordYearly200Response, errorChannel chan error) {
	curRecord := 1
