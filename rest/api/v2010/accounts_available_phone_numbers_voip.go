...
func (c *ApiService) PageAvailablePhoneNumberVoip(CountryCode string, params *ListAvailablePhoneNumberVoipParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListAvailablePhoneNumberVoip(CountryCode string, params *ListAvailablePhoneNumberVoipParams) (ListAvailablePhoneNumberVoip200Response, error) {
	response, errors := c.StreamAvailablePhoneNumberVoip(CountryCode, params)

	records := make(ListAvailablePhoneNumberVoip200Response, 0)
...
func (c *ApiService) StreamAvailablePhoneNumberVoip(CountryCode string, params *ListAvailablePhoneNumberVoipParams) (chan ListAvailablePhoneNumberVoip200Response, chan error) {
	if params == nil {
		params = &ListAvailablePhoneNumberVoipParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListAvailablePhoneNumberVoip200Response, 1)
...
func (c *ApiService) streamAvailablePhoneNumberVoip(response *, params *ListAvailablePhoneNumberVoipParams, recordChannel chan ListAvailablePhoneNumberVoip200Response, errorChannel chan error) {
	curRecord := 1
