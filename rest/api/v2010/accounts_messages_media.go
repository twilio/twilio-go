...
func (c *ApiService) PageMedia(MessageSid string, params *ListMediaParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListMedia(MessageSid string, params *ListMediaParams) (ListMedia200Response, error) {
	response, errors := c.StreamMedia(MessageSid, params)

	records := make(ListMedia200Response, 0)
...
func (c *ApiService) StreamMedia(MessageSid string, params *ListMediaParams) (chan ListMedia200Response, chan error) {
	if params == nil {
		params = &ListMediaParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListMedia200Response, 1)
...
func (c *ApiService) streamMedia(response *, params *ListMediaParams, recordChannel chan ListMedia200Response, errorChannel chan error) {
	curRecord := 1
