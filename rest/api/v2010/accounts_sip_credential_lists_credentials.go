...
func (c *ApiService) PageSipCredential(CredentialListSid string, params *ListSipCredentialParams, pageToken, pageNumber string) (*, error) {
    path := "/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{CredentialListSid}/Credentials.json"
...
func (c *ApiService) ListSipCredential(CredentialListSid string, params *ListSipCredentialParams) (ListSipCredential200Response, error) {
	response, errors := c.StreamSipCredential(CredentialListSid, params)

	records := make(ListSipCredential200Response, 0)
...
func (c *ApiService) StreamSipCredential(CredentialListSid string, params *ListSipCredentialParams) (chan ListSipCredential200Response, chan error) {
	if params == nil {
		params = &ListSipCredentialParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListSipCredential200Response, 1)
...
func (c *ApiService) streamSipCredential(response *, params *ListSipCredentialParams, recordChannel chan ListSipCredential200Response, errorChannel chan error) {
	curRecord := 1
