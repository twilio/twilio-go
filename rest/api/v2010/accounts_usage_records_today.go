...
// PageUsageRecordTodayWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageUsageRecordTodayWithMetadata(params *ListUsageRecordTodayParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListUsageRecordTodayResponse], error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Usage/Records/Today.json"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListUsageRecordTodayResponse](
		*ps,             // The page object
...
// ListUsageRecordTodayWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListUsageRecordTodayWithMetadata(params *ListUsageRecordTodayParams) (*metadata.ResourceMetadata[[]ApiV2010UsageRecordToday], error) {
	response, errors := c.StreamUsageRecordTodayWithMetadata(params)
	...
	metadataWrapper := metadata.NewResourceMetadata[[]ApiV2010UsageRecordToday](
		records,
...
// StreamUsageRecordTodayWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamUsageRecordTodayWithMetadata(params *ListUsageRecordTodayParams) (*metadata.ResourceMetadata[chan ApiV2010UsageRecordToday], chan error) {
	if params == nil {
		params = &ListUsageRecordTodayParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageUsageRecordTodayWithMetadata(params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamUsageRecordToday(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ApiV2010UsageRecordToday](
