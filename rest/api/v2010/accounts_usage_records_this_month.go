...
func (c *ApiService) PageUsageRecordThisMonth(params *ListUsageRecordThisMonthParams, pageToken, pageNumber string) (*, error) {
...
func (c *ApiService) ListUsageRecordThisMonth(params *ListUsageRecordThisMonthParams) (ListUsageRecordThisMonth200Response, error) {
	response, errors := c.StreamUsageRecordThisMonth(params)

	records := make(ListUsageRecordThisMonth200Response, 0)
...
func (c *ApiService) StreamUsageRecordThisMonth(params *ListUsageRecordThisMonthParams) (chan ListUsageRecordThisMonth200Response, chan error) {
	if params == nil {
		params = &ListUsageRecordThisMonthParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ListUsageRecordThisMonth200Response, 1)
...
func (c *ApiService) streamUsageRecordThisMonth(response *, params *ListUsageRecordThisMonthParams, recordChannel chan ListUsageRecordThisMonth200Response, errorChannel chan error) {
	curRecord := 1
