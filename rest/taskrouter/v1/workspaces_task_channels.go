...
func (c *ApiService) TaskChannelPage(WorkspaceSid string, params *ListTaskChannelParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Workspaces/{WorkspaceSid}/TaskChannels"
	path = strings.Replace(path, "{"+"WorkspaceSid"+"}", WorkspaceSid, -1)
...
func (c *ApiService) TaskChannelStream(WorkspaceSid string, params *ListTaskChannelParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.TaskChannelPage(WorkspaceSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) TaskChannelList(WorkspaceSid string, params *ListTaskChannelParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.TaskChannelPage(WorkspaceSid, params, "", "", fmt.Sprint(limits.PageSize))
