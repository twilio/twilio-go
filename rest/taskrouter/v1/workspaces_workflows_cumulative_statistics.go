...
func (c *ApiService) FetchWorkflowCumulativeStatistics(WorkspaceSid string, WorkflowSid string, params *FetchWorkflowCumulativeStatisticsParams) (*TaskrouterV1WorkflowCumulativeStatistics, error) {
	...
	ps := &TaskrouterV1WorkflowCumulativeStatistics{}
...
// FetchWorkflowCumulativeStatisticsWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchWorkflowCumulativeStatisticsWithMetadata(WorkspaceSid string, WorkflowSid string, params *FetchWorkflowCumulativeStatisticsParams) (*metadata.ResourceMetadata[TaskrouterV1WorkflowCumulativeStatistics], error) {
	path := "/v1/Workspaces/{WorkspaceSid}/Workflows/{WorkflowSid}/CumulativeStatistics"
	path = strings.Replace(path, "{"+"WorkspaceSid"+"}", WorkspaceSid, -1)
	path = strings.Replace(path, "{"+"WorkflowSid"+"}", WorkflowSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[TaskrouterV1WorkflowCumulativeStatistics](
