...
func (c *ApiService) TaskQueuesStatisticsPage(WorkspaceSid string, params *ListTaskQueuesStatisticsParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Workspaces/{WorkspaceSid}/TaskQueues/Statistics"
	path = strings.Replace(path, "{"+"WorkspaceSid"+"}", WorkspaceSid, -1)
...
func (c *ApiService) TaskQueuesStatisticsStream(WorkspaceSid string, params *ListTaskQueuesStatisticsParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.TaskQueuesStatisticsPage(WorkspaceSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) TaskQueuesStatisticsList(WorkspaceSid string, params *ListTaskQueuesStatisticsParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.TaskQueuesStatisticsPage(WorkspaceSid, params, "", "", fmt.Sprint(limits.PageSize))
