...
func (c *ApiService) FetchWorkersRealTimeStatistics(WorkspaceSid string, params *FetchWorkersRealTimeStatisticsParams) (*TaskrouterV1WorkersRealTimeStatistics, error) {
	return c.FetchWorkersRealTimeStatisticsWithContext(context.TODO(), WorkspaceSid, params)
}
func (c *ApiService) FetchWorkersRealTimeStatisticsWithContext(ctx context.Context, WorkspaceSid string, params *FetchWorkersRealTimeStatisticsParams) (*TaskrouterV1WorkersRealTimeStatistics, error) {
