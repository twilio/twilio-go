...
func (c *ApiService) FetchWorkflowRealTimeStatistics(WorkspaceSid string, WorkflowSid string, params *FetchWorkflowRealTimeStatisticsParams) (*TaskrouterV1WorkflowRealTimeStatistics, error) {
	return c.FetchWorkflowRealTimeStatisticsWithContext(context.TODO(), WorkspaceSid, WorkflowSid, params)
}
func (c *ApiService) FetchWorkflowRealTimeStatisticsWithContext(ctx context.Context, WorkspaceSid string, WorkflowSid string, params *FetchWorkflowRealTimeStatisticsParams) (*TaskrouterV1WorkflowRealTimeStatistics, error) {
