...
**ReservationsCreated** | Pointer to **int** | The total number of Reservations created for Tasks in the TaskQueue. |[default to 0]
**ReservationsAccepted** | Pointer to **int** | The total number of Reservations accepted for Tasks in the TaskQueue. |[default to 0]
**ReservationsRejected** | Pointer to **int** | The total number of Reservations rejected for Tasks in the TaskQueue. |[default to 0]
**ReservationsTimedOut** | Pointer to **int** | The total number of Reservations that timed out for Tasks in the TaskQueue. |[default to 0]
**ReservationsCanceled** | Pointer to **int** | The total number of Reservations canceled for Tasks in the TaskQueue. |[default to 0]
**ReservationsRescinded** | Pointer to **int** | The total number of Reservations rescinded. |[default to 0]
...
**TasksCanceled** | Pointer to **int** | The total number of Tasks canceled in the TaskQueue. |[default to 0]
**TasksCompleted** | Pointer to **int** | The total number of Tasks completed in the TaskQueue. |[default to 0]
**TasksDeleted** | Pointer to **int** | The total number of Tasks deleted in the TaskQueue. |[default to 0]
**TasksEntered** | Pointer to **int** | The total number of Tasks entered into the TaskQueue. |[default to 0]
