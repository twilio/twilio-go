...
// FetchWorkspaceRealTimeStatisticsWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchWorkspaceRealTimeStatisticsWithMetadata(WorkspaceSid string, params *FetchWorkspaceRealTimeStatisticsParams) (*metadata.ResourceMetadata[TaskrouterV1WorkspaceRealTimeStatistics], error) {
	path := "/v1/Workspaces/{WorkspaceSid}/RealTimeStatistics"
	path = strings.Replace(path, "{"+"WorkspaceSid"+"}", WorkspaceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[TaskrouterV1WorkspaceRealTimeStatistics](
