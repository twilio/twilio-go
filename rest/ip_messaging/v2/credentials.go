...
func (c *ApiService) CreateCredentialWithContext(ctx context.Context, params *CreateCredentialParams) (*IpMessagingV2Credential, error) {
	path := "/v2/Credentials"
...
func (c *ApiService) FetchCredentialWithContext(ctx context.Context, Sid string) (*IpMessagingV2Credential, error) {
	path := "/v2/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Credential records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListCredentialWithContext(ctx context.Context, params *ListCredentialParams) ([]IpMessagingV2Credential, error) {
...
// Streams Credential records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamCredentialWithContext(ctx context.Context, params *ListCredentialParams) (chan IpMessagingV2Credential, chan error) {
	if params == nil {
...
func (c *ApiService) streamCredentialWithContext(ctx context.Context, response *ListCredentialResponse, params *ListCredentialParams, recordChannel chan IpMessagingV2Credential, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateCredentialWithContext(ctx context.Context, Sid string, params *UpdateCredentialParams) (*IpMessagingV2Credential, error) {
	path := "/v2/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
