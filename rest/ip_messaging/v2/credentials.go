...
func (c *ApiService) ListCredential(params *ListCredentialParams, limit int) ([]IpMessagingV2Credential, error) {
	if params == nil {
...
func (c *ApiService) StreamCredential(params *ListCredentialParams, limit int) (chan IpMessagingV2Credential, error) {
	if params == nil {
		params = &ListCredentialParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
