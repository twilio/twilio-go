...
func (c *ApiService) ListBinding(ServiceSid string, params *ListBindingParams, limit int) ([]IpMessagingV2ServiceBinding, error) {
...
func (c *ApiService) StreamBinding(ServiceSid string, params *ListBindingParams, limit int) (chan IpMessagingV2ServiceBinding, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
