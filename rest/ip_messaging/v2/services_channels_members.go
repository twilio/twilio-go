...
func (c *ApiService) ListMember(ServiceSid string, ChannelSid string, params *ListMemberParams, limit int) ([]IpMessagingV2ServiceChannelMember, error) {
...
func (c *ApiService) StreamMember(ServiceSid string, ChannelSid string, params *ListMemberParams, limit int) (chan IpMessagingV2ServiceChannelMember, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
