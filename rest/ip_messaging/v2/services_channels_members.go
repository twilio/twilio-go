...
func (c *ApiService) CreateMemberWithMetadata(ServiceSid string, ChannelSid string, params *CreateMemberParams) (*metadata.ResourceMetadata[IpMessagingV2Member], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Members"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV2Member](
...
func (c *ApiService) DeleteMemberWithMetadata(ServiceSid string, ChannelSid string, Sid string, params *DeleteMemberParams) (*metadata.ResourceMetadata[bool], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Members/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) FetchMemberWithMetadata(ServiceSid string, ChannelSid string, Sid string) (*metadata.ResourceMetadata[IpMessagingV2Member], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Members/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListMemberWithMetadata(ServiceSid string, ChannelSid string, params *ListMemberParams) (*metadata.ResourceMetadata[[]IpMessagingV2Member], error) {
...
func (c *ApiService) StreamMemberWithMetadata(ServiceSid string, ChannelSid string, params *ListMemberParams) (*metadata.ResourceMetadata[chan IpMessagingV2Member], chan error) {
	if params == nil {
		params = &ListMemberParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV2Member](
...
func (c *ApiService) UpdateMemberWithMetadata(ServiceSid string, ChannelSid string, Sid string, params *UpdateMemberParams) (*metadata.ResourceMetadata[IpMessagingV2Member], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Members/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
