...
func (c *ApiService) CreateRoleWithMetadata(ServiceSid string, params *CreateRoleParams) (*metadata.ResourceMetadata[IpMessagingV2Role], error) {
	path := "/v2/Services/{ServiceSid}/Roles"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV2Role](
...
func (c *ApiService) FetchRoleWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[IpMessagingV2Role], error) {
	path := "/v2/Services/{ServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListRoleWithMetadata(ServiceSid string, params *ListRoleParams) (*metadata.ResourceMetadata[[]IpMessagingV2Role], error) {
...
func (c *ApiService) StreamRole(ServiceSid string, params *ListRoleParams) (chan IpMessagingV2Role, chan error) {
	...
	recordChannel := make(chan IpMessagingV2Role, 1)
...
func (c *ApiService) StreamRoleWithMetadata(ServiceSid string, params *ListRoleParams) (*metadata.ResourceMetadata[chan IpMessagingV2Role], chan error) {
	if params == nil {
		params = &ListRoleParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV2Role](
...
func (c *ApiService) UpdateRoleWithMetadata(ServiceSid string, Sid string, params *UpdateRoleParams) (*metadata.ResourceMetadata[IpMessagingV2Role], error) {
	path := "/v2/Services/{ServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
