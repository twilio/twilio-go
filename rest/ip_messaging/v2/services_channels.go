...
func (c *ApiService) CreateChannel(ServiceSid string, params *CreateChannelParams) (*IpMessagingV2Channel, error) {
	return c.CreateChannelWithContext(context.TODO(), ServiceSid, params)
}
func (c *ApiService) CreateChannelWithContext(ctx context.Context, ServiceSid string, params *CreateChannelParams) (*IpMessagingV2Channel, error) {
...
func (c *ApiService) DeleteChannel(ServiceSid string, Sid string, params *DeleteChannelParams) error {
	return c.DeleteChannelWithContext(context.TODO(), ServiceSid, Sid, params)
}
func (c *ApiService) DeleteChannelWithContext(ctx context.Context, ServiceSid string, Sid string, params *DeleteChannelParams) error {
...
func (c *ApiService) FetchChannel(ServiceSid string, Sid string) (*IpMessagingV2Channel, error) {
	return c.FetchChannelWithContext(context.TODO(), ServiceSid, Sid)
}
func (c *ApiService) FetchChannelWithContext(ctx context.Context, ServiceSid string, Sid string) (*IpMessagingV2Channel, error) {
	path := "/v2/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageChannel(ServiceSid string, params *ListChannelParams, pageToken, pageNumber string) (*ListChannelResponse, error) {
	return c.PageChannelWithContext(context.TODO(), ServiceSid, params, pageToken, pageNumber)
}

// Retrieve a single page of Channel records from the API. Request is executed immediately.
func (c *ApiService) PageChannelWithContext(ctx context.Context, ServiceSid string, params *ListChannelParams, pageToken, pageNumber string) (*ListChannelResponse, error) {
	path := "/v2/Services/{ServiceSid}/Channels"
...
func (c *ApiService) ListChannel(ServiceSid string, params *ListChannelParams) ([]IpMessagingV2Channel, error) {
	return c.ListChannelWithContext(context.TODO(), ServiceSid, params)
}

// Lists Channel records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListChannelWithContext(ctx context.Context, ServiceSid string, params *ListChannelParams) ([]IpMessagingV2Channel, error) {
	response, errors := c.StreamChannelWithContext(ctx, ServiceSid, params)
...
func (c *ApiService) StreamChannel(ServiceSid string, params *ListChannelParams) (chan IpMessagingV2Channel, chan error) {
	return c.StreamChannelWithContext(context.TODO(), ServiceSid, params)
}

// Streams Channel records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamChannelWithContext(ctx context.Context, ServiceSid string, params *ListChannelParams) (chan IpMessagingV2Channel, chan error) {
	if params == nil {
	...
	response, err := c.PageChannelWithContext(ctx, ServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamChannelWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamChannelWithContext(ctx context.Context, response *ListChannelResponse, params *ListChannelParams, recordChannel chan IpMessagingV2Channel, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListChannelResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListChannelResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
...
func (c *ApiService) UpdateChannel(ServiceSid string, Sid string, params *UpdateChannelParams) (*IpMessagingV2Channel, error) {
	return c.UpdateChannelWithContext(context.TODO(), ServiceSid, Sid, params)
}
func (c *ApiService) UpdateChannelWithContext(ctx context.Context, ServiceSid string, Sid string, params *UpdateChannelParams) (*IpMessagingV2Channel, error) {
	path := "/v2/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
