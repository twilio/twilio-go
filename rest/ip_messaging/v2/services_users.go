...
func (c *ApiService) CreateUserWithMetadata(ServiceSid string, params *CreateUserParams) (*metadata.ResourceMetadata[IpMessagingV2User], error) {
	path := "/v2/Services/{ServiceSid}/Users"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV2User](
...
func (c *ApiService) FetchUserWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[IpMessagingV2User], error) {
	path := "/v2/Services/{ServiceSid}/Users/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListUserWithMetadata(ServiceSid string, params *ListUserParams) (*metadata.ResourceMetadata[[]IpMessagingV2User], error) {
...
func (c *ApiService) StreamUser(ServiceSid string, params *ListUserParams) (chan IpMessagingV2User, chan error) {
	...
	recordChannel := make(chan IpMessagingV2User, 1)
...
func (c *ApiService) StreamUserWithMetadata(ServiceSid string, params *ListUserParams) (*metadata.ResourceMetadata[chan IpMessagingV2User], chan error) {
	if params == nil {
		params = &ListUserParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV2User](
...
func (c *ApiService) UpdateUserWithMetadata(ServiceSid string, Sid string, params *UpdateUserParams) (*metadata.ResourceMetadata[IpMessagingV2User], error) {
	path := "/v2/Services/{ServiceSid}/Users/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
