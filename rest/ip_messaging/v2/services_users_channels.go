...
func (c *ApiService) DeleteUserChannelWithMetadata(ServiceSid string, UserSid string, ChannelSid string) (*metadata.ResourceMetadata[bool], error) {
	path := "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
...
func (c *ApiService) FetchUserChannelWithMetadata(ServiceSid string, UserSid string, ChannelSid string) (*metadata.ResourceMetadata[IpMessagingV2UserChannel], error) {
	path := "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV2UserChannel](
...
func (c *ApiService) ListUserChannelWithMetadata(ServiceSid string, UserSid string, params *ListUserChannelParams) (*metadata.ResourceMetadata[[]IpMessagingV2UserChannel], error) {
...
func (c *ApiService) StreamUserChannelWithMetadata(ServiceSid string, UserSid string, params *ListUserChannelParams) (*metadata.ResourceMetadata[chan IpMessagingV2UserChannel], chan error) {
	if params == nil {
		params = &ListUserChannelParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV2UserChannel](
...
func (c *ApiService) UpdateUserChannelWithMetadata(ServiceSid string, UserSid string, ChannelSid string, params *UpdateUserChannelParams) (*metadata.ResourceMetadata[IpMessagingV2UserChannel], error) {
	path := "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
