...
// Lists User records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListUserWithCtx(ctx context.Context, ServiceSid string, params *ListUserParams) ([]IpMessagingV1User, error) {
...
// Streams User records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamUserWithCtx(ctx context.Context, ServiceSid string, params *ListUserParams) (chan IpMessagingV1User, chan error) {
	if params == nil {
...
func (c *ApiService) streamUser(ctx context.Context, response *ListUserResponse, params *ListUserParams, recordChannel chan IpMessagingV1User, errorChannel chan error) {
	curRecord := 1
