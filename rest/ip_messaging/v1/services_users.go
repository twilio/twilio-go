...
func (c *ApiService) CreateUserWithMetadata(ServiceSid string, params *CreateUserParams) (*metadata.ResourceMetadata[IpMessagingV1User], error) {
	path := "/v1/Services/{ServiceSid}/Users"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV1User](
...
func (c *ApiService) FetchUserWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[IpMessagingV1User], error) {
	path := "/v1/Services/{ServiceSid}/Users/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListUserWithMetadata(ServiceSid string, params *ListUserParams) (*metadata.ResourceMetadata[[]IpMessagingV1User], error) {
...
func (c *ApiService) StreamUserWithMetadata(ServiceSid string, params *ListUserParams) (*metadata.ResourceMetadata[chan IpMessagingV1User], chan error) {
	if params == nil {
		params = &ListUserParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV1User](
...
func (c *ApiService) UpdateUserWithMetadata(ServiceSid string, Sid string, params *UpdateUserParams) (*metadata.ResourceMetadata[IpMessagingV1User], error) {
	path := "/v1/Services/{ServiceSid}/Users/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
