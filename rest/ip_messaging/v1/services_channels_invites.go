...
func (c *ApiService) CreateInviteWithMetadata(ServiceSid string, ChannelSid string, params *CreateInviteParams) (*metadata.ResourceMetadata[IpMessagingV1Invite], error) {
	path := "/v1/Services/{ServiceSid}/Channels/{ChannelSid}/Invites"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV1Invite](
...
func (c *ApiService) FetchInviteWithMetadata(ServiceSid string, ChannelSid string, Sid string) (*metadata.ResourceMetadata[IpMessagingV1Invite], error) {
	path := "/v1/Services/{ServiceSid}/Channels/{ChannelSid}/Invites/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListInviteWithMetadata(ServiceSid string, ChannelSid string, params *ListInviteParams) (*metadata.ResourceMetadata[[]IpMessagingV1Invite], error) {
...
func (c *ApiService) StreamInviteWithMetadata(ServiceSid string, ChannelSid string, params *ListInviteParams) (*metadata.ResourceMetadata[chan IpMessagingV1Invite], chan error) {
	if params == nil {
		params = &ListInviteParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV1Invite](
