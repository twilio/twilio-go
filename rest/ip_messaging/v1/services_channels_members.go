...
func (c *ApiService) CreateMemberWithMetadata(ServiceSid string, ChannelSid string, params *CreateMemberParams) (*metadata.ResourceMetadata[IpMessagingV1Member], error) {
	path := "/v1/Services/{ServiceSid}/Channels/{ChannelSid}/Members"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV1Member](
...
func (c *ApiService) FetchMemberWithMetadata(ServiceSid string, ChannelSid string, Sid string) (*metadata.ResourceMetadata[IpMessagingV1Member], error) {
	path := "/v1/Services/{ServiceSid}/Channels/{ChannelSid}/Members/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListMemberWithMetadata(ServiceSid string, ChannelSid string, params *ListMemberParams) (*metadata.ResourceMetadata[[]IpMessagingV1Member], error) {
...
func (c *ApiService) StreamMemberWithMetadata(ServiceSid string, ChannelSid string, params *ListMemberParams) (*metadata.ResourceMetadata[chan IpMessagingV1Member], chan error) {
	if params == nil {
		params = &ListMemberParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV1Member](
...
func (c *ApiService) UpdateMemberWithMetadata(ServiceSid string, ChannelSid string, Sid string, params *UpdateMemberParams) (*metadata.ResourceMetadata[IpMessagingV1Member], error) {
	path := "/v1/Services/{ServiceSid}/Channels/{ChannelSid}/Members/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
