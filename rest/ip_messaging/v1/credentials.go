...
func (c *ApiService) CreateCredentialWithMetadata(params *CreateCredentialParams) (*metadata.ResourceMetadata[IpMessagingV1Credential], error) {
	path := "/v1/Credentials"
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV1Credential](
...
func (c *ApiService) FetchCredentialWithMetadata(Sid string) (*metadata.ResourceMetadata[IpMessagingV1Credential], error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListCredentialWithMetadata(params *ListCredentialParams) (*metadata.ResourceMetadata[[]IpMessagingV1Credential], error) {
...
func (c *ApiService) StreamCredentialWithMetadata(params *ListCredentialParams) (*metadata.ResourceMetadata[chan IpMessagingV1Credential], chan error) {
	if params == nil {
		params = &ListCredentialParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV1Credential](
...
func (c *ApiService) UpdateCredentialWithMetadata(Sid string, params *UpdateCredentialParams) (*metadata.ResourceMetadata[IpMessagingV1Credential], error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
