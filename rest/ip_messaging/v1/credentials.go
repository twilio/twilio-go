...
func (c *ApiService) ListCredential(params *ListCredentialParams, limit int) ([]IpMessagingV1Credential, error) {
...
func (c *ApiService) StreamCredential(params *ListCredentialParams, limit int) (chan IpMessagingV1Credential, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
