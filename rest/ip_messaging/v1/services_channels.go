...
func (c *ApiService) CreateChannelWithMetadata(ServiceSid string, params *CreateChannelParams) (*metadata.ResourceMetadata[IpMessagingV1Channel], error) {
	path := "/v1/Services/{ServiceSid}/Channels"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV1Channel](
...
func (c *ApiService) DeleteChannelWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[bool], error) {
	path := "/v1/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) FetchChannelWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[IpMessagingV1Channel], error) {
	path := "/v1/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListChannelWithMetadata(ServiceSid string, params *ListChannelParams) (*metadata.ResourceMetadata[[]IpMessagingV1Channel], error) {
...
func (c *ApiService) StreamChannelWithMetadata(ServiceSid string, params *ListChannelParams) (*metadata.ResourceMetadata[chan IpMessagingV1Channel], chan error) {
	if params == nil {
		params = &ListChannelParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV1Channel](
...
func (c *ApiService) UpdateChannelWithMetadata(ServiceSid string, Sid string, params *UpdateChannelParams) (*metadata.ResourceMetadata[IpMessagingV1Channel], error) {
	path := "/v1/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
