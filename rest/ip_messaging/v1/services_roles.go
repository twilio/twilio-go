...
func (c *ApiService) CreateRoleWithMetadata(ServiceSid string, params *CreateRoleParams) (*metadata.ResourceMetadata[IpMessagingV1Role], error) {
	path := "/v1/Services/{ServiceSid}/Roles"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[IpMessagingV1Role](
...
func (c *ApiService) FetchRoleWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[IpMessagingV1Role], error) {
	path := "/v1/Services/{ServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListRoleWithMetadata(ServiceSid string, params *ListRoleParams) (*metadata.ResourceMetadata[[]IpMessagingV1Role], error) {
...
func (c *ApiService) StreamRoleWithMetadata(ServiceSid string, params *ListRoleParams) (*metadata.ResourceMetadata[chan IpMessagingV1Role], chan error) {
	if params == nil {
		params = &ListRoleParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan IpMessagingV1Role](
...
func (c *ApiService) UpdateRoleWithMetadata(ServiceSid string, Sid string, params *UpdateRoleParams) (*metadata.ResourceMetadata[IpMessagingV1Role], error) {
	path := "/v1/Services/{ServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
