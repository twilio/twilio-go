...
func (c *ApiService) CreateRoleWithContext(ctx context.Context, ServiceSid string, params *CreateRoleParams) (*IpMessagingV1Role, error) {
...
func (c *ApiService) FetchRoleWithContext(ctx context.Context, ServiceSid string, Sid string) (*IpMessagingV1Role, error) {
	path := "/v1/Services/{ServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Role records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListRoleWithContext(ctx context.Context, ServiceSid string, params *ListRoleParams) ([]IpMessagingV1Role, error) {
...
// Streams Role records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamRoleWithContext(ctx context.Context, ServiceSid string, params *ListRoleParams) (chan IpMessagingV1Role, chan error) {
	if params == nil {
...
func (c *ApiService) streamRoleWithContext(ctx context.Context, response *ListRoleResponse, params *ListRoleParams, recordChannel chan IpMessagingV1Role, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateRoleWithContext(ctx context.Context, ServiceSid string, Sid string, params *UpdateRoleParams) (*IpMessagingV1Role, error) {
	path := "/v1/Services/{ServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
