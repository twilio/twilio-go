...
// DataMappingFromCloudAppDataSet Configuration for mapping from a TDI dataset backed by a cloud app (CRM) source.
type DataMappingFromCloudAppDataSet struct {
