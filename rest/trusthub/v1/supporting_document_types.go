...
// Fetch a specific Supporting Document Type Instance.
func (c *ApiService) FetchSupportingDocumentTypeWithCtx(ctx context.Context, Sid string) (*TrusthubV1SupportingDocumentType, error) {
...
// Lists SupportingDocumentType records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListSupportingDocumentTypeWithCtx(ctx context.Context, params *ListSupportingDocumentTypeParams) ([]TrusthubV1SupportingDocumentType, error) {
...
// Streams SupportingDocumentType records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamSupportingDocumentTypeWithCtx(ctx context.Context, params *ListSupportingDocumentTypeParams) (chan TrusthubV1SupportingDocumentType, chan error) {
	if params == nil {
...
func (c *ApiService) streamSupportingDocumentType(ctx context.Context, response *ListSupportingDocumentTypeResponse, params *ListSupportingDocumentTypeParams, recordChannel chan TrusthubV1SupportingDocumentType, errorChannel chan error) {
	curRecord := 1
