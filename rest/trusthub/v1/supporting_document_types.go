...
func (c *ApiService) FetchSupportingDocumentTypeWithMetadata(Sid string) (*metadata.ResourceMetadata[TrusthubV1SupportingDocumentType], error) {
	path := "/v1/SupportingDocumentTypes/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[TrusthubV1SupportingDocumentType](
...
func (c *ApiService) ListSupportingDocumentTypeWithMetadata(params *ListSupportingDocumentTypeParams) (*metadata.ResourceMetadata[[]TrusthubV1SupportingDocumentType], error) {
...
func (c *ApiService) StreamSupportingDocumentTypeWithMetadata(params *ListSupportingDocumentTypeParams) (*metadata.ResourceMetadata[chan TrusthubV1SupportingDocumentType], chan error) {
	if params == nil {
		params = &ListSupportingDocumentTypeParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan TrusthubV1SupportingDocumentType](
