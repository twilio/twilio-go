...
func (c *ApiService) FetchEndUserTypeWithContext(ctx context.Context, Sid string) (*TrusthubV1EndUserType, error) {
...
// Lists EndUserType records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListEndUserTypeWithContext(ctx context.Context, params *ListEndUserTypeParams) ([]TrusthubV1EndUserType, error) {
...
// Streams EndUserType records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamEndUserTypeWithContext(ctx context.Context, params *ListEndUserTypeParams) (chan TrusthubV1EndUserType, chan error) {
	if params == nil {
...
func (c *ApiService) streamEndUserTypeWithContext(ctx context.Context, response *ListEndUserTypeResponse, params *ListEndUserTypeParams, recordChannel chan TrusthubV1EndUserType, errorChannel chan error) {
	curRecord := 1
