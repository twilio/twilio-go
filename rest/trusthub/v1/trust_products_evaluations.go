...
func (c *ApiService) CreateTrustProductEvaluation(TrustProductSid string, params *CreateTrustProductEvaluationParams) (*TrusthubV1TrustProductEvaluation, error) {
	return c.CreateTrustProductEvaluationWithContext(context.TODO(), TrustProductSid, params)
}
func (c *ApiService) CreateTrustProductEvaluationWithContext(ctx context.Context, TrustProductSid string, params *CreateTrustProductEvaluationParams) (*TrusthubV1TrustProductEvaluation, error) {
...
func (c *ApiService) FetchTrustProductEvaluation(TrustProductSid string, Sid string) (*TrusthubV1TrustProductEvaluation, error) {
	return c.FetchTrustProductEvaluationWithContext(context.TODO(), TrustProductSid, Sid)
}
func (c *ApiService) FetchTrustProductEvaluationWithContext(ctx context.Context, TrustProductSid string, Sid string) (*TrusthubV1TrustProductEvaluation, error) {
...
func (c *ApiService) PageTrustProductEvaluation(TrustProductSid string, params *ListTrustProductEvaluationParams, pageToken, pageNumber string) (*ListTrustProductEvaluationResponse, error) {
	return c.PageTrustProductEvaluationWithContext(context.TODO(), TrustProductSid, params, pageToken, pageNumber)
}

// Retrieve a single page of TrustProductEvaluation records from the API. Request is executed immediately.
func (c *ApiService) PageTrustProductEvaluationWithContext(ctx context.Context, TrustProductSid string, params *ListTrustProductEvaluationParams, pageToken, pageNumber string) (*ListTrustProductEvaluationResponse, error) {
	path := "/v1/TrustProducts/{TrustProductSid}/Evaluations"
...
func (c *ApiService) ListTrustProductEvaluation(TrustProductSid string, params *ListTrustProductEvaluationParams) ([]TrusthubV1TrustProductEvaluation, error) {
	return c.ListTrustProductEvaluationWithContext(context.TODO(), TrustProductSid, params)
}

// Lists TrustProductEvaluation records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListTrustProductEvaluationWithContext(ctx context.Context, TrustProductSid string, params *ListTrustProductEvaluationParams) ([]TrusthubV1TrustProductEvaluation, error) {
	response, errors := c.StreamTrustProductEvaluationWithContext(ctx, TrustProductSid, params)
...
func (c *ApiService) StreamTrustProductEvaluation(TrustProductSid string, params *ListTrustProductEvaluationParams) (chan TrusthubV1TrustProductEvaluation, chan error) {
	return c.StreamTrustProductEvaluationWithContext(context.TODO(), TrustProductSid, params)
}

// Streams TrustProductEvaluation records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamTrustProductEvaluationWithContext(ctx context.Context, TrustProductSid string, params *ListTrustProductEvaluationParams) (chan TrusthubV1TrustProductEvaluation, chan error) {
	if params == nil {
	...
	response, err := c.PageTrustProductEvaluationWithContext(ctx, TrustProductSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamTrustProductEvaluationWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamTrustProductEvaluationWithContext(ctx context.Context, response *ListTrustProductEvaluationResponse, params *ListTrustProductEvaluationParams, recordChannel chan TrusthubV1TrustProductEvaluation, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListTrustProductEvaluationResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListTrustProductEvaluationResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
