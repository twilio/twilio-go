...
func (c *ApiService) CustomerProfileEntityAssignmentPage(CustomerProfileSid string, params *ListCustomerProfileEntityAssignmentParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/CustomerProfiles/{CustomerProfileSid}/EntityAssignments"
	path = strings.Replace(path, "{"+"CustomerProfileSid"+"}", CustomerProfileSid, -1)
...
func (c *ApiService) CustomerProfileEntityAssignmentStream(CustomerProfileSid string, params *ListCustomerProfileEntityAssignmentParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.CustomerProfileEntityAssignmentPage(CustomerProfileSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) CustomerProfileEntityAssignmentList(CustomerProfileSid string, params *ListCustomerProfileEntityAssignmentParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.CustomerProfileEntityAssignmentPage(CustomerProfileSid, params, "", "", fmt.Sprint(limits.PageSize))
