...
func (c *ApiService) CreateEndUserWithContext(ctx context.Context, params *CreateEndUserParams) (*TrusthubV1EndUser, error) {
	path := "/v1/EndUsers"
...
func (c *ApiService) FetchEndUserWithContext(ctx context.Context, Sid string) (*TrusthubV1EndUser, error) {
	path := "/v1/EndUsers/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists EndUser records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListEndUserWithContext(ctx context.Context, params *ListEndUserParams) ([]TrusthubV1EndUser, error) {
...
// Streams EndUser records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamEndUserWithContext(ctx context.Context, params *ListEndUserParams) (chan TrusthubV1EndUser, chan error) {
	if params == nil {
...
func (c *ApiService) streamEndUserWithContext(ctx context.Context, response *ListEndUserResponse, params *ListEndUserParams, recordChannel chan TrusthubV1EndUser, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateEndUserWithContext(ctx context.Context, Sid string, params *UpdateEndUserParams) (*TrusthubV1EndUser, error) {
	path := "/v1/EndUsers/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
