...
func (c *ApiService) CreateEndUserWithMetadata(params *CreateEndUserParams) (*metadata.ResourceMetadata[TrusthubV1EndUser], error) {
	path := "/v1/EndUsers"
	...
	metadataWrapper := metadata.NewResourceMetadata[TrusthubV1EndUser](
...
func (c *ApiService) FetchEndUserWithMetadata(Sid string) (*metadata.ResourceMetadata[TrusthubV1EndUser], error) {
	path := "/v1/EndUsers/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListEndUserWithMetadata(params *ListEndUserParams) (*metadata.ResourceMetadata[[]TrusthubV1EndUser], error) {
...
func (c *ApiService) StreamEndUserWithMetadata(params *ListEndUserParams) (*metadata.ResourceMetadata[chan TrusthubV1EndUser], chan error) {
	if params == nil {
		params = &ListEndUserParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan TrusthubV1EndUser](
...
func (c *ApiService) UpdateEndUserWithMetadata(Sid string, params *UpdateEndUserParams) (*metadata.ResourceMetadata[TrusthubV1EndUser], error) {
	path := "/v1/EndUsers/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
