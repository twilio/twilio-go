...
func (c *ApiService) CreateSupportingDocumentWithContext(ctx context.Context, params *CreateSupportingDocumentParams) (*TrusthubV1SupportingDocument, error) {
...
func (c *ApiService) FetchSupportingDocumentWithContext(ctx context.Context, Sid string) (*TrusthubV1SupportingDocument, error) {
	path := "/v1/SupportingDocuments/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists SupportingDocument records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListSupportingDocumentWithContext(ctx context.Context, params *ListSupportingDocumentParams) ([]TrusthubV1SupportingDocument, error) {
...
// Streams SupportingDocument records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamSupportingDocumentWithContext(ctx context.Context, params *ListSupportingDocumentParams) (chan TrusthubV1SupportingDocument, chan error) {
	if params == nil {
...
func (c *ApiService) streamSupportingDocumentWithContext(ctx context.Context, response *ListSupportingDocumentResponse, params *ListSupportingDocumentParams, recordChannel chan TrusthubV1SupportingDocument, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateSupportingDocumentWithContext(ctx context.Context, Sid string, params *UpdateSupportingDocumentParams) (*TrusthubV1SupportingDocument, error) {
	path := "/v1/SupportingDocuments/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
