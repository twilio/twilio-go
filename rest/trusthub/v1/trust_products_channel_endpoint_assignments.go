...
func (c *ApiService) TrustProductChannelEndpointAssignmentPage(TrustProductSid string, params *ListTrustProductChannelEndpointAssignmentParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/TrustProducts/{TrustProductSid}/ChannelEndpointAssignments"
	path = strings.Replace(path, "{"+"TrustProductSid"+"}", TrustProductSid, -1)
...
func (c *ApiService) TrustProductChannelEndpointAssignmentStream(TrustProductSid string, params *ListTrustProductChannelEndpointAssignmentParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.TrustProductChannelEndpointAssignmentPage(TrustProductSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) TrustProductChannelEndpointAssignmentList(TrustProductSid string, params *ListTrustProductChannelEndpointAssignmentParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.TrustProductChannelEndpointAssignmentPage(TrustProductSid, params, "", "", fmt.Sprint(limits.PageSize))
