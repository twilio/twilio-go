...
func (c *ApiService) TrustProductChannelEndpointAssignmentPage(TrustProductSid string, params *ListTrustProductChannelEndpointAssignmentParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/v1/TrustProducts/{TrustProductSid}/ChannelEndpointAssignments"
	path = strings.Replace(path, "{"+"TrustProductSid"+"}", TrustProductSid, -1)
