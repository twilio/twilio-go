# MessagingV1UsAppToPersonResponse
...
**PrivacyPolicyUrl** | Pointer to **string** | The URL of the privacy policy for the campaign. |
**TermsAndConditionsUrl** | Pointer to **string** | The URL of the terms and conditions for the campaign. |
