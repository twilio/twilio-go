...
func (c *ApiService) ListService(params *ListServiceParams, limit int) ([]MessagingV1Service, error) {
...
func (c *ApiService) StreamService(params *ListServiceParams, limit int) (chan MessagingV1Service, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
