...
func (c *ApiService) FetchUsAppToPersonUsecase(MessagingServiceSid string, params *FetchUsAppToPersonUsecaseParams) (*MessagingV1UsAppToPersonUsecase, error) {
	return c.FetchUsAppToPersonUsecaseWithContext(context.TODO(), MessagingServiceSid, params)
}
func (c *ApiService) FetchUsAppToPersonUsecaseWithContext(ctx context.Context, MessagingServiceSid string, params *FetchUsAppToPersonUsecaseParams) (*MessagingV1UsAppToPersonUsecase, error) {
