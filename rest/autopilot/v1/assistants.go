...
func (c *ApiService) AssistantPage(params *ListAssistantParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Assistants"
...
func (c *ApiService) AssistantStream(params *ListAssistantParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AssistantPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) AssistantList(params *ListAssistantParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.AssistantPage(params, "", "", fmt.Sprint(limits.PageSize))
