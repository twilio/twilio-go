...
func (c *ApiService) ListAssistant(params *ListAssistantParams) (*ListAssistantResponse, error) {
	path := "/v1/Assistants"
...
func (c *ApiService) AssistantsPage(params *ListAssistantParams, pageToken string, pageNumber string) (*ListAssistantResponse, error) {
	path := "/v1/Assistants"
...
//Lists Assistants records from the API as a list. Unlike stream, this operation is eager and will loads 'limit' records into memory before returning.
func (c *ApiService) AssistantsList(params *ListAssistantParams, limit int) ([]ListAssistantResponse, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListAssistant(params)
	if err != nil {
		return nil, err
	}
	...
	ret := make([]ListAssistantResponse, len(resp))
...
func (c *ApiService) AssistantsStream(params *ListAssistantParams, limit int) (chan interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListAssistant(params)
	if err != nil {
		return nil, err
