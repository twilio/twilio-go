...
func (c *ApiService) TaskPage(AssistantSid string, params *ListTaskParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Assistants/{AssistantSid}/Tasks"
	path = strings.Replace(path, "{"+"AssistantSid"+"}", AssistantSid, -1)
...
func (c *ApiService) TaskStream(AssistantSid string, params *ListTaskParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.TaskPage(AssistantSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) TaskList(AssistantSid string, params *ListTaskParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.TaskPage(AssistantSid, params, "", "", fmt.Sprint(limits.PageSize))
