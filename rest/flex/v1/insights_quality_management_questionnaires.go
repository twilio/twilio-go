...
// CreateInsightsQuestionnairesWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateInsightsQuestionnairesWithMetadata(params *CreateInsightsQuestionnairesParams) (*metadata.ResourceMetadata[FlexV1InsightsQuestionnaires], error) {
	path := "/v1/Insights/QualityManagement/Questionnaires"
	...
	metadataWrapper := metadata.NewResourceMetadata[FlexV1InsightsQuestionnaires](
...
// DeleteInsightsQuestionnairesWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteInsightsQuestionnairesWithMetadata(QuestionnaireSid string, params *DeleteInsightsQuestionnairesParams) (*metadata.ResourceMetadata[bool], error) {
	path := "/v1/Insights/QualityManagement/Questionnaires/{QuestionnaireSid}"
	path = strings.Replace(path, "{"+"QuestionnaireSid"+"}", QuestionnaireSid, -1)
...
// FetchInsightsQuestionnairesWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchInsightsQuestionnairesWithMetadata(QuestionnaireSid string, params *FetchInsightsQuestionnairesParams) (*metadata.ResourceMetadata[FlexV1InsightsQuestionnaires], error) {
	path := "/v1/Insights/QualityManagement/Questionnaires/{QuestionnaireSid}"
	path = strings.Replace(path, "{"+"QuestionnaireSid"+"}", QuestionnaireSid, -1)
...
// PageInsightsQuestionnairesWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageInsightsQuestionnairesWithMetadata(params *ListInsightsQuestionnairesParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListInsightsQuestionnairesResponse], error) {
	path := "/v1/Insights/QualityManagement/Questionnaires"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListInsightsQuestionnairesResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListInsightsQuestionnairesWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListInsightsQuestionnairesWithMetadata(params *ListInsightsQuestionnairesParams) (*metadata.ResourceMetadata[[]FlexV1InsightsQuestionnaires], error) {
	response, errors := c.StreamInsightsQuestionnairesWithMetadata(params)
...
// StreamInsightsQuestionnairesWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamInsightsQuestionnairesWithMetadata(params *ListInsightsQuestionnairesParams) (*metadata.ResourceMetadata[chan FlexV1InsightsQuestionnaires], chan error) {
	if params == nil {
		params = &ListInsightsQuestionnairesParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageInsightsQuestionnairesWithMetadata(params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamInsightsQuestionnaires(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan FlexV1InsightsQuestionnaires](
...
// UpdateInsightsQuestionnairesWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) UpdateInsightsQuestionnairesWithMetadata(QuestionnaireSid string, params *UpdateInsightsQuestionnairesParams) (*metadata.ResourceMetadata[FlexV1InsightsQuestionnaires], error) {
	path := "/v1/Insights/QualityManagement/Questionnaires/{QuestionnaireSid}"
	path = strings.Replace(path, "{"+"QuestionnaireSid"+"}", QuestionnaireSid, -1)
