...
func (c *ApiService) CreateWebChannel(params *CreateWebChannelParams) (*FlexV1WebChannel, error) {
	return c.CreateWebChannelWithContext(context.TODO(), params)
}
func (c *ApiService) CreateWebChannelWithContext(ctx context.Context, params *CreateWebChannelParams) (*FlexV1WebChannel, error) {
	path := "/v1/WebChannels"
...
func (c *ApiService) DeleteWebChannel(Sid string) error {
	return c.DeleteWebChannelWithContext(context.TODO(), Sid)
}
func (c *ApiService) DeleteWebChannelWithContext(ctx context.Context, Sid string) error {
...
func (c *ApiService) FetchWebChannel(Sid string) (*FlexV1WebChannel, error) {
	return c.FetchWebChannelWithContext(context.TODO(), Sid)
}
func (c *ApiService) FetchWebChannelWithContext(ctx context.Context, Sid string) (*FlexV1WebChannel, error) {
	path := "/v1/WebChannels/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageWebChannel(params *ListWebChannelParams, pageToken, pageNumber string) (*ListWebChannelResponse, error) {
	return c.PageWebChannelWithContext(context.TODO(), params, pageToken, pageNumber)
}

// Retrieve a single page of WebChannel records from the API. Request is executed immediately.
func (c *ApiService) PageWebChannelWithContext(ctx context.Context, params *ListWebChannelParams, pageToken, pageNumber string) (*ListWebChannelResponse, error) {
	path := "/v1/WebChannels"
...
func (c *ApiService) ListWebChannel(params *ListWebChannelParams) ([]FlexV1WebChannel, error) {
	return c.ListWebChannelWithContext(context.TODO(), params)
}

// Lists WebChannel records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListWebChannelWithContext(ctx context.Context, params *ListWebChannelParams) ([]FlexV1WebChannel, error) {
	response, errors := c.StreamWebChannelWithContext(ctx, params)
...
func (c *ApiService) StreamWebChannel(params *ListWebChannelParams) (chan FlexV1WebChannel, chan error) {
	return c.StreamWebChannelWithContext(context.TODO(), params)
}

// Streams WebChannel records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamWebChannelWithContext(ctx context.Context, params *ListWebChannelParams) (chan FlexV1WebChannel, chan error) {
	if params == nil {
	...
	response, err := c.PageWebChannelWithContext(ctx, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamWebChannelWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamWebChannelWithContext(ctx context.Context, response *ListWebChannelResponse, params *ListWebChannelParams, recordChannel chan FlexV1WebChannel, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListWebChannelResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListWebChannelResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
...
func (c *ApiService) UpdateWebChannel(Sid string, params *UpdateWebChannelParams) (*FlexV1WebChannel, error) {
	return c.UpdateWebChannelWithContext(context.TODO(), Sid, params)
}
func (c *ApiService) UpdateWebChannelWithContext(ctx context.Context, Sid string, params *UpdateWebChannelParams) (*FlexV1WebChannel, error) {
	path := "/v1/WebChannels/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
