...
func (c *ApiService) FlexFlowPage(params *ListFlexFlowParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/FlexFlows"
...
func (c *ApiService) FlexFlowStream(params *ListFlexFlowParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.FlexFlowPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) FlexFlowList(params *ListFlexFlowParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.FlexFlowPage(params, "", "", fmt.Sprint(limits.PageSize))
