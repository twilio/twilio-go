...
func (c *ApiService) ChannelPage(params *ListChannelParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/v1/Channels"
...
func (c *ApiService) ChannelStream(params *ListChannelParams, limit int) (chan map[string]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.ChannelPage(params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) ChannelList(params *ListChannelParams, limit int) ([]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.ChannelPage(params, "", "")
	if err != nil {
		return nil, err
