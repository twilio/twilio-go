...
func (c *ApiService) DeleteSim(Sid string) error {
	return c.DeleteSimWithCtx(context.TODO(), Sid)
}

// Delete a Sim resource on your Account.
func (c *ApiService) DeleteSimWithCtx(ctx context.Context, Sid string) error {
	path := "/v1/Sims/{Sid}"
...
// Fetch a Sim resource on your Account.
func (c *ApiService) FetchSimWithCtx(ctx context.Context, Sid string) (*WirelessV1Sim, error) {
	path := "/v1/Sims/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Sim records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListSimWithCtx(ctx context.Context, params *ListSimParams) ([]WirelessV1Sim, error) {
...
// Streams Sim records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamSimWithCtx(ctx context.Context, params *ListSimParams) (chan WirelessV1Sim, chan error) {
	if params == nil {
...
func (c *ApiService) streamSim(ctx context.Context, response *ListSimResponse, params *ListSimParams, recordChannel chan WirelessV1Sim, errorChannel chan error) {
	curRecord := 1
...
// Updates the given properties of a Sim resource on your Account.
func (c *ApiService) UpdateSimWithCtx(ctx context.Context, Sid string, params *UpdateSimParams) (*WirelessV1Sim, error) {
	path := "/v1/Sims/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
