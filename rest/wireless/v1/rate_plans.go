...
func (c *ApiService) CreateRatePlan(params *CreateRatePlanParams) (*WirelessV1RatePlan, error) {
	return c.CreateRatePlanWithContext(context.TODO(), params)
}
func (c *ApiService) CreateRatePlanWithContext(ctx context.Context, params *CreateRatePlanParams) (*WirelessV1RatePlan, error) {
	path := "/v1/RatePlans"
...
func (c *ApiService) DeleteRatePlan(Sid string) error {
	return c.DeleteRatePlanWithContext(context.TODO(), Sid)
}
func (c *ApiService) DeleteRatePlanWithContext(ctx context.Context, Sid string) error {
...
func (c *ApiService) FetchRatePlan(Sid string) (*WirelessV1RatePlan, error) {
	return c.FetchRatePlanWithContext(context.TODO(), Sid)
}
func (c *ApiService) FetchRatePlanWithContext(ctx context.Context, Sid string) (*WirelessV1RatePlan, error) {
	path := "/v1/RatePlans/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageRatePlan(params *ListRatePlanParams, pageToken, pageNumber string) (*ListRatePlanResponse, error) {
	return c.PageRatePlanWithContext(context.TODO(), params, pageToken, pageNumber)
}

// Retrieve a single page of RatePlan records from the API. Request is executed immediately.
func (c *ApiService) PageRatePlanWithContext(ctx context.Context, params *ListRatePlanParams, pageToken, pageNumber string) (*ListRatePlanResponse, error) {
	path := "/v1/RatePlans"
...
func (c *ApiService) ListRatePlan(params *ListRatePlanParams) ([]WirelessV1RatePlan, error) {
	return c.ListRatePlanWithContext(context.TODO(), params)
}

// Lists RatePlan records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListRatePlanWithContext(ctx context.Context, params *ListRatePlanParams) ([]WirelessV1RatePlan, error) {
	response, errors := c.StreamRatePlanWithContext(ctx, params)
...
func (c *ApiService) StreamRatePlan(params *ListRatePlanParams) (chan WirelessV1RatePlan, chan error) {
	return c.StreamRatePlanWithContext(context.TODO(), params)
}

// Streams RatePlan records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamRatePlanWithContext(ctx context.Context, params *ListRatePlanParams) (chan WirelessV1RatePlan, chan error) {
	if params == nil {
	...
	response, err := c.PageRatePlanWithContext(ctx, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamRatePlanWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamRatePlanWithContext(ctx context.Context, response *ListRatePlanResponse, params *ListRatePlanParams, recordChannel chan WirelessV1RatePlan, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListRatePlanResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListRatePlanResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
...
func (c *ApiService) UpdateRatePlan(Sid string, params *UpdateRatePlanParams) (*WirelessV1RatePlan, error) {
	return c.UpdateRatePlanWithContext(context.TODO(), Sid, params)
}
func (c *ApiService) UpdateRatePlanWithContext(ctx context.Context, Sid string, params *UpdateRatePlanParams) (*WirelessV1RatePlan, error) {
	path := "/v1/RatePlans/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
