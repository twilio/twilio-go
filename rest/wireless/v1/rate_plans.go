...
func (c *ApiService) RatePlanPage(params *ListRatePlanParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/RatePlans"
...
func (c *ApiService) RatePlanStream(params *ListRatePlanParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.RatePlanPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) RatePlanList(params *ListRatePlanParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.RatePlanPage(params, "", "", fmt.Sprint(limits.PageSize))
