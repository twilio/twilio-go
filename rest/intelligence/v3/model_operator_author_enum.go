...
// OperatorAuthorEnum The creator and maintainer of the Language Operator.   Available values: - `SELF` - Created and maintained by the customer (Custom Operator) - `TWILIO` - Created and maintained by Twilio (Twilio-Authored Operator)
type OperatorAuthorEnum string

// List of OperatorAuthorEnum
const (
	OPERATORAUTHORENUM_SELF   OperatorAuthorEnum = "SELF"
	OPERATORAUTHORENUM_TWILIO OperatorAuthorEnum = "TWILIO"
)
