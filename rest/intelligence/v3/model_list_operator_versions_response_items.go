...
// ListOperatorVersionsResponseItems struct for ListOperatorVersionsResponseItems
type ListOperatorVersionsResponseItems struct {
	...
	DateDeprecated time.Time `json:"dateDeprecated,omitempty"`
