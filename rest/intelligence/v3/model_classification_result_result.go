...
// ClassificationResultResult The actual result from executing the Language Operator with `CLASSIFICATION` output format.
type ClassificationResultResult struct {
	// The predicted label assigned by the Language Operator.
