...
// CreateOrUpdateOperatorRequest struct for CreateOrUpdateOperatorRequest
type CreateOrUpdateOperatorRequest struct {
	...
	OutputFormat OperatorOutputFormat `json:"outputFormat"`
