...
// TextResultResult The actual result from executing the Language Operator with `TEXT` output format.
type TextResultResult struct {
	// The plaintext result produced by the Language Operator.
