...
// LookupResponseWithCorId struct for LookupResponseWithCorId
type LookupResponseWithCorId struct {
	// Unique identifier used to match request with response
	CorrelationId string `json:"correlation_id,omitempty"`
	// Twilio error conde in case that the request to downstream fails
	...
	PhoneNumberQualityScore PhoneNumberQualityScore  `json:"phone_number_quality_score,omitempty"`
}
