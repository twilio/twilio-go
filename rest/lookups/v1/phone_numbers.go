...
func (c *ApiService) FetchPhoneNumber(PhoneNumber string, params *FetchPhoneNumberParams) (*LookupsV1PhoneNumber, error) {
	return c.FetchPhoneNumberWithContext(context.TODO(), PhoneNumber, params)
}
func (c *ApiService) FetchPhoneNumberWithContext(ctx context.Context, PhoneNumber string, params *FetchPhoneNumberParams) (*LookupsV1PhoneNumber, error) {
