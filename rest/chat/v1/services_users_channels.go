...
func (c *ApiService) ListUserChannelWithMetadata(ServiceSid string, UserSid string, params *ListUserChannelParams) (*metadata.ResourceMetadata[[]ChatV1UserChannel], error) {
	...
	metadataWrapper := metadata.NewResourceMetadata[[]ChatV1UserChannel](
		records,
...
func (c *ApiService) StreamUserChannelWithMetadata(ServiceSid string, UserSid string, params *ListUserChannelParams) (*metadata.ResourceMetadata[chan ChatV1UserChannel], chan error) {
	if params == nil {
		params = &ListUserChannelParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV1UserChannel](
