...
func (c *ApiService) ListService(params *ListServiceParams, limit int) ([]ChatV1Service, error) {
...
func (c *ApiService) StreamService(params *ListServiceParams, limit int) (chan ChatV1Service, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
