...
func (c *ApiService) CreateServiceWithContext(ctx context.Context, params *CreateServiceParams) (*ChatV1Service, error) {
	path := "/v1/Services"
...
func (c *ApiService) FetchServiceWithContext(ctx context.Context, Sid string) (*ChatV1Service, error) {
	path := "/v1/Services/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Service records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListServiceWithContext(ctx context.Context, params *ListServiceParams) ([]ChatV1Service, error) {
...
// Streams Service records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamServiceWithContext(ctx context.Context, params *ListServiceParams) (chan ChatV1Service, chan error) {
	if params == nil {
...
func (c *ApiService) streamServiceWithContext(ctx context.Context, response *ListServiceResponse, params *ListServiceParams, recordChannel chan ChatV1Service, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateServiceWithContext(ctx context.Context, Sid string, params *UpdateServiceParams) (*ChatV1Service, error) {
	path := "/v1/Services/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
