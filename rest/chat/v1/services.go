...
func (c *ApiService) CreateServiceWithMetadata(params *CreateServiceParams) (*metadata.ResourceMetadata[ChatV1Service], error) {
	path := "/v1/Services"
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV1Service](
...
func (c *ApiService) FetchServiceWithMetadata(Sid string) (*metadata.ResourceMetadata[ChatV1Service], error) {
	path := "/v1/Services/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListServiceWithMetadata(params *ListServiceParams) (*metadata.ResourceMetadata[[]ChatV1Service], error) {
...
func (c *ApiService) StreamService(params *ListServiceParams) (chan ChatV1Service, chan error) {
	...
	recordChannel := make(chan ChatV1Service, 1)
...
func (c *ApiService) StreamServiceWithMetadata(params *ListServiceParams) (*metadata.ResourceMetadata[chan ChatV1Service], chan error) {
	if params == nil {
		params = &ListServiceParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV1Service](
...
func (c *ApiService) streamService(response *ListServiceResponse, params *ListServiceParams, recordChannel chan ChatV1Service, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateServiceWithMetadata(Sid string, params *UpdateServiceParams) (*metadata.ResourceMetadata[ChatV1Service], error) {
	path := "/v1/Services/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
