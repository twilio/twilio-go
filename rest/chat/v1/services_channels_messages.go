...
func (c *ApiService) ListMessage(ServiceSid string, ChannelSid string, params *ListMessageParams, limit int) ([]ChatV1ServiceChannelMessage, error) {
	if params == nil {
...
func (c *ApiService) StreamMessage(ServiceSid string, ChannelSid string, params *ListMessageParams, limit int) (chan ChatV1ServiceChannelMessage, error) {
	if params == nil {
		params = &ListMessageParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
