...
func (c *ApiService) CreateCredentialWithMetadata(params *CreateCredentialParams) (*metadata.ResourceMetadata[ChatV1Credential], error) {
	path := "/v1/Credentials"
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV1Credential](
...
func (c *ApiService) FetchCredentialWithMetadata(Sid string) (*metadata.ResourceMetadata[ChatV1Credential], error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListCredentialWithMetadata(params *ListCredentialParams) (*metadata.ResourceMetadata[[]ChatV1Credential], error) {
...
func (c *ApiService) StreamCredential(params *ListCredentialParams) (chan ChatV1Credential, chan error) {
	...
	recordChannel := make(chan ChatV1Credential, 1)
...
func (c *ApiService) StreamCredentialWithMetadata(params *ListCredentialParams) (*metadata.ResourceMetadata[chan ChatV1Credential], chan error) {
	if params == nil {
		params = &ListCredentialParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV1Credential](
...
func (c *ApiService) streamCredential(response *ListCredentialResponse, params *ListCredentialParams, recordChannel chan ChatV1Credential, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateCredentialWithMetadata(Sid string, params *UpdateCredentialParams) (*metadata.ResourceMetadata[ChatV1Credential], error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
