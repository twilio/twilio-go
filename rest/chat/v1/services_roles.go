...
func (c *ApiService) CreateRoleWithMetadata(ServiceSid string, params *CreateRoleParams) (*metadata.ResourceMetadata[ChatV1Role], error) {
	path := "/v1/Services/{ServiceSid}/Roles"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV1Role](
...
func (c *ApiService) FetchRoleWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[ChatV1Role], error) {
	path := "/v1/Services/{ServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListRoleWithMetadata(ServiceSid string, params *ListRoleParams) (*metadata.ResourceMetadata[[]ChatV1Role], error) {
...
func (c *ApiService) StreamRoleWithMetadata(ServiceSid string, params *ListRoleParams) (*metadata.ResourceMetadata[chan ChatV1Role], chan error) {
	if params == nil {
		params = &ListRoleParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV1Role](
...
func (c *ApiService) UpdateRoleWithMetadata(ServiceSid string, Sid string, params *UpdateRoleParams) (*metadata.ResourceMetadata[ChatV1Role], error) {
	path := "/v1/Services/{ServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
