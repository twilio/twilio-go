...
func (c *ApiService) RolePage(ServiceSid string, params *ListRoleParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Services/{ServiceSid}/Roles"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
...
func (c *ApiService) RoleStream(ServiceSid string, params *ListRoleParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.RolePage(ServiceSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) RoleList(ServiceSid string, params *ListRoleParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.RolePage(ServiceSid, params, "", "", fmt.Sprint(limits.PageSize))
