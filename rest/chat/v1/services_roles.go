...
func (c *ApiService) ServicesRolesPage(ServiceSid string, params *ListRoleParams, pageToken string, pageNumber string) (*ListRoleResponse, error) {
	path := "/v1/Services/{ServiceSid}/Roles"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
...
func (c *ApiService) ServicesRolesList(ServiceSid string, params *ListRoleParams, limit int) ([]ListRoleResponse, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListRole(ServiceSid, params)
	if err != nil {
		return nil, err
	}
	...
	ret := make([]ListRoleResponse, len(resp))
...
func (c *ApiService) ServicesRolesStream(ServiceSid string, params *ListRoleParams, limit int) (chan interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListRole(ServiceSid, params)
	if err != nil {
		return nil, err
