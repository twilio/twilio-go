...
func (c *ApiService) ListRole(ServiceSid string, params *ListRoleParams, limit int) ([]ChatV1ServiceRole, error) {
	if params == nil {
...
func (c *ApiService) StreamRole(ServiceSid string, params *ListRoleParams, limit int) (chan ChatV1ServiceRole, error) {
	if params == nil {
		params = &ListRoleParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
