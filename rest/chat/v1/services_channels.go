...
func (c *ApiService) CreateChannelWithContext(ctx context.Context, ServiceSid string, params *CreateChannelParams) (*ChatV1Channel, error) {
...
func (c *ApiService) FetchChannelWithContext(ctx context.Context, ServiceSid string, Sid string) (*ChatV1Channel, error) {
	path := "/v1/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Channel records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListChannelWithContext(ctx context.Context, ServiceSid string, params *ListChannelParams) ([]ChatV1Channel, error) {
...
// Streams Channel records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamChannelWithContext(ctx context.Context, ServiceSid string, params *ListChannelParams) (chan ChatV1Channel, chan error) {
	if params == nil {
...
func (c *ApiService) streamChannelWithContext(ctx context.Context, response *ListChannelResponse, params *ListChannelParams, recordChannel chan ChatV1Channel, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateChannelWithContext(ctx context.Context, ServiceSid string, Sid string, params *UpdateChannelParams) (*ChatV1Channel, error) {
	path := "/v1/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
