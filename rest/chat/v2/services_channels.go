...
func (c *ApiService) CreateChannelWithMetadata(ServiceSid string, params *CreateChannelParams) (*metadata.ResourceMetadata[ChatV2Channel], error) {
	path := "/v2/Services/{ServiceSid}/Channels"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV2Channel](
...
func (c *ApiService) FetchChannelWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[ChatV2Channel], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListChannelWithMetadata(ServiceSid string, params *ListChannelParams) (*metadata.ResourceMetadata[[]ChatV2Channel], error) {
...
func (c *ApiService) StreamChannelWithMetadata(ServiceSid string, params *ListChannelParams) (*metadata.ResourceMetadata[chan ChatV2Channel], chan error) {
	if params == nil {
		params = &ListChannelParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV2Channel](
...
func (c *ApiService) UpdateChannelWithMetadata(ServiceSid string, Sid string, params *UpdateChannelParams) (*metadata.ResourceMetadata[ChatV2Channel], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
