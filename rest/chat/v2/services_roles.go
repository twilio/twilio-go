...
func (c *ApiService) ListRole(ServiceSid string, params *ListRoleParams) ([]ChatV2ServiceRole, error) {
	if params == nil {
...
func (c *ApiService) StreamRole(ServiceSid string, params *ListRoleParams) (chan ChatV2ServiceRole, error) {
	if params == nil {
		params = &ListRoleParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
