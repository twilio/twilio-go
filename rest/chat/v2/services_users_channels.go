...
func (c *ApiService) DeleteUserChannel(ServiceSid string, UserSid string, ChannelSid string, params *DeleteUserChannelParams) error {
	return c.DeleteUserChannelWithContext(context.TODO(), ServiceSid, UserSid, ChannelSid, params)
}
func (c *ApiService) DeleteUserChannelWithContext(ctx context.Context, ServiceSid string, UserSid string, ChannelSid string, params *DeleteUserChannelParams) error {
...
func (c *ApiService) FetchUserChannelWithContext(ctx context.Context, ServiceSid string, UserSid string, ChannelSid string) (*ChatV2UserChannel, error) {
	path := "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
...
// Lists UserChannel records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListUserChannelWithContext(ctx context.Context, ServiceSid string, UserSid string, params *ListUserChannelParams) ([]ChatV2UserChannel, error) {
...
// Streams UserChannel records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamUserChannelWithContext(ctx context.Context, ServiceSid string, UserSid string, params *ListUserChannelParams) (chan ChatV2UserChannel, chan error) {
	if params == nil {
...
func (c *ApiService) streamUserChannelWithContext(ctx context.Context, response *ListUserChannelResponse, params *ListUserChannelParams, recordChannel chan ChatV2UserChannel, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateUserChannelWithContext(ctx context.Context, ServiceSid string, UserSid string, ChannelSid string, params *UpdateUserChannelParams) (*ChatV2UserChannel, error) {
	path := "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
