...
func (c *ApiService) CreateChannelWebhookWithMetadata(ServiceSid string, ChannelSid string, params *CreateChannelWebhookParams) (*metadata.ResourceMetadata[ChatV2ChannelWebhook], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV2ChannelWebhook](
...
func (c *ApiService) FetchChannelWebhookWithMetadata(ServiceSid string, ChannelSid string, Sid string) (*metadata.ResourceMetadata[ChatV2ChannelWebhook], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListChannelWebhookWithMetadata(ServiceSid string, ChannelSid string, params *ListChannelWebhookParams) (*metadata.ResourceMetadata[[]ChatV2ChannelWebhook], error) {
...
func (c *ApiService) StreamChannelWebhookWithMetadata(ServiceSid string, ChannelSid string, params *ListChannelWebhookParams) (*metadata.ResourceMetadata[chan ChatV2ChannelWebhook], chan error) {
	if params == nil {
		params = &ListChannelWebhookParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV2ChannelWebhook](
...
func (c *ApiService) UpdateChannelWebhookWithMetadata(ServiceSid string, ChannelSid string, Sid string, params *UpdateChannelWebhookParams) (*metadata.ResourceMetadata[ChatV2ChannelWebhook], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
