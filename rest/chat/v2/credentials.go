...
func (c *ApiService) CreateCredentialWithMetadata(params *CreateCredentialParams) (*metadata.ResourceMetadata[ChatV2Credential], error) {
	path := "/v2/Credentials"
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV2Credential](
...
func (c *ApiService) FetchCredentialWithMetadata(Sid string) (*metadata.ResourceMetadata[ChatV2Credential], error) {
	path := "/v2/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListCredentialWithMetadata(params *ListCredentialParams) (*metadata.ResourceMetadata[[]ChatV2Credential], error) {
...
func (c *ApiService) StreamCredentialWithMetadata(params *ListCredentialParams) (*metadata.ResourceMetadata[chan ChatV2Credential], chan error) {
	if params == nil {
		params = &ListCredentialParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV2Credential](
...
func (c *ApiService) UpdateCredentialWithMetadata(Sid string, params *UpdateCredentialParams) (*metadata.ResourceMetadata[ChatV2Credential], error) {
	path := "/v2/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
