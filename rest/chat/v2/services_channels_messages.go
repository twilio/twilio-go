...
func (c *ApiService) CreateMessageWithMetadata(ServiceSid string, ChannelSid string, params *CreateMessageParams) (*metadata.ResourceMetadata[ChatV2Message], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV2Message](
...
func (c *ApiService) FetchMessageWithMetadata(ServiceSid string, ChannelSid string, Sid string) (*metadata.ResourceMetadata[ChatV2Message], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListMessageWithMetadata(ServiceSid string, ChannelSid string, params *ListMessageParams) (*metadata.ResourceMetadata[[]ChatV2Message], error) {
...
func (c *ApiService) StreamMessageWithMetadata(ServiceSid string, ChannelSid string, params *ListMessageParams) (*metadata.ResourceMetadata[chan ChatV2Message], chan error) {
	if params == nil {
		params = &ListMessageParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV2Message](
...
func (c *ApiService) UpdateMessageWithMetadata(ServiceSid string, ChannelSid string, Sid string, params *UpdateMessageParams) (*metadata.ResourceMetadata[ChatV2Message], error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
