...
func (c *ApiService) CreateMessageWithContext(ctx context.Context, ServiceSid string, ChannelSid string, params *CreateMessageParams) (*ChatV2Message, error) {
...
func (c *ApiService) FetchMessageWithContext(ctx context.Context, ServiceSid string, ChannelSid string, Sid string) (*ChatV2Message, error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Message records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListMessageWithContext(ctx context.Context, ServiceSid string, ChannelSid string, params *ListMessageParams) ([]ChatV2Message, error) {
...
// Streams Message records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamMessageWithContext(ctx context.Context, ServiceSid string, ChannelSid string, params *ListMessageParams) (chan ChatV2Message, chan error) {
	if params == nil {
...
func (c *ApiService) streamMessageWithContext(ctx context.Context, response *ListMessageResponse, params *ListMessageParams, recordChannel chan ChatV2Message, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) UpdateMessageWithContext(ctx context.Context, ServiceSid string, ChannelSid string, Sid string, params *UpdateMessageParams) (*ChatV2Message, error) {
	path := "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ChannelSid"+"}", ChannelSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
