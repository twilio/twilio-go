...
func (c *ApiService) FetchUserBindingWithMetadata(ServiceSid string, UserSid string, Sid string) (*metadata.ResourceMetadata[ChatV2UserBinding], error) {
	path := "/v2/Services/{ServiceSid}/Users/{UserSid}/Bindings/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV2UserBinding](
...
func (c *ApiService) ListUserBindingWithMetadata(ServiceSid string, UserSid string, params *ListUserBindingParams) (*metadata.ResourceMetadata[[]ChatV2UserBinding], error) {
...
func (c *ApiService) StreamUserBindingWithMetadata(ServiceSid string, UserSid string, params *ListUserBindingParams) (*metadata.ResourceMetadata[chan ChatV2UserBinding], chan error) {
	if params == nil {
		params = &ListUserBindingParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV2UserBinding](
