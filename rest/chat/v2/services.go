...
func (c *ApiService) CreateServiceWithMetadata(params *CreateServiceParams) (*metadata.ResourceMetadata[ChatV2Service], error) {
	path := "/v2/Services"
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV2Service](
...
func (c *ApiService) FetchServiceWithMetadata(Sid string) (*metadata.ResourceMetadata[ChatV2Service], error) {
	path := "/v2/Services/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListServiceWithMetadata(params *ListServiceParams) (*metadata.ResourceMetadata[[]ChatV2Service], error) {
...
func (c *ApiService) StreamServiceWithMetadata(params *ListServiceParams) (*metadata.ResourceMetadata[chan ChatV2Service], chan error) {
	if params == nil {
		params = &ListServiceParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan ChatV2Service](
...
func (c *ApiService) UpdateServiceWithMetadata(Sid string, params *UpdateServiceParams) (*metadata.ResourceMetadata[ChatV2Service], error) {
	path := "/v2/Services/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
