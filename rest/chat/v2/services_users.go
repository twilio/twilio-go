...
// CreateUserWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateUserWithMetadata(ServiceSid string, params *CreateUserParams) (*metadata.ResourceMetadata[ChatV2User], error) {
	path := "/v2/Services/{ServiceSid}/Users"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ChatV2User](
...
// DeleteUserWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteUserWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[bool], error) {
	path := "/v2/Services/{ServiceSid}/Users/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) FetchUserWithMetadata(ServiceSid string, Sid string) (*metadata.ResourceMetadata[ChatV2User], error) {
	path := "/v2/Services/{ServiceSid}/Users/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// PageUserWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageUserWithMetadata(ServiceSid string, params *ListUserParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListUserResponse], error) {
	path := "/v2/Services/{ServiceSid}/Users"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListUserResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListUserWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListUserWithMetadata(ServiceSid string, params *ListUserParams) (*metadata.ResourceMetadata[[]ChatV2User], error) {
	response, errors := c.StreamUserWithMetadata(ServiceSid, params)
...
func (c *ApiService) StreamUser(ServiceSid string, params *ListUserParams) (chan ChatV2User, chan error) {
	if params == nil {
		params = &ListUserParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan ChatV2User, 1)
...
// StreamUserWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamUserWithMetadata(ServiceSid string, params *ListUserParams) (*metadata.ResourceMetadata[chan ChatV2User], chan error) {
	if params == nil {
		params = &ListUserParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageUserWithMetadata(ServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamUser(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ChatV2User](
...
func (c *ApiService) UpdateUserWithMetadata(ServiceSid string, Sid string, params *UpdateUserParams) (*metadata.ResourceMetadata[ChatV2User], error) {
	path := "/v2/Services/{ServiceSid}/Users/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
