...
func (c *ApiService) CreateWebhook(ServiceSid string, params *CreateWebhookParams) (*VerifyV2Webhook, error) {
	return c.CreateWebhookWithContext(context.TODO(), ServiceSid, params)
}
func (c *ApiService) CreateWebhookWithContext(ctx context.Context, ServiceSid string, params *CreateWebhookParams) (*VerifyV2Webhook, error) {
...
func (c *ApiService) DeleteWebhook(ServiceSid string, Sid string) error {
	return c.DeleteWebhookWithContext(context.TODO(), ServiceSid, Sid)
}
func (c *ApiService) DeleteWebhookWithContext(ctx context.Context, ServiceSid string, Sid string) error {
...
func (c *ApiService) FetchWebhook(ServiceSid string, Sid string) (*VerifyV2Webhook, error) {
	return c.FetchWebhookWithContext(context.TODO(), ServiceSid, Sid)
}
func (c *ApiService) FetchWebhookWithContext(ctx context.Context, ServiceSid string, Sid string) (*VerifyV2Webhook, error) {
	path := "/v2/Services/{ServiceSid}/Webhooks/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageWebhook(ServiceSid string, params *ListWebhookParams, pageToken, pageNumber string) (*ListWebhookResponse, error) {
	return c.PageWebhookWithContext(context.TODO(), ServiceSid, params, pageToken, pageNumber)
}

// Retrieve a single page of Webhook records from the API. Request is executed immediately.
func (c *ApiService) PageWebhookWithContext(ctx context.Context, ServiceSid string, params *ListWebhookParams, pageToken, pageNumber string) (*ListWebhookResponse, error) {
	path := "/v2/Services/{ServiceSid}/Webhooks"
...
func (c *ApiService) ListWebhook(ServiceSid string, params *ListWebhookParams) ([]VerifyV2Webhook, error) {
	return c.ListWebhookWithContext(context.TODO(), ServiceSid, params)
}

// Lists Webhook records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListWebhookWithContext(ctx context.Context, ServiceSid string, params *ListWebhookParams) ([]VerifyV2Webhook, error) {
	response, errors := c.StreamWebhookWithContext(ctx, ServiceSid, params)
...
func (c *ApiService) StreamWebhook(ServiceSid string, params *ListWebhookParams) (chan VerifyV2Webhook, chan error) {
	return c.StreamWebhookWithContext(context.TODO(), ServiceSid, params)
}

// Streams Webhook records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamWebhookWithContext(ctx context.Context, ServiceSid string, params *ListWebhookParams) (chan VerifyV2Webhook, chan error) {
	if params == nil {
	...
	response, err := c.PageWebhookWithContext(ctx, ServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamWebhookWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamWebhookWithContext(ctx context.Context, response *ListWebhookResponse, params *ListWebhookParams, recordChannel chan VerifyV2Webhook, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListWebhookResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListWebhookResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
...
func (c *ApiService) UpdateWebhook(ServiceSid string, Sid string, params *UpdateWebhookParams) (*VerifyV2Webhook, error) {
	return c.UpdateWebhookWithContext(context.TODO(), ServiceSid, Sid, params)
}
func (c *ApiService) UpdateWebhookWithContext(ctx context.Context, ServiceSid string, Sid string, params *UpdateWebhookParams) (*VerifyV2Webhook, error) {
	path := "/v2/Services/{ServiceSid}/Webhooks/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
