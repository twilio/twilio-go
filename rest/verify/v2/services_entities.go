...
func (c *ApiService) EntityPage(ServiceSid string, params *ListEntityParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v2/Services/{ServiceSid}/Entities"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
...
func (c *ApiService) EntityStream(ServiceSid string, params *ListEntityParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EntityPage(ServiceSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) EntityList(ServiceSid string, params *ListEntityParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EntityPage(ServiceSid, params, "", "", fmt.Sprint(limits.PageSize))
