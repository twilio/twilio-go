...
func (c *ApiService) CreateEntity(ServiceSid string, params *CreateEntityParams) (*VerifyV2Entity, error) {
	return c.CreateEntityWithCtx(context.TODO(), ServiceSid, params)
}

// Create a new Entity for the Service
func (c *ApiService) CreateEntityWithCtx(ctx context.Context, ServiceSid string, params *CreateEntityParams) (*VerifyV2Entity, error) {
...
func (c *ApiService) DeleteEntity(ServiceSid string, Identity string) error {
	return c.DeleteEntityWithCtx(context.TODO(), ServiceSid, Identity)
}

// Delete a specific Entity.
func (c *ApiService) DeleteEntityWithCtx(ctx context.Context, ServiceSid string, Identity string) error {
...
func (c *ApiService) FetchEntity(ServiceSid string, Identity string) (*VerifyV2Entity, error) {
	return c.FetchEntityWithCtx(context.TODO(), ServiceSid, Identity)
}

// Fetch a specific Entity.
func (c *ApiService) FetchEntityWithCtx(ctx context.Context, ServiceSid string, Identity string) (*VerifyV2Entity, error) {
	path := "/v2/Services/{ServiceSid}/Entities/{Identity}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Identity"+"}", Identity, -1)
...
func (c *ApiService) PageEntity(ServiceSid string, params *ListEntityParams, pageToken, pageNumber string) (*ListEntityResponse, error) {
	return c.PageEntityWithCtx(context.TODO(), ServiceSid, params, pageToken, pageNumber)
}

// Retrieve a single page of Entity records from the API. Request is executed immediately.
func (c *ApiService) PageEntityWithCtx(ctx context.Context, ServiceSid string, params *ListEntityParams, pageToken, pageNumber string) (*ListEntityResponse, error) {
	path := "/v2/Services/{ServiceSid}/Entities"
...
func (c *ApiService) ListEntity(ServiceSid string, params *ListEntityParams) ([]VerifyV2Entity, error) {
	return c.ListEntityWithCtx(context.TODO(), ServiceSid, params)
}

// Lists Entity records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListEntityWithCtx(ctx context.Context, ServiceSid string, params *ListEntityParams) ([]VerifyV2Entity, error) {
	response, errors := c.StreamEntityWithCtx(ctx, ServiceSid, params)
...
func (c *ApiService) StreamEntity(ServiceSid string, params *ListEntityParams) (chan VerifyV2Entity, chan error) {
	return c.StreamEntityWithCtx(context.TODO(), ServiceSid, params)
}

// Streams Entity records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamEntityWithCtx(ctx context.Context, ServiceSid string, params *ListEntityParams) (chan VerifyV2Entity, chan error) {
	if params == nil {
	...
	response, err := c.PageEntityWithCtx(ctx, ServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamEntity(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamEntity(ctx context.Context, response *ListEntityResponse, params *ListEntityParams, recordChannel chan VerifyV2Entity, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) getNextListEntityResponse(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
