...
// param: ServiceSid The unique SID identifier of the Service.
//
// param: Identity The unique external identifier for the Entity of the Service. This identifier should be immutable, not PII, and generated by your external system, such as your user's UUID, GUID, or SID. This value must be between 8 and 64 characters long.
//
// param: optional nil or *CreateChallengeParams - Optional Parameters:
//
// param: "AuthPayload" (string) - Optional payload used to verify the Challenge upon creation. Only used with a Factor of type `totp` to carry the TOTP code that needs to be verified.
//
...
//
// param: "BindingPublicKey" (string) - The Ecdsa public key in PKIX, ASN.1 DER format encoded in Base64.  Required when `factor_type` is `push`
//
// param: "BindingSecret" (string) - The shared secret for TOTP factors encoded in Base32. This can be provided when creating the Factor, otherwise it will be generated.  Used when `factor_type` is `totp`
//
// param: "ConfigAlg" (string) - The algorithm used to derive the TOTP codes. Can be `sha1`, `sha256` or `sha512`. Defaults to `sha1`.  Used when `factor_type` is `totp`
//
// param: "ConfigAppId" (string) - The ID that uniquely identifies your app in the Google or Apple store, such as `com.example.myapp`.  Required when `factor_type` is `push`. If specified, it can be up to 100 characters long.
//
// param: "ConfigCodeLength" (int32) - Number of digits for generated TOTP codes. Must be between 3 and 8, inclusive. The default value is defined at the service level in the property `totp.code_length`. If not configured defaults to 6.  Used when `factor_type` is `totp`
//
...
//
// param: "ConfigNotificationToken" (string) - For APN, the device token. For FCM the registration token. It used to send the push notifications.  Used when `factor_type` is `push`. If specified, must be between 32 and 255 characters long.
//
// param: "ConfigSdkVersion" (string) - The Verify Push SDK version used to configure the factor  Used when `factor_type` is `push`
//
// param: "ConfigSkew" (int32) - The number of time-steps, past and future, that are valid for validation of TOTP codes. Must be between 0 and 2, inclusive. The default value is defined at the service level in the property `totp.skew`. If not configured defaults to 1.  Used when `factor_type` is `totp`
//
// param: "ConfigTimeStep" (int32) - Defines how often, in seconds, are TOTP codes generated. i.e, a new TOTP code is generated every time_step seconds. Must be between 20 and 60 seconds, inclusive. The default value is defined at the service level in the property `totp.time_step`. Defaults to 30 seconds if not configured.  Used when `factor_type` is `totp`
//
// param: "FactorType" (string) - The Type of this Factor. Currently `push` and `totp` are supported. For `totp` to work, you need to contact [Twilio sales](https://www.twilio.com/help/sales) first to have the Verify TOTP feature enabled for your Twilio account.
//
// param: "FriendlyName" (string) - The friendly name of this Factor. This can be any string up to 64 characters, meant for humans to distinguish between Factors. For `factor_type` `push`, this could be a device name. For `factor_type` `totp`, this value is used as the “account name” in constructing the `binding.uri` property. At the same time, we recommend avoiding providing PII.
//
...
// param: Identity The unique external identifier for the Entity of the Service. This identifier should be immutable, not PII, and generated by your external system, such as your user's UUID, GUID, or SID. This value must be between 8 and 64 characters long.
//
// param: ChallengeSid The unique SID identifier of the Challenge.
//
// param: optional nil or *CreateNotificationParams - Optional Parameters:
//
// param: "Ttl" (int32) - How long, in seconds, the Notification is valid. Delivery will be attempted if the device is offline until the TTL elapses. 0 means that the notification delivery is attempted immediately, only once, and is not stored for future delivery. Must be an integer between 0 and 300 seconds, inclusive. Defaults to 300 seconds.
//
...
//
// param: "TotpCodeLength" (int32) - Optional configuration for the TOTP factors. Number of digits for generated TOTP codes. Must be between 3 and 8, inclusive. Defaults to 6
//
// param: "TotpIssuer" (string) - Optional configuration for the TOTP factors. Set TOTP Issuer for this service. This will allow to configure the issuer of the TOTP URI. Defaults to the service friendly name if not provided.
//
// param: "TotpSkew" (int32) - Optional configuration for the TOTP factors. The number of time-steps, past and future, that are valid for validation of TOTP codes. Must be between 0 and 2, inclusive. Defaults to 1
//
// param: "TotpTimeStep" (int32) - Optional configuration for the TOTP factors. Defines how often, in seconds, are TOTP codes generated. i.e, a new TOTP code is generated every time_step seconds. Must be between 20 and 60 seconds, inclusive. Defaults to 30 seconds
//
...
// param: ServiceSid The unique SID identifier of the Service.
//
// param: Identity Customer unique identity for the Entity owner of the Challenge. This value must be between 8 and 64 characters long.
//
...
//
// param: "ConfigAlg" (string) - The algorithm used to derive the TOTP codes. Can be `sha1`, `sha256` or `sha512`
//
// param: "ConfigCodeLength" (int32) - Number of digits for generated TOTP codes. Must be between 3 and 8, inclusive
//
// param: "ConfigNotificationToken" (string) - For APN, the device token. For FCM the registration token. It used to send the push notifications. Required when `factor_type` is `push`. If specified, this value must be between 32 and 255 characters long.
//
// param: "ConfigSdkVersion" (string) - The Verify Push SDK version used to configure the factor
//
// param: "ConfigSkew" (int32) - The number of time-steps, past and future, that are valid for validation of TOTP codes. Must be between 0 and 2, inclusive
//
// param: "ConfigTimeStep" (int32) - Defines how often, in seconds, are TOTP codes generated. i.e, a new TOTP code is generated every time_step seconds. Must be between 20 and 60 seconds, inclusive
//
// param: "FriendlyName" (string) - The new friendly name of this Factor. It can be up to 64 characters.
//
// return: VerifyV2ServiceEntityFactor
...
// param: "TotpCodeLength" (int32) - Optional configuration for the TOTP factors. Number of digits for generated TOTP codes. Must be between 3 and 8, inclusive. Defaults to 6
//
// param: "TotpIssuer" (string) - Optional configuration for the TOTP factors. Set TOTP Issuer for this service. This will allow to configure the issuer of the TOTP URI.
//
// param: "TotpSkew" (int32) - Optional configuration for the TOTP factors. The number of time-steps, past and future, that are valid for validation of TOTP codes. Must be between 0 and 2, inclusive. Defaults to 1
//
// param: "TotpTimeStep" (int32) - Optional configuration for the TOTP factors. Defines how often, in seconds, are TOTP codes generated. i.e, a new TOTP code is generated every time_step seconds. Must be between 20 and 60 seconds, inclusive. Defaults to 30 seconds
