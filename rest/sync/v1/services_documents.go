...
func (c *ApiService) DocumentPage(ServiceSid string, params *ListDocumentParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Services/{ServiceSid}/Documents"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
...
func (c *ApiService) DocumentStream(ServiceSid string, params *ListDocumentParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.DocumentPage(ServiceSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) DocumentList(ServiceSid string, params *ListDocumentParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.DocumentPage(ServiceSid, params, "", "", fmt.Sprint(limits.PageSize))
