...
func (c *ApiService) CreateSyncList(ServiceSid string, params *CreateSyncListParams) (*SyncV1SyncList, error) {
	return c.CreateSyncListWithContext(context.TODO(), ServiceSid, params)
}
func (c *ApiService) CreateSyncListWithContext(ctx context.Context, ServiceSid string, params *CreateSyncListParams) (*SyncV1SyncList, error) {
...
func (c *ApiService) DeleteSyncList(ServiceSid string, Sid string) error {
	return c.DeleteSyncListWithContext(context.TODO(), ServiceSid, Sid)
}
func (c *ApiService) DeleteSyncListWithContext(ctx context.Context, ServiceSid string, Sid string) error {
...
func (c *ApiService) FetchSyncList(ServiceSid string, Sid string) (*SyncV1SyncList, error) {
	return c.FetchSyncListWithContext(context.TODO(), ServiceSid, Sid)
}
func (c *ApiService) FetchSyncListWithContext(ctx context.Context, ServiceSid string, Sid string) (*SyncV1SyncList, error) {
	path := "/v1/Services/{ServiceSid}/Lists/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageSyncList(ServiceSid string, params *ListSyncListParams, pageToken, pageNumber string) (*ListSyncListResponse, error) {
	return c.PageSyncListWithContext(context.TODO(), ServiceSid, params, pageToken, pageNumber)
}

// Retrieve a single page of SyncList records from the API. Request is executed immediately.
func (c *ApiService) PageSyncListWithContext(ctx context.Context, ServiceSid string, params *ListSyncListParams, pageToken, pageNumber string) (*ListSyncListResponse, error) {
	path := "/v1/Services/{ServiceSid}/Lists"
...
func (c *ApiService) ListSyncList(ServiceSid string, params *ListSyncListParams) ([]SyncV1SyncList, error) {
	return c.ListSyncListWithContext(context.TODO(), ServiceSid, params)
}

// Lists SyncList records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListSyncListWithContext(ctx context.Context, ServiceSid string, params *ListSyncListParams) ([]SyncV1SyncList, error) {
	response, errors := c.StreamSyncListWithContext(ctx, ServiceSid, params)
...
func (c *ApiService) StreamSyncList(ServiceSid string, params *ListSyncListParams) (chan SyncV1SyncList, chan error) {
	return c.StreamSyncListWithContext(context.TODO(), ServiceSid, params)
}

// Streams SyncList records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamSyncListWithContext(ctx context.Context, ServiceSid string, params *ListSyncListParams) (chan SyncV1SyncList, chan error) {
	if params == nil {
	...
	response, err := c.PageSyncListWithContext(ctx, ServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamSyncListWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamSyncListWithContext(ctx context.Context, response *ListSyncListResponse, params *ListSyncListParams, recordChannel chan SyncV1SyncList, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListSyncListResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListSyncListResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
...
func (c *ApiService) UpdateSyncList(ServiceSid string, Sid string, params *UpdateSyncListParams) (*SyncV1SyncList, error) {
	return c.UpdateSyncListWithContext(context.TODO(), ServiceSid, Sid, params)
}
func (c *ApiService) UpdateSyncListWithContext(ctx context.Context, ServiceSid string, Sid string, params *UpdateSyncListParams) (*SyncV1SyncList, error) {
	path := "/v1/Services/{ServiceSid}/Lists/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
