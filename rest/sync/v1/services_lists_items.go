...
func (c *ApiService) CreateSyncListItem(ServiceSid string, ListSid string, params *CreateSyncListItemParams) (*SyncV1SyncListItem, error) {
	return c.CreateSyncListItemWithContext(context.TODO(), ServiceSid, ListSid, params)
}
func (c *ApiService) CreateSyncListItemWithContext(ctx context.Context, ServiceSid string, ListSid string, params *CreateSyncListItemParams) (*SyncV1SyncListItem, error) {
...
func (c *ApiService) DeleteSyncListItem(ServiceSid string, ListSid string, Index int, params *DeleteSyncListItemParams) error {
	return c.DeleteSyncListItemWithContext(context.TODO(), ServiceSid, ListSid, Index, params)
}
func (c *ApiService) DeleteSyncListItemWithContext(ctx context.Context, ServiceSid string, ListSid string, Index int, params *DeleteSyncListItemParams) error {
...
func (c *ApiService) FetchSyncListItem(ServiceSid string, ListSid string, Index int) (*SyncV1SyncListItem, error) {
	return c.FetchSyncListItemWithContext(context.TODO(), ServiceSid, ListSid, Index)
}
func (c *ApiService) FetchSyncListItemWithContext(ctx context.Context, ServiceSid string, ListSid string, Index int) (*SyncV1SyncListItem, error) {
	path := "/v1/Services/{ServiceSid}/Lists/{ListSid}/Items/{Index}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ListSid"+"}", ListSid, -1)
	path = strings.Replace(path, "{"+"Index"+"}", fmt.Sprint(Index), -1)
...
func (c *ApiService) PageSyncListItem(ServiceSid string, ListSid string, params *ListSyncListItemParams, pageToken, pageNumber string) (*ListSyncListItemResponse, error) {
	return c.PageSyncListItemWithContext(context.TODO(), ServiceSid, ListSid, params, pageToken, pageNumber)
}

// Retrieve a single page of SyncListItem records from the API. Request is executed immediately.
func (c *ApiService) PageSyncListItemWithContext(ctx context.Context, ServiceSid string, ListSid string, params *ListSyncListItemParams, pageToken, pageNumber string) (*ListSyncListItemResponse, error) {
	path := "/v1/Services/{ServiceSid}/Lists/{ListSid}/Items"
...
func (c *ApiService) ListSyncListItem(ServiceSid string, ListSid string, params *ListSyncListItemParams) ([]SyncV1SyncListItem, error) {
	return c.ListSyncListItemWithContext(context.TODO(), ServiceSid, ListSid, params)
}

// Lists SyncListItem records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListSyncListItemWithContext(ctx context.Context, ServiceSid string, ListSid string, params *ListSyncListItemParams) ([]SyncV1SyncListItem, error) {
	response, errors := c.StreamSyncListItemWithContext(ctx, ServiceSid, ListSid, params)
...
func (c *ApiService) StreamSyncListItem(ServiceSid string, ListSid string, params *ListSyncListItemParams) (chan SyncV1SyncListItem, chan error) {
	return c.StreamSyncListItemWithContext(context.TODO(), ServiceSid, ListSid, params)
}

// Streams SyncListItem records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamSyncListItemWithContext(ctx context.Context, ServiceSid string, ListSid string, params *ListSyncListItemParams) (chan SyncV1SyncListItem, chan error) {
	if params == nil {
	...
	response, err := c.PageSyncListItemWithContext(ctx, ServiceSid, ListSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamSyncListItemWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamSyncListItemWithContext(ctx context.Context, response *ListSyncListItemResponse, params *ListSyncListItemParams, recordChannel chan SyncV1SyncListItem, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListSyncListItemResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListSyncListItemResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
...
func (c *ApiService) UpdateSyncListItem(ServiceSid string, ListSid string, Index int, params *UpdateSyncListItemParams) (*SyncV1SyncListItem, error) {
	return c.UpdateSyncListItemWithContext(context.TODO(), ServiceSid, ListSid, Index, params)
}
func (c *ApiService) UpdateSyncListItemWithContext(ctx context.Context, ServiceSid string, ListSid string, Index int, params *UpdateSyncListItemParams) (*SyncV1SyncListItem, error) {
	path := "/v1/Services/{ServiceSid}/Lists/{ListSid}/Items/{Index}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"ListSid"+"}", ListSid, -1)
	path = strings.Replace(path, "{"+"Index"+"}", fmt.Sprint(Index), -1)
