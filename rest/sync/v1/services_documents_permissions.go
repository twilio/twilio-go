...
func (c *ApiService) DocumentPermissionPage(ServiceSid string, DocumentSid string, params *ListDocumentPermissionParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/v1/Services/{ServiceSid}/Documents/{DocumentSid}/Permissions"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"DocumentSid"+"}", DocumentSid, -1)
...
func (c *ApiService) DocumentPermissionStream(ServiceSid string, DocumentSid string, params *ListDocumentPermissionParams, limit int) (chan map[string]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.DocumentPermissionPage(ServiceSid, DocumentSid, params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) DocumentPermissionList(ServiceSid string, DocumentSid string, params *ListDocumentPermissionParams, limit int) ([]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.DocumentPermissionPage(ServiceSid, DocumentSid, params, "", "")
	if err != nil {
		return nil, err
