...
func (c *ApiService) CreateSyncMap(ServiceSid string, params *CreateSyncMapParams) (*SyncV1SyncMap, error) {
	return c.CreateSyncMapWithContext(context.TODO(), ServiceSid, params)
}
func (c *ApiService) CreateSyncMapWithContext(ctx context.Context, ServiceSid string, params *CreateSyncMapParams) (*SyncV1SyncMap, error) {
...
func (c *ApiService) DeleteSyncMap(ServiceSid string, Sid string) error {
	return c.DeleteSyncMapWithContext(context.TODO(), ServiceSid, Sid)
}
func (c *ApiService) DeleteSyncMapWithContext(ctx context.Context, ServiceSid string, Sid string) error {
...
func (c *ApiService) FetchSyncMap(ServiceSid string, Sid string) (*SyncV1SyncMap, error) {
	return c.FetchSyncMapWithContext(context.TODO(), ServiceSid, Sid)
}
func (c *ApiService) FetchSyncMapWithContext(ctx context.Context, ServiceSid string, Sid string) (*SyncV1SyncMap, error) {
	path := "/v1/Services/{ServiceSid}/Maps/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageSyncMap(ServiceSid string, params *ListSyncMapParams, pageToken, pageNumber string) (*ListSyncMapResponse, error) {
	return c.PageSyncMapWithContext(context.TODO(), ServiceSid, params, pageToken, pageNumber)
}

// Retrieve a single page of SyncMap records from the API. Request is executed immediately.
func (c *ApiService) PageSyncMapWithContext(ctx context.Context, ServiceSid string, params *ListSyncMapParams, pageToken, pageNumber string) (*ListSyncMapResponse, error) {
	path := "/v1/Services/{ServiceSid}/Maps"
...
func (c *ApiService) ListSyncMap(ServiceSid string, params *ListSyncMapParams) ([]SyncV1SyncMap, error) {
	return c.ListSyncMapWithContext(context.TODO(), ServiceSid, params)
}

// Lists SyncMap records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListSyncMapWithContext(ctx context.Context, ServiceSid string, params *ListSyncMapParams) ([]SyncV1SyncMap, error) {
	response, errors := c.StreamSyncMapWithContext(ctx, ServiceSid, params)
...
func (c *ApiService) StreamSyncMap(ServiceSid string, params *ListSyncMapParams) (chan SyncV1SyncMap, chan error) {
	return c.StreamSyncMapWithContext(context.TODO(), ServiceSid, params)
}

// Streams SyncMap records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamSyncMapWithContext(ctx context.Context, ServiceSid string, params *ListSyncMapParams) (chan SyncV1SyncMap, chan error) {
	if params == nil {
	...
	response, err := c.PageSyncMapWithContext(ctx, ServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamSyncMapWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamSyncMapWithContext(ctx context.Context, response *ListSyncMapResponse, params *ListSyncMapParams, recordChannel chan SyncV1SyncMap, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListSyncMapResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListSyncMapResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
...
func (c *ApiService) UpdateSyncMap(ServiceSid string, Sid string, params *UpdateSyncMapParams) (*SyncV1SyncMap, error) {
	return c.UpdateSyncMapWithContext(context.TODO(), ServiceSid, Sid, params)
}
func (c *ApiService) UpdateSyncMapWithContext(ctx context.Context, ServiceSid string, Sid string, params *UpdateSyncMapParams) (*SyncV1SyncMap, error) {
	path := "/v1/Services/{ServiceSid}/Maps/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
