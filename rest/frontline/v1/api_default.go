...
func (c *DefaultApiService) FetchUser(Sid string) (*FrontlineV1User, error) {
	path := "/v1/Users/{Sid}"
...
func (c *DefaultApiService) UpdateUser(Sid string, params *UpdateUserParams) (*FrontlineV1User, error) {
	path := "/v1/Users/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
