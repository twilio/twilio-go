...
func (c *ApiService) ListKnowledgeChunksWithMetadata(Id string, params *ListKnowledgeChunksParams) (*metadata.ResourceMetadata[[]KnowledgeV1KnowledgeChunk], error) {
	...
	metadataWrapper := metadata.NewResourceMetadata[[]KnowledgeV1KnowledgeChunk](
		records,
...
func (c *ApiService) StreamKnowledgeChunksWithMetadata(Id string, params *ListKnowledgeChunksParams) (*metadata.ResourceMetadata[chan KnowledgeV1KnowledgeChunk], chan error) {
	if params == nil {
		params = &ListKnowledgeChunksParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	metadataWrapper := metadata.NewResourceMetadata[chan KnowledgeV1KnowledgeChunk](
