...
func (c *ApiService) FleetPage(params *ListFleetParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Fleets"
...
func (c *ApiService) FleetStream(params *ListFleetParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.FleetPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) FleetList(params *ListFleetParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.FleetPage(params, "", "", fmt.Sprint(limits.PageSize))
