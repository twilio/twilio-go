...
func (c *ApiService) CreateSmsCommand(params *CreateSmsCommandParams) (*SupersimV1SmsCommand, error) {
	return c.CreateSmsCommandWithContext(context.TODO(), params)
}
func (c *ApiService) CreateSmsCommandWithContext(ctx context.Context, params *CreateSmsCommandParams) (*SupersimV1SmsCommand, error) {
	path := "/v1/SmsCommands"
...
func (c *ApiService) FetchSmsCommand(Sid string) (*SupersimV1SmsCommand, error) {
	return c.FetchSmsCommandWithContext(context.TODO(), Sid)
}
func (c *ApiService) FetchSmsCommandWithContext(ctx context.Context, Sid string) (*SupersimV1SmsCommand, error) {
...
func (c *ApiService) PageSmsCommand(params *ListSmsCommandParams, pageToken, pageNumber string) (*ListSmsCommandResponse, error) {
	return c.PageSmsCommandWithContext(context.TODO(), params, pageToken, pageNumber)
}

// Retrieve a single page of SmsCommand records from the API. Request is executed immediately.
func (c *ApiService) PageSmsCommandWithContext(ctx context.Context, params *ListSmsCommandParams, pageToken, pageNumber string) (*ListSmsCommandResponse, error) {
	path := "/v1/SmsCommands"
...
func (c *ApiService) ListSmsCommand(params *ListSmsCommandParams) ([]SupersimV1SmsCommand, error) {
	return c.ListSmsCommandWithContext(context.TODO(), params)
}

// Lists SmsCommand records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListSmsCommandWithContext(ctx context.Context, params *ListSmsCommandParams) ([]SupersimV1SmsCommand, error) {
	response, errors := c.StreamSmsCommandWithContext(ctx, params)
...
func (c *ApiService) StreamSmsCommand(params *ListSmsCommandParams) (chan SupersimV1SmsCommand, chan error) {
	return c.StreamSmsCommandWithContext(context.TODO(), params)
}

// Streams SmsCommand records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamSmsCommandWithContext(ctx context.Context, params *ListSmsCommandParams) (chan SupersimV1SmsCommand, chan error) {
	if params == nil {
	...
	response, err := c.PageSmsCommandWithContext(ctx, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamSmsCommandWithContext(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamSmsCommandWithContext(ctx context.Context, response *ListSmsCommandResponse, params *ListSmsCommandParams, recordChannel chan SupersimV1SmsCommand, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithContext(ctx, c.baseURL, response, c.getNextListSmsCommandResponseWithContext)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListSmsCommandResponseWithContext(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
