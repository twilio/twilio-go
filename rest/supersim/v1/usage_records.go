...
func (c *ApiService) UsageRecordsPage(params *ListUsageRecordParams, pageToken string, pageNumber string) (*ListUsageRecordResponse, error) {
	path := "/v1/UsageRecords"
...
func (c *ApiService) UsageRecordsList(params *ListUsageRecordParams, limit int) ([]ListUsageRecordResponse, error) {
...
func (c *ApiService) UsageRecordsStream(params *ListUsageRecordParams, limit int) (chan interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListUsageRecord(params)
	if err != nil {
		return nil, err
