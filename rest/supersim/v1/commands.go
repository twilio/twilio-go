...
func (c *ApiService) CommandPage(params *ListCommandParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Commands"
...
func (c *ApiService) CommandStream(params *ListCommandParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.CommandPage(params, "", "", fmt.Sprint(limits.PageSize))
	return c.requestHandler.Stream(page, limits.Limit, limits.PageLimit)
}

//Lists Command records from the API as a list. Unlike stream, this operation is eager and will loads 'limit' records into memory before returning.
func (c *ApiService) CommandList(params *ListCommandParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.CommandPage(params, "", "", fmt.Sprint(limits.PageSize))
