...
// ConversationsV2PatchConversationConfiguration Partial configuration update for an existing conversation. Only statusCallbacks can be modified.
type ConversationsV2PatchConversationConfiguration struct {
