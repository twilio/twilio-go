...
// PatchConfigurationRequest struct for PatchConfigurationRequest
type PatchConfigurationRequest struct {
	...
	ChannelSettings map[string]PatchConfigurationRequestChannelSettingsValue `json:"channelSettings,omitempty"`
	...
	ConversationsV1Bridge   *PatchConfigurationRequestConversationsV1Bridge `json:"conversationsV1Bridge,omitempty"`
}
