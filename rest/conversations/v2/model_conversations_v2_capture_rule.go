...
// ConversationsV2CaptureRule Defines a capture rule with from and to addresses. Supports wildcard `*` for omnidirectional matching.
type ConversationsV2CaptureRule struct {
