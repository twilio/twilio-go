...
// ListParticipantByConversationResponseParticipants struct for ListParticipantByConversationResponseParticipants
type ListParticipantByConversationResponseParticipants struct {
	// Participant ID.
	Id string `json:"id"`
	// Conversation ID.
