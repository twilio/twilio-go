...
// ListCommunicationByConversationResponseCommunications struct for ListCommunicationByConversationResponseCommunications
type ListCommunicationByConversationResponseCommunications struct {
	// Communication ID.
	Id string `json:"id"`
	// Conversation ID.
