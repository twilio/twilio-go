...
func (params *ListServiceRoleParams) SetPageSize(PageSize int64) *ListServiceRoleParams {
	params.PageSize = &PageSize
	return params
}
func (params *ListServiceRoleParams) SetLimit(Limit int64) *ListServiceRoleParams {
	params.Limit = &Limit
	return params
}
