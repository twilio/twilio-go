...
// CreateServiceRoleWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) CreateServiceRoleWithMetadata(ChatServiceSid string, params *CreateServiceRoleParams) (*metadata.ResourceMetadata[ConversationsV1ServiceRole], error) {
	path := "/v1/Services/{ChatServiceSid}/Roles"
	path = strings.Replace(path, "{"+"ChatServiceSid"+"}", ChatServiceSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ConversationsV1ServiceRole](
...
// DeleteServiceRoleWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteServiceRoleWithMetadata(ChatServiceSid string, Sid string) (*metadata.ResourceMetadata[bool], error) {
	path := "/v1/Services/{ChatServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ChatServiceSid"+"}", ChatServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// FetchServiceRoleWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchServiceRoleWithMetadata(ChatServiceSid string, Sid string) (*metadata.ResourceMetadata[ConversationsV1ServiceRole], error) {
	path := "/v1/Services/{ChatServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ChatServiceSid"+"}", ChatServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// PageServiceRoleWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageServiceRoleWithMetadata(ChatServiceSid string, params *ListServiceRoleParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListServiceRoleResponse], error) {
	path := "/v1/Services/{ChatServiceSid}/Roles"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListServiceRoleResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListServiceRoleWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListServiceRoleWithMetadata(ChatServiceSid string, params *ListServiceRoleParams) (*metadata.ResourceMetadata[[]ConversationsV1ServiceRole], error) {
	response, errors := c.StreamServiceRoleWithMetadata(ChatServiceSid, params)
...
// StreamServiceRoleWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamServiceRoleWithMetadata(ChatServiceSid string, params *ListServiceRoleParams) (*metadata.ResourceMetadata[chan ConversationsV1ServiceRole], chan error) {
	if params == nil {
		params = &ListServiceRoleParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageServiceRoleWithMetadata(ChatServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamServiceRole(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ConversationsV1ServiceRole](
...
// UpdateServiceRoleWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) UpdateServiceRoleWithMetadata(ChatServiceSid string, Sid string, params *UpdateServiceRoleParams) (*metadata.ResourceMetadata[ConversationsV1ServiceRole], error) {
	path := "/v1/Services/{ChatServiceSid}/Roles/{Sid}"
	path = strings.Replace(path, "{"+"ChatServiceSid"+"}", ChatServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
