...
func (c *ApiService) PageServiceParticipantConversation(ChatServiceSid string, params *ListServiceParticipantConversationParams, pageToken, pageNumber string) (*ListServiceParticipantConversationResponse, error) {
	return c.PageServiceParticipantConversationWithCtx(context.TODO(), ChatServiceSid, params, pageToken, pageNumber)
}

// Retrieve a single page of ServiceParticipantConversation records from the API. Request is executed immediately.
func (c *ApiService) PageServiceParticipantConversationWithCtx(ctx context.Context, ChatServiceSid string, params *ListServiceParticipantConversationParams, pageToken, pageNumber string) (*ListServiceParticipantConversationResponse, error) {
...
func (c *ApiService) ListServiceParticipantConversation(ChatServiceSid string, params *ListServiceParticipantConversationParams) ([]ConversationsV1ServiceParticipantConversation, error) {
	return c.ListServiceParticipantConversationWithCtx(context.TODO(), ChatServiceSid, params)
}

// Lists ServiceParticipantConversation records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListServiceParticipantConversationWithCtx(ctx context.Context, ChatServiceSid string, params *ListServiceParticipantConversationParams) ([]ConversationsV1ServiceParticipantConversation, error) {
	response, errors := c.StreamServiceParticipantConversationWithCtx(ctx, ChatServiceSid, params)
...
func (c *ApiService) StreamServiceParticipantConversation(ChatServiceSid string, params *ListServiceParticipantConversationParams) (chan ConversationsV1ServiceParticipantConversation, chan error) {
	return c.StreamServiceParticipantConversationWithCtx(context.TODO(), ChatServiceSid, params)
}

// Streams ServiceParticipantConversation records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamServiceParticipantConversationWithCtx(ctx context.Context, ChatServiceSid string, params *ListServiceParticipantConversationParams) (chan ConversationsV1ServiceParticipantConversation, chan error) {
	if params == nil {
	...
	response, err := c.PageServiceParticipantConversationWithCtx(ctx, ChatServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamServiceParticipantConversation(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamServiceParticipantConversation(ctx context.Context, response *ListServiceParticipantConversationResponse, params *ListServiceParticipantConversationParams, recordChannel chan ConversationsV1ServiceParticipantConversation, errorChannel chan error) {
	curRecord := 1
...
func (c *ApiService) getNextListServiceParticipantConversationResponse(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
