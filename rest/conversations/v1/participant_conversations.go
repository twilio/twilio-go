...
// PageParticipantConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageParticipantConversationWithMetadata(params *ListParticipantConversationParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListParticipantConversationResponse], error) {
	path := "/v1/ParticipantConversations"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListParticipantConversationResponse](
		*ps,             // The page object
...
// ListParticipantConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListParticipantConversationWithMetadata(params *ListParticipantConversationParams) (*metadata.ResourceMetadata[[]ConversationsV1ParticipantConversation], error) {
	response, errors := c.StreamParticipantConversationWithMetadata(params)
	...
	metadataWrapper := metadata.NewResourceMetadata[[]ConversationsV1ParticipantConversation](
		records,
...
// StreamParticipantConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamParticipantConversationWithMetadata(params *ListParticipantConversationParams) (*metadata.ResourceMetadata[chan ConversationsV1ParticipantConversation], chan error) {
	if params == nil {
		params = &ListParticipantConversationParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageParticipantConversationWithMetadata(params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamParticipantConversation(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ConversationsV1ParticipantConversation](
