...
func (c *ApiService) ConversationScopedWebhookPage(ConversationSid string, params *ListConversationScopedWebhookParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Conversations/{ConversationSid}/Webhooks"
	path = strings.Replace(path, "{"+"ConversationSid"+"}", ConversationSid, -1)
...
func (c *ApiService) ConversationScopedWebhookStream(ConversationSid string, params *ListConversationScopedWebhookParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ConversationScopedWebhookPage(ConversationSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) ConversationScopedWebhookList(ConversationSid string, params *ListConversationScopedWebhookParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ConversationScopedWebhookPage(ConversationSid, params, "", "", fmt.Sprint(limits.PageSize))
