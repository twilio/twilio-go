...
func (c *ApiService) ServiceConversationPage(ChatServiceSid string, params *ListServiceConversationParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/v1/Services/{ChatServiceSid}/Conversations"
	path = strings.Replace(path, "{"+"ChatServiceSid"+"}", ChatServiceSid, -1)
...
func (c *ApiService) ServiceConversationStream(ChatServiceSid string, params *ListServiceConversationParams, limit int) (chan map[string]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.ServiceConversationPage(ChatServiceSid, params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) ServiceConversationList(ChatServiceSid string, params *ListServiceConversationParams, limit int) ([]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.ServiceConversationPage(ChatServiceSid, params, "", "")
	if err != nil {
		return nil, err
