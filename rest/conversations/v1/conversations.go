...
func (c *ApiService) ConversationsPage(params *ListConversationParams, pageToken string, pageNumber string) (*ListConversationResponse, error) {
	path := "/v1/Conversations"
...
//Lists Conversations records from the API as a list. Unlike stream, this operation is eager and will loads 'limit' records into memory before returning.
func (c *ApiService) ConversationsList(params *ListConversationParams, limit int) ([]ListConversationResponse, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListConversation(params)
	if err != nil {
		return nil, err
	}
	...
	ret := make([]ListConversationResponse, len(resp))
...
func (c *ApiService) ConversationsStream(params *ListConversationParams, limit int) (chan interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListConversation(params)
	if err != nil {
		return nil, err
