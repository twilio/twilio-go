...
func (c *ApiService) ListConversation(params *ListConversationParams, limit *int) ([]*ListConversationResponse, error) {
	...
	curRecord := 0
	var records []*ListConversationResponse

	for response != nil {
		records = append(records, response)

		var record interface{}
		if record, err = client.GetNext(response, &curRecord, limit, c.getNextListConversationResponse); record == nil || err != nil {
			return records, err
		}
...
func (c *ApiService) StreamConversation(params *ListConversationParams, limit *int) (chan *ListConversationResponse, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
	...
	channel := make(chan *ListConversationResponse, 1)
