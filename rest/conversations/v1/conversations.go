...
func (c *ApiService) ConversationPage(params *ListConversationParams, pageToken string, pageNumber string) (*client.Page, error) {
	path := "/v1/Conversations"
...
func (c *ApiService) ConversationStream(params *ListConversationParams, limit int) (chan map[string]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.ConversationPage(params, "", "")
	if err != nil {
		return nil, err
	}
...
func (c *ApiService) ConversationList(params *ListConversationParams, limit int) ([]interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	page, err := c.ConversationPage(params, "", "")
	if err != nil {
		return nil, err
