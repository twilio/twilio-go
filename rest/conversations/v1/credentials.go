...
// Add a new push notification credential to your account
func (c *ApiService) CreateCredentialWithCtx(ctx context.Context, params *CreateCredentialParams) (*ConversationsV1Credential, error) {
	path := "/v1/Credentials"
...
// Fetch a push notification credential from your account
func (c *ApiService) FetchCredentialWithCtx(ctx context.Context, Sid string) (*ConversationsV1Credential, error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
// Lists Credential records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListCredentialWithCtx(ctx context.Context, params *ListCredentialParams) ([]ConversationsV1Credential, error) {
...
// Streams Credential records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamCredentialWithCtx(ctx context.Context, params *ListCredentialParams) (chan ConversationsV1Credential, chan error) {
	if params == nil {
...
func (c *ApiService) streamCredential(ctx context.Context, response *ListCredentialResponse, params *ListCredentialParams, recordChannel chan ConversationsV1Credential, errorChannel chan error) {
	curRecord := 1
...
// Update an existing push notification credential on your account
func (c *ApiService) UpdateCredentialWithCtx(ctx context.Context, Sid string, params *UpdateCredentialParams) (*ConversationsV1Credential, error) {
	path := "/v1/Credentials/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
