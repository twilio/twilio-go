...
// DeleteServiceUserConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) DeleteServiceUserConversationWithMetadata(ChatServiceSid string, UserSid string, ConversationSid string) (*metadata.ResourceMetadata[bool], error) {
	path := "/v1/Services/{ChatServiceSid}/Users/{UserSid}/Conversations/{ConversationSid}"
	path = strings.Replace(path, "{"+"ChatServiceSid"+"}", ChatServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"ConversationSid"+"}", ConversationSid, -1)
...
// FetchServiceUserConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) FetchServiceUserConversationWithMetadata(ChatServiceSid string, UserSid string, ConversationSid string) (*metadata.ResourceMetadata[ConversationsV1ServiceUserConversation], error) {
	path := "/v1/Services/{ChatServiceSid}/Users/{UserSid}/Conversations/{ConversationSid}"
	path = strings.Replace(path, "{"+"ChatServiceSid"+"}", ChatServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"ConversationSid"+"}", ConversationSid, -1)
	...
	metadataWrapper := metadata.NewResourceMetadata[ConversationsV1ServiceUserConversation](
...
// PageServiceUserConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) PageServiceUserConversationWithMetadata(ChatServiceSid string, UserSid string, params *ListServiceUserConversationParams, pageToken, pageNumber string) (*metadata.ResourceMetadata[ListServiceUserConversationResponse], error) {
	path := "/v1/Services/{ChatServiceSid}/Users/{UserSid}/Conversations"
	...
	metadataWrapper := metadata.NewResourceMetadata[ListServiceUserConversationResponse](
		*ps,             // The page object
		resp.StatusCode, // HTTP status code
		resp.Header,     // HTTP headers
	)
...
// ListServiceUserConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) ListServiceUserConversationWithMetadata(ChatServiceSid string, UserSid string, params *ListServiceUserConversationParams) (*metadata.ResourceMetadata[[]ConversationsV1ServiceUserConversation], error) {
	response, errors := c.StreamServiceUserConversationWithMetadata(ChatServiceSid, UserSid, params)
...
// StreamServiceUserConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) StreamServiceUserConversationWithMetadata(ChatServiceSid string, UserSid string, params *ListServiceUserConversationParams) (*metadata.ResourceMetadata[chan ConversationsV1ServiceUserConversation], chan error) {
	if params == nil {
		params = &ListServiceUserConversationParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))
	...
	response, err := c.PageServiceUserConversationWithMetadata(ChatServiceSid, UserSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
		...
		resource := response.GetResource()
		go c.streamServiceUserConversation(&resource, params, recordChannel, errorChannel)
	}

	metadataWrapper := metadata.NewResourceMetadata[chan ConversationsV1ServiceUserConversation](
...
// UpdateServiceUserConversationWithMetadata returns response with metadata like status code and response headers
func (c *ApiService) UpdateServiceUserConversationWithMetadata(ChatServiceSid string, UserSid string, ConversationSid string, params *UpdateServiceUserConversationParams) (*metadata.ResourceMetadata[ConversationsV1ServiceUserConversation], error) {
	path := "/v1/Services/{ChatServiceSid}/Users/{UserSid}/Conversations/{ConversationSid}"
	path = strings.Replace(path, "{"+"ChatServiceSid"+"}", ChatServiceSid, -1)
	path = strings.Replace(path, "{"+"UserSid"+"}", UserSid, -1)
	path = strings.Replace(path, "{"+"ConversationSid"+"}", ConversationSid, -1)
