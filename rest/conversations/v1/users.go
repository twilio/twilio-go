...
func (c *ApiService) ListUser(params *ListUserParams, limit *int) ([]*ListUserResponse, error) {
...
func (c *ApiService) StreamUser(params *ListUserParams, limit *int) (chan *ListUserResponse, error) {
	params.SetPageSize(client.ReadLimits(params.PageSize, limit))
