...
func (c *ApiService) UsersPage(params *ListUserParams, pageToken string, pageNumber string) (*ListUserResponse, error) {
	path := "/v1/Users"
...
//Lists Users records from the API as a list. Unlike stream, this operation is eager and will loads 'limit' records into memory before returning.
func (c *ApiService) UsersList(params *ListUserParams, limit int) ([]ListUserResponse, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListUser(params)
	if err != nil {
		return nil, err
	}
...
//Streams Users records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) UsersStream(params *ListUserParams, limit int) (chan interface{}, error) {
	params.SetPageSize(c.requestHandler.ReadLimits(params.PageSize, limit))
	response, err := c.ListUser(params)
	if err != nil {
		return nil, err
