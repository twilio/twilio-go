...
func (c *ApiService) UserPage(params *ListUserParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Users"
...
func (c *ApiService) UserStream(params *ListUserParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.UserPage(params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) UserList(params *ListUserParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.UserPage(params, "", "", fmt.Sprint(limits.PageSize))
