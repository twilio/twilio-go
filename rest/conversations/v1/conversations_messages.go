...
func (c *ApiService) ConversationMessagePage(ConversationSid string, params *ListConversationMessageParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Conversations/{ConversationSid}/Messages"
	path = strings.Replace(path, "{"+"ConversationSid"+"}", ConversationSid, -1)
...
func (c *ApiService) ConversationMessageStream(ConversationSid string, params *ListConversationMessageParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ConversationMessagePage(ConversationSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) ConversationMessageList(ConversationSid string, params *ListConversationMessageParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.ConversationMessagePage(ConversationSid, params, "", "", fmt.Sprint(limits.PageSize))
