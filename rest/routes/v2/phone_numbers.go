...
func (c *ApiService) FetchPhoneNumber(PhoneNumber string) (*RoutesV2PhoneNumber, error) {
	return c.FetchPhoneNumberWithContext(context.TODO(), PhoneNumber)
}
func (c *ApiService) FetchPhoneNumberWithContext(ctx context.Context, PhoneNumber string) (*RoutesV2PhoneNumber, error) {
...
func (c *ApiService) UpdatePhoneNumber(PhoneNumber string, params *UpdatePhoneNumberParams) (*RoutesV2PhoneNumber, error) {
	return c.UpdatePhoneNumberWithContext(context.TODO(), PhoneNumber, params)
}
func (c *ApiService) UpdatePhoneNumberWithContext(ctx context.Context, PhoneNumber string, params *UpdatePhoneNumberParams) (*RoutesV2PhoneNumber, error) {
	path := "/v2/PhoneNumbers/{PhoneNumber}"
	path = strings.Replace(path, "{"+"PhoneNumber"+"}", PhoneNumber, -1)
