...
func (c *ApiService) FaxMediaPage(FaxSid string, params *ListFaxMediaParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Faxes/{FaxSid}/Media"
	path = strings.Replace(path, "{"+"FaxSid"+"}", FaxSid, -1)
...
func (c *ApiService) FaxMediaStream(FaxSid string, params *ListFaxMediaParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.FaxMediaPage(FaxSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) FaxMediaList(FaxSid string, params *ListFaxMediaParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.FaxMediaPage(FaxSid, params, "", "", fmt.Sprint(limits.PageSize))
