...
func (c *ApiService) EnvironmentPage(ServiceSid string, params *ListEnvironmentParams, pageToken string, pageNumber string, pageSize string) *client.Page {
	path := "/v1/Services/{ServiceSid}/Environments"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
...
func (c *ApiService) EnvironmentStream(ServiceSid string, params *ListEnvironmentParams, meta client.PaginationData) chan map[string]interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EnvironmentPage(ServiceSid, params, "", "", fmt.Sprint(limits.PageSize))
...
func (c *ApiService) EnvironmentList(ServiceSid string, params *ListEnvironmentParams, meta client.PaginationData) []interface{} {
	limits := c.requestHandler.ReadLimits(meta)
	page := c.EnvironmentPage(ServiceSid, params, "", "", fmt.Sprint(limits.PageSize))
