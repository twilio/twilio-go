...
func (c *ApiService) CreateEnvironment(ServiceSid string, params *CreateEnvironmentParams) (*ServerlessV1Environment, error) {
	return c.CreateEnvironmentWithCtx(context.TODO(), ServiceSid, params)
}

// Create a new environment.
func (c *ApiService) CreateEnvironmentWithCtx(ctx context.Context, ServiceSid string, params *CreateEnvironmentParams) (*ServerlessV1Environment, error) {
...
func (c *ApiService) DeleteEnvironment(ServiceSid string, Sid string) error {
	return c.DeleteEnvironmentWithCtx(context.TODO(), ServiceSid, Sid)
}

// Delete a specific environment.
func (c *ApiService) DeleteEnvironmentWithCtx(ctx context.Context, ServiceSid string, Sid string) error {
...
func (c *ApiService) FetchEnvironment(ServiceSid string, Sid string) (*ServerlessV1Environment, error) {
	return c.FetchEnvironmentWithCtx(context.TODO(), ServiceSid, Sid)
}

// Retrieve a specific environment.
func (c *ApiService) FetchEnvironmentWithCtx(ctx context.Context, ServiceSid string, Sid string) (*ServerlessV1Environment, error) {
	path := "/v1/Services/{ServiceSid}/Environments/{Sid}"
	path = strings.Replace(path, "{"+"ServiceSid"+"}", ServiceSid, -1)
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) PageEnvironment(ServiceSid string, params *ListEnvironmentParams, pageToken, pageNumber string) (*ListEnvironmentResponse, error) {
	return c.PageEnvironmentWithCtx(context.TODO(), ServiceSid, params, pageToken, pageNumber)
}

// Retrieve a single page of Environment records from the API. Request is executed immediately.
func (c *ApiService) PageEnvironmentWithCtx(ctx context.Context, ServiceSid string, params *ListEnvironmentParams, pageToken, pageNumber string) (*ListEnvironmentResponse, error) {
	path := "/v1/Services/{ServiceSid}/Environments"
...
func (c *ApiService) ListEnvironment(ServiceSid string, params *ListEnvironmentParams) ([]ServerlessV1Environment, error) {
	return c.ListEnvironmentWithCtx(context.TODO(), ServiceSid, params)
}

// Lists Environment records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListEnvironmentWithCtx(ctx context.Context, ServiceSid string, params *ListEnvironmentParams) ([]ServerlessV1Environment, error) {
	response, errors := c.StreamEnvironmentWithCtx(ctx, ServiceSid, params)
...
func (c *ApiService) StreamEnvironment(ServiceSid string, params *ListEnvironmentParams) (chan ServerlessV1Environment, chan error) {
	return c.StreamEnvironmentWithCtx(context.TODO(), ServiceSid, params)
}

// Streams Environment records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamEnvironmentWithCtx(ctx context.Context, ServiceSid string, params *ListEnvironmentParams) (chan ServerlessV1Environment, chan error) {
	if params == nil {
	...
	response, err := c.PageEnvironmentWithCtx(ctx, ServiceSid, params, "", "")
	if err != nil {
		errorChannel <- err
		close(recordChannel)
		close(errorChannel)
	} else {
		go c.streamEnvironment(ctx, response, params, recordChannel, errorChannel)
	}

	return recordChannel, errorChannel
}

func (c *ApiService) streamEnvironment(ctx context.Context, response *ListEnvironmentResponse, params *ListEnvironmentParams, recordChannel chan ServerlessV1Environment, errorChannel chan error) {
	curRecord := 1
	...
	for response != nil {
		...
		record, err := client.GetNextWithCtx(ctx, c.baseURL, response, c.getNextListEnvironmentResponse)
		if err != nil {
			errorChannel <- err
			break
		} else if record == nil {
...
func (c *ApiService) getNextListEnvironmentResponse(ctx context.Context, nextPageUrl string) (interface{}, error) {
	if nextPageUrl == "" {
		return nil, nil
	}
