...
// AiV1TranscriptSensitive struct for AiV1TranscriptSensitive
type AiV1TranscriptSensitive struct {
	...
	// The direction of this Transcript's call. One of `inbound`, `outbound-api`, `outbound-dial`, `trunking-originating`, `trunking-terminating` or `unknown`.
...
func (response *AiV1TranscriptSensitive) UnmarshalJSON(bytes []byte) (err error) {
	raw := struct {
	...
	*response = AiV1TranscriptSensitive{
