...
type CreateServiceParams struct {
	...
	WordAlternates *bool `json:"WordAlternates,omitempty"`
...
func (params *CreateServiceParams) SetEnvironment(Environment string) *CreateServiceParams {
...
func (params *CreateServiceParams) SetLanguageLocale(LanguageLocale string) *CreateServiceParams {
	params.LanguageLocale = &LanguageLocale
	return params
}
func (params *CreateServiceParams) SetWordAlternates(WordAlternates bool) *CreateServiceParams {
	params.WordAlternates = &WordAlternates
	return params
}
...
func (c *ApiService) CreateService(params *CreateServiceParams) (*AiV1Service, error) {
	path := "/v1/Services"
	...
	if params != nil && params.Environment != nil {
		data.Set("Environment", *params.Environment)
	}
	...
	if params != nil && params.WordAlternates != nil {
		data.Set("WordAlternates", fmt.Sprint(*params.WordAlternates))
	}
...
func (c *ApiService) FetchService(Sid string) (*AiV1Service, error) {
	path := "/v1/Services/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
...
func (c *ApiService) ListService(params *ListServiceParams) ([]AiV1Service, error) {
	response, errors := c.StreamService(params)

	records := make([]AiV1Service, 0)
...
func (c *ApiService) StreamService(params *ListServiceParams) (chan AiV1Service, chan error) {
	if params == nil {
		params = &ListServiceParams{}
	}
	params.SetPageSize(client.ReadLimits(params.PageSize, params.Limit))

	recordChannel := make(chan AiV1Service, 1)
...
func (c *ApiService) streamService(response *ListServiceResponse, params *ListServiceParams, recordChannel chan AiV1Service, errorChannel chan error) {
	curRecord := 1
...
type UpdateServiceParams struct {
	...
	DefaultCustomModelSid *string `json:"DefaultCustomModelSid,omitempty"`
	// The environment where the audio is coming from. Values can be 'telephony', 'meeting_room', or 'media_broadcast'.
	Environment *string `json:"Environment,omitempty"`
	// A human readable description of this resource, up to 64 characters.
	FriendlyName *string `json:"FriendlyName,omitempty"`
...
func (params *UpdateServiceParams) SetDefaultCustomModelSid(DefaultCustomModelSid string) *UpdateServiceParams {
	params.DefaultCustomModelSid = &DefaultCustomModelSid
	return params
}
func (params *UpdateServiceParams) SetEnvironment(Environment string) *UpdateServiceParams {
	params.Environment = &Environment
	return params
}
...
func (params *UpdateServiceParams) SetLanguageLocale(LanguageLocale string) *UpdateServiceParams {
	params.LanguageLocale = &LanguageLocale
	return params
}
...
func (params *UpdateServiceParams) SetWordAlternates(WordAlternates bool) *UpdateServiceParams {
	params.WordAlternates = &WordAlternates
	return params
}
...
func (c *ApiService) UpdateService(Sid string, params *UpdateServiceParams) (*AiV1Service, error) {
	path := "/v1/Services/{Sid}"
	path = strings.Replace(path, "{"+"Sid"+"}", Sid, -1)
	...
	if params != nil && params.DefaultCustomModelSid != nil {
		data.Set("DefaultCustomModelSid", *params.DefaultCustomModelSid)
	}
	if params != nil && params.Environment != nil {
		data.Set("Environment", *params.Environment)
	}
