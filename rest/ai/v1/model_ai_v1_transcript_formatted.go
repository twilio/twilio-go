...
// AiV1TranscriptFormatted struct for AiV1TranscriptFormatted
type AiV1TranscriptFormatted struct {
...
func (response *AiV1TranscriptFormatted) UnmarshalJSON(bytes []byte) (err error) {
	raw := struct {
	...
	*response = AiV1TranscriptFormatted{
