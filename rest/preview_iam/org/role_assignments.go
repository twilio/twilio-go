...
func (c *ApiService) DeleteRoleAssignment(OrganizationSid string, RoleAssignmentSid string) error {
	path := "/Organizations/{OrganizationSid}/RoleAssignments/{RoleAssignmentSid}"
	path = strings.Replace(path, "{"+"OrganizationSid"+"}", OrganizationSid, -1)
	path = strings.Replace(path, "{"+"RoleAssignmentSid"+"}", RoleAssignmentSid, -1)
