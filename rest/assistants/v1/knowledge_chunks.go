...
// Lists KnowledgeChunks records from the API as a list. Unlike stream, this operation is eager and loads 'limit' records into memory before returning.
func (c *ApiService) ListKnowledgeChunksWithContext(ctx context.Context, Id string, params *ListKnowledgeChunksParams) ([]AssistantsV1KnowledgeChunk, error) {
...
// Streams KnowledgeChunks records from the API as a channel stream. This operation lazily loads records as efficiently as possible until the limit is reached.
func (c *ApiService) StreamKnowledgeChunksWithContext(ctx context.Context, Id string, params *ListKnowledgeChunksParams) (chan AssistantsV1KnowledgeChunk, chan error) {
	if params == nil {
...
func (c *ApiService) streamKnowledgeChunksWithContext(ctx context.Context, response *ListKnowledgeChunksResponse, params *ListKnowledgeChunksParams, recordChannel chan AssistantsV1KnowledgeChunk, errorChannel chan error) {
	curRecord := 1
