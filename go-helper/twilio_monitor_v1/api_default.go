...
*/
func (c *DefaultApiService) ListAlert(params *ListAlertParams) (*InlineResponse200, error) {
    path := "/v1/Alerts"
...
*/
func (c *DefaultApiService) ListEvent(params *ListEventParams) (*InlineResponse2001, error) {
    path := "/v1/Events"
