...
*/
func (c *DefaultApiService) ListInteraction(serviceSid string, sessionSid string, params *ListInteractionParams) (*InlineResponse2003, error) {
...
*/
func (c *DefaultApiService) ListMessageInteraction(serviceSid string, sessionSid string, participantSid string, params *ListMessageInteractionParams) (*InlineResponse2005, error) {
    path := "/v1/Services/{ServiceSid}/Sessions/{SessionSid}/Participants/{ParticipantSid}/MessageInteractions"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"SessionSid"+"}", sessionSid, -1)
    path = strings.Replace(path, "{"+"ParticipantSid"+"}", participantSid, -1)
...
*/
func (c *DefaultApiService) ListParticipant(serviceSid string, sessionSid string, params *ListParticipantParams) (*InlineResponse2004, error) {
    path := "/v1/Services/{ServiceSid}/Sessions/{SessionSid}/Participants"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"SessionSid"+"}", sessionSid, -1)
...
*/
func (c *DefaultApiService) ListPhoneNumber(serviceSid string, params *ListPhoneNumberParams) (*InlineResponse2001, error) {
    path := "/v1/Services/{ServiceSid}/PhoneNumbers"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListSession(serviceSid string, params *ListSessionParams) (*InlineResponse2002, error) {
    path := "/v1/Services/{ServiceSid}/Sessions"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListShortCode(serviceSid string, params *ListShortCodeParams) (*InlineResponse2006, error) {
    path := "/v1/Services/{ServiceSid}/ShortCodes"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
