...
*/
func (c *DefaultApiService) ListCredentialAws(params *ListCredentialAwsParams) (*InlineResponse200, error) {
    path := "/v1/Credentials/AWS"
...
*/
func (c *DefaultApiService) ListCredentialPublicKey(params *ListCredentialPublicKeyParams) (*InlineResponse2001, error) {
    path := "/v1/Credentials/PublicKeys"
