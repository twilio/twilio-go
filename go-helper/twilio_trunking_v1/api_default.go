...
*/
func (c *DefaultApiService) ListCredentialList(trunkSid string, params *ListCredentialListParams) (*InlineResponse2001, error) {
    path := "/v1/Trunks/{TrunkSid}/CredentialLists"
    path = strings.Replace(path, "{"+"TrunkSid"+"}", trunkSid, -1)
...
*/
func (c *DefaultApiService) ListIpAccessControlList(trunkSid string, params *ListIpAccessControlListParams) (*InlineResponse2002, error) {
    path := "/v1/Trunks/{TrunkSid}/IpAccessControlLists"
    path = strings.Replace(path, "{"+"TrunkSid"+"}", trunkSid, -1)
...
*/
func (c *DefaultApiService) ListOriginationUrl(trunkSid string, params *ListOriginationUrlParams) (*InlineResponse2003, error) {
    path := "/v1/Trunks/{TrunkSid}/OriginationUrls"
    path = strings.Replace(path, "{"+"TrunkSid"+"}", trunkSid, -1)
...
*/
func (c *DefaultApiService) ListPhoneNumber(trunkSid string, params *ListPhoneNumberParams) (*InlineResponse2004, error) {
    path := "/v1/Trunks/{TrunkSid}/PhoneNumbers"
    path = strings.Replace(path, "{"+"TrunkSid"+"}", trunkSid, -1)
...
*/
func (c *DefaultApiService) ListTrunk(params *ListTrunkParams) (*InlineResponse200, error) {
    path := "/v1/Trunks"
