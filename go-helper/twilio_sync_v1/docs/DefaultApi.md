...
> InlineResponse2001 ListDocument(ctx, serviceSid, optional)
...
> InlineResponse2002 ListDocumentPermission(ctx, serviceSid, documentSid, optional)
...
> InlineResponse2003 ListSyncList(ctx, serviceSid, optional)
...
> InlineResponse2004 ListSyncListItem(ctx, serviceSid, listSid, optional)
...
> InlineResponse2005 ListSyncListPermission(ctx, serviceSid, listSid, optional)
...
> InlineResponse2006 ListSyncMap(ctx, serviceSid, optional)
...
> InlineResponse2007 ListSyncMapItem(ctx, serviceSid, mapSid, optional)
...
> InlineResponse2008 ListSyncMapPermission(ctx, serviceSid, mapSid, optional)
...
> InlineResponse2009 ListSyncStream(ctx, serviceSid, optional)
