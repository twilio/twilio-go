...
*/
func (c *DefaultApiService) ListDocument(serviceSid string, params *ListDocumentParams) (*InlineResponse2001, error) {
    path := "/v1/Services/{ServiceSid}/Documents"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListDocumentPermission(serviceSid string, documentSid string, params *ListDocumentPermissionParams) (*InlineResponse2002, error) {
...
*/
func (c *DefaultApiService) ListSyncList(serviceSid string, params *ListSyncListParams) (*InlineResponse2003, error) {
    path := "/v1/Services/{ServiceSid}/Lists"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListSyncListItem(serviceSid string, listSid string, params *ListSyncListItemParams) (*InlineResponse2004, error) {
    path := "/v1/Services/{ServiceSid}/Lists/{ListSid}/Items"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"ListSid"+"}", listSid, -1)
...
*/
func (c *DefaultApiService) ListSyncListPermission(serviceSid string, listSid string, params *ListSyncListPermissionParams) (*InlineResponse2005, error) {
...
*/
func (c *DefaultApiService) ListSyncMap(serviceSid string, params *ListSyncMapParams) (*InlineResponse2006, error) {
    path := "/v1/Services/{ServiceSid}/Maps"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListSyncMapItem(serviceSid string, mapSid string, params *ListSyncMapItemParams) (*InlineResponse2007, error) {
    path := "/v1/Services/{ServiceSid}/Maps/{MapSid}/Items"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"MapSid"+"}", mapSid, -1)
...
*/
func (c *DefaultApiService) ListSyncMapPermission(serviceSid string, mapSid string, params *ListSyncMapPermissionParams) (*InlineResponse2008, error) {
...
*/
func (c *DefaultApiService) ListSyncStream(serviceSid string, params *ListSyncStreamParams) (*InlineResponse2009, error) {
    path := "/v1/Services/{ServiceSid}/Streams"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
