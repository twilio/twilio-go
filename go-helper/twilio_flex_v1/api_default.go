...
*/
func (c *DefaultApiService) ListChannel(params *ListChannelParams) (*InlineResponse200, error) {
    path := "/v1/Channels"
...
*/
func (c *DefaultApiService) ListFlexFlow(params *ListFlexFlowParams) (*InlineResponse2001, error) {
    path := "/v1/FlexFlows"
...
*/
func (c *DefaultApiService) ListWebChannel(params *ListWebChannelParams) (*InlineResponse2002, error) {
    path := "/v1/WebChannels"
