...
*/
func (c *DefaultApiService) ListComposition(params *ListCompositionParams) (*InlineResponse2001, error) {
    path := "/v1/Compositions"
...
*/
func (c *DefaultApiService) ListCompositionHook(params *ListCompositionHookParams) (*InlineResponse200, error) {
    path := "/v1/CompositionHooks"
...
*/
func (c *DefaultApiService) ListRecording(params *ListRecordingParams) (*InlineResponse2002, error) {
    path := "/v1/Recordings"
...
*/
func (c *DefaultApiService) ListRoom(params *ListRoomParams) (*InlineResponse2003, error) {
    path := "/v1/Rooms"
...
*/
func (c *DefaultApiService) ListRoomParticipant(roomSid string, params *ListRoomParticipantParams) (*InlineResponse2004, error) {
...
*/
func (c *DefaultApiService) ListRoomParticipantPublishedTrack(roomSid string, participantSid string, params *ListRoomParticipantPublishedTrackParams) (*InlineResponse2005, error) {
...
*/
func (c *DefaultApiService) ListRoomParticipantSubscribedTrack(roomSid string, participantSid string, params *ListRoomParticipantSubscribedTrackParams) (*InlineResponse2006, error) {
...
*/
func (c *DefaultApiService) ListRoomRecording(roomSid string, params *ListRoomRecordingParams) (*InlineResponse2007, error) {
