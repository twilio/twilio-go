...
*/
func (c *DefaultApiService) ListAccountUsageRecord(params *ListAccountUsageRecordParams) (*InlineResponse2005, error) {
...
*/
func (c *DefaultApiService) ListCommand(params *ListCommandParams) (*InlineResponse200, error) {
    path := "/v1/Commands"
...
*/
func (c *DefaultApiService) ListDataSession(simSid string, params *ListDataSessionParams) (*InlineResponse2003, error) {
...
*/
func (c *DefaultApiService) ListRatePlan(params *ListRatePlanParams) (*InlineResponse2001, error) {
    path := "/v1/RatePlans"
...
*/
func (c *DefaultApiService) ListSim(params *ListSimParams) (*InlineResponse2002, error) {
    path := "/v1/Sims"
...
*/
func (c *DefaultApiService) ListUsageRecord(simSid string, params *ListUsageRecordParams) (*InlineResponse2004, error) {
