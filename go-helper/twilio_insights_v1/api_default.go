...
*/
func (c *DefaultApiService) ListEvent(callSid string, params *ListEventParams) (*InlineResponse2002, error) {
...
*/
func (c *DefaultApiService) ListMetric(callSid string, params *ListMetricParams) (*InlineResponse2003, error) {
...
*/
func (c *DefaultApiService) ListVideoParticipantSummary(roomSid string, params *ListVideoParticipantSummaryParams) (*InlineResponse2001, error) {
...
*/
func (c *DefaultApiService) ListVideoRoomSummary(params *ListVideoRoomSummaryParams) (*InlineResponse200, error) {
    path := "/v1/Video/Rooms"
