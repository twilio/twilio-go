...
*/
func (c *DefaultApiService) ListEventType(params *ListEventTypeParams) (*InlineResponse2004, error) {
    path := "/v1/Types"
...
*/
func (c *DefaultApiService) ListSink(params *ListSinkParams) (*InlineResponse2001, error) {
    path := "/v1/Sinks"
...
*/
func (c *DefaultApiService) ListSubscribedEvent(subscriptionSid string, params *ListSubscribedEventParams) (*InlineResponse2003, error) {
...
*/
func (c *DefaultApiService) ListSubscription(params *ListSubscriptionParams) (*InlineResponse2002, error) {
    path := "/v1/Subscriptions"
...
*/
func (c *DefaultApiService) ListVersion(id string, params *ListVersionParams) (*InlineResponse200, error) {
