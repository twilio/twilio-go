...
*/
func (c *DefaultApiService) ListActivity(workspaceSid string, params *ListActivityParams) (*InlineResponse2001, error) {
    path := "/v1/Workspaces/{WorkspaceSid}/Activities"
    path = strings.Replace(path, "{"+"WorkspaceSid"+"}", workspaceSid, -1)
...
*/
func (c *DefaultApiService) ListEvent(workspaceSid string, params *ListEventParams) (*InlineResponse2002, error) {
...
*/
func (c *DefaultApiService) ListTask(workspaceSid string, params *ListTaskParams) (*InlineResponse2006, error) {
    path := "/v1/Workspaces/{WorkspaceSid}/Tasks"
    path = strings.Replace(path, "{"+"WorkspaceSid"+"}", workspaceSid, -1)
...
*/
func (c *DefaultApiService) ListTaskChannel(workspaceSid string, params *ListTaskChannelParams) (*InlineResponse2003, error) {
    path := "/v1/Workspaces/{WorkspaceSid}/TaskChannels"
    path = strings.Replace(path, "{"+"WorkspaceSid"+"}", workspaceSid, -1)
...
*/
func (c *DefaultApiService) ListTaskQueue(workspaceSid string, params *ListTaskQueueParams) (*InlineResponse2004, error) {
    path := "/v1/Workspaces/{WorkspaceSid}/TaskQueues"
    path = strings.Replace(path, "{"+"WorkspaceSid"+"}", workspaceSid, -1)
...
*/
func (c *DefaultApiService) ListTaskQueuesStatistics(workspaceSid string, params *ListTaskQueuesStatisticsParams) (*InlineResponse2005, error) {
...
*/
func (c *DefaultApiService) ListTaskReservation(workspaceSid string, taskSid string, params *ListTaskReservationParams) (*InlineResponse2007, error) {
...
*/
func (c *DefaultApiService) ListWorker(workspaceSid string, params *ListWorkerParams) (*InlineResponse2008, error) {
    path := "/v1/Workspaces/{WorkspaceSid}/Workers"
    path = strings.Replace(path, "{"+"WorkspaceSid"+"}", workspaceSid, -1)
...
*/
func (c *DefaultApiService) ListWorkerChannel(workspaceSid string, workerSid string, params *ListWorkerChannelParams) (*InlineResponse2009, error) {
...
*/
func (c *DefaultApiService) ListWorkerReservation(workspaceSid string, workerSid string, params *ListWorkerReservationParams) (*InlineResponse20010, error) {
...
*/
func (c *DefaultApiService) ListWorkflow(workspaceSid string, params *ListWorkflowParams) (*InlineResponse20011, error) {
    path := "/v1/Workspaces/{WorkspaceSid}/Workflows"
    path = strings.Replace(path, "{"+"WorkspaceSid"+"}", workspaceSid, -1)
...
*/
func (c *DefaultApiService) ListWorkspace(params *ListWorkspaceParams) (*InlineResponse200, error) {
    path := "/v1/Workspaces"
