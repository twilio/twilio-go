...
> InlineResponse2001 ListActivity(ctx, workspaceSid, optional)
...
> InlineResponse2002 ListEvent(ctx, workspaceSid, optional)
...
> InlineResponse2006 ListTask(ctx, workspaceSid, optional)
...
> InlineResponse2003 ListTaskChannel(ctx, workspaceSid, optional)
...
> InlineResponse2004 ListTaskQueue(ctx, workspaceSid, optional)
...
> InlineResponse2005 ListTaskQueuesStatistics(ctx, workspaceSid, optional)
...
> InlineResponse2007 ListTaskReservation(ctx, workspaceSid, taskSid, optional)
...
> InlineResponse2008 ListWorker(ctx, workspaceSid, optional)
...
> InlineResponse2009 ListWorkerChannel(ctx, workspaceSid, workerSid, optional)
...
> InlineResponse20010 ListWorkerReservation(ctx, workspaceSid, workerSid, optional)
...
> InlineResponse20011 ListWorkflow(ctx, workspaceSid, optional)
...
> InlineResponse200 ListWorkspace(ctx, optional)
