...
*/
func (c *DefaultApiService) ListByocTrunk(params *ListByocTrunkParams) (*InlineResponse200, error) {
    path := "/v1/ByocTrunks"
...
*/
func (c *DefaultApiService) ListConnectionPolicy(params *ListConnectionPolicyParams) (*InlineResponse2001, error) {
    path := "/v1/ConnectionPolicies"
...
*/
func (c *DefaultApiService) ListConnectionPolicyTarget(connectionPolicySid string, params *ListConnectionPolicyTargetParams) (*InlineResponse2002, error) {
    path := "/v1/ConnectionPolicies/{ConnectionPolicySid}/Targets"
    path = strings.Replace(path, "{"+"ConnectionPolicySid"+"}", connectionPolicySid, -1)
...
*/
func (c *DefaultApiService) ListDialingPermissionsCountry(params *ListDialingPermissionsCountryParams) (*InlineResponse2003, error) {
...
*/
func (c *DefaultApiService) ListDialingPermissionsHrsPrefixes(isoCode string, params *ListDialingPermissionsHrsPrefixesParams) (*InlineResponse2004, error) {
...
*/
func (c *DefaultApiService) ListIpRecord(params *ListIpRecordParams) (*InlineResponse2005, error) {
    path := "/v1/IpRecords"
...
*/
func (c *DefaultApiService) ListSourceIpMapping(params *ListSourceIpMappingParams) (*InlineResponse2006, error) {
    path := "/v1/SourceIpMappings"
