...
*/
func (c *DefaultApiService) ListBucket(serviceSid string, rateLimitSid string, params *ListBucketParams) (*InlineResponse2006, error) {
    path := "/v2/Services/{ServiceSid}/RateLimits/{RateLimitSid}/Buckets"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"RateLimitSid"+"}", rateLimitSid, -1)
...
*/
func (c *DefaultApiService) ListChallenge(serviceSid string, identity string, params *ListChallengeParams) (*InlineResponse2002, error) {
    path := "/v2/Services/{ServiceSid}/Entities/{Identity}/Challenges"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"Identity"+"}", identity, -1)
...
*/
func (c *DefaultApiService) ListEntity(serviceSid string, params *ListEntityParams) (*InlineResponse2001, error) {
    path := "/v2/Services/{ServiceSid}/Entities"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListFactor(serviceSid string, identity string, params *ListFactorParams) (*InlineResponse2003, error) {
    path := "/v2/Services/{ServiceSid}/Entities/{Identity}/Factors"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"Identity"+"}", identity, -1)
...
*/
func (c *DefaultApiService) ListMessagingConfiguration(serviceSid string, params *ListMessagingConfigurationParams) (*InlineResponse2004, error) {
    path := "/v2/Services/{ServiceSid}/MessagingConfigurations"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListRateLimit(serviceSid string, params *ListRateLimitParams) (*InlineResponse2005, error) {
    path := "/v2/Services/{ServiceSid}/RateLimits"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListService(params *ListServiceParams) (*InlineResponse200, error) {
    path := "/v2/Services"
...
*/
func (c *DefaultApiService) ListWebhook(serviceSid string, params *ListWebhookParams) (*InlineResponse2007, error) {
    path := "/v2/Services/{ServiceSid}/Webhooks"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
