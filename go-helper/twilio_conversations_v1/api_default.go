...
*/
func (c *DefaultApiService) ListConversation(params *ListConversationParams) (*InlineResponse200, error) {
    path := "/v1/Conversations"
...
*/
func (c *DefaultApiService) ListConversationMessage(conversationSid string, params *ListConversationMessageParams) (*InlineResponse2001, error) {
    path := "/v1/Conversations/{ConversationSid}/Messages"
    path = strings.Replace(path, "{"+"ConversationSid"+"}", conversationSid, -1)
...
*/
func (c *DefaultApiService) ListConversationMessageReceipt(conversationSid string, messageSid string, params *ListConversationMessageReceiptParams) (*InlineResponse2002, error) {
...
*/
func (c *DefaultApiService) ListConversationParticipant(conversationSid string, params *ListConversationParticipantParams) (*InlineResponse2003, error) {
    path := "/v1/Conversations/{ConversationSid}/Participants"
    path = strings.Replace(path, "{"+"ConversationSid"+"}", conversationSid, -1)
...
*/
func (c *DefaultApiService) ListConversationScopedWebhook(conversationSid string, params *ListConversationScopedWebhookParams) (*InlineResponse2004, error) {
    path := "/v1/Conversations/{ConversationSid}/Webhooks"
    path = strings.Replace(path, "{"+"ConversationSid"+"}", conversationSid, -1)
...
*/
func (c *DefaultApiService) ListCredential(params *ListCredentialParams) (*InlineResponse2005, error) {
    path := "/v1/Credentials"
...
*/
func (c *DefaultApiService) ListRole(params *ListRoleParams) (*InlineResponse2006, error) {
    path := "/v1/Roles"
...
*/
func (c *DefaultApiService) ListService(params *ListServiceParams) (*InlineResponse2007, error) {
    path := "/v1/Services"
...
*/
func (c *DefaultApiService) ListServiceBinding(chatServiceSid string, params *ListServiceBindingParams) (*InlineResponse2008, error) {
...
*/
func (c *DefaultApiService) ListServiceConversation(chatServiceSid string, params *ListServiceConversationParams) (*InlineResponse2009, error) {
    path := "/v1/Services/{ChatServiceSid}/Conversations"
    path = strings.Replace(path, "{"+"ChatServiceSid"+"}", chatServiceSid, -1)
...
*/
func (c *DefaultApiService) ListServiceConversationMessage(chatServiceSid string, conversationSid string, params *ListServiceConversationMessageParams) (*InlineResponse20010, error) {
    path := "/v1/Services/{ChatServiceSid}/Conversations/{ConversationSid}/Messages"
    path = strings.Replace(path, "{"+"ChatServiceSid"+"}", chatServiceSid, -1)
    path = strings.Replace(path, "{"+"ConversationSid"+"}", conversationSid, -1)
...
*/
func (c *DefaultApiService) ListServiceConversationMessageReceipt(chatServiceSid string, conversationSid string, messageSid string, params *ListServiceConversationMessageReceiptParams) (*InlineResponse20011, error) {
...
*/
func (c *DefaultApiService) ListServiceConversationParticipant(chatServiceSid string, conversationSid string, params *ListServiceConversationParticipantParams) (*InlineResponse20012, error) {
    path := "/v1/Services/{ChatServiceSid}/Conversations/{ConversationSid}/Participants"
    path = strings.Replace(path, "{"+"ChatServiceSid"+"}", chatServiceSid, -1)
    path = strings.Replace(path, "{"+"ConversationSid"+"}", conversationSid, -1)
...
*/
func (c *DefaultApiService) ListServiceConversationScopedWebhook(chatServiceSid string, conversationSid string, params *ListServiceConversationScopedWebhookParams) (*InlineResponse20013, error) {
    path := "/v1/Services/{ChatServiceSid}/Conversations/{ConversationSid}/Webhooks"
    path = strings.Replace(path, "{"+"ChatServiceSid"+"}", chatServiceSid, -1)
    path = strings.Replace(path, "{"+"ConversationSid"+"}", conversationSid, -1)
...
*/
func (c *DefaultApiService) ListServiceRole(chatServiceSid string, params *ListServiceRoleParams) (*InlineResponse20014, error) {
    path := "/v1/Services/{ChatServiceSid}/Roles"
    path = strings.Replace(path, "{"+"ChatServiceSid"+"}", chatServiceSid, -1)
...
*/
func (c *DefaultApiService) ListServiceUser(chatServiceSid string, params *ListServiceUserParams) (*InlineResponse20015, error) {
    path := "/v1/Services/{ChatServiceSid}/Users"
    path = strings.Replace(path, "{"+"ChatServiceSid"+"}", chatServiceSid, -1)
...
*/
func (c *DefaultApiService) ListUser(params *ListUserParams) (*InlineResponse20016, error) {
    path := "/v1/Users"
