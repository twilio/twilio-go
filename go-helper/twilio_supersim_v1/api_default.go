 ...
 * @param "CommandsUrl" (string) - The URL that will receive a webhook when a SIM in the Fleet originates a machine-to-machine SMS via Commands. Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
...
*/
func (c *DefaultApiService) ListFleet(params *ListFleetParams) (*InlineResponse2001, error) {
    path := "/v1/Fleets"
...
*/
func (c *DefaultApiService) ListNetwork(params *ListNetworkParams) (*InlineResponse2004, error) {
    path := "/v1/Networks"
...
*/
func (c *DefaultApiService) ListNetworkAccessProfile(params *ListNetworkAccessProfileParams) (*InlineResponse2002, error) {
    path := "/v1/NetworkAccessProfiles"
...
*/
func (c *DefaultApiService) ListNetworkAccessProfileNetwork(networkAccessProfileSid string, params *ListNetworkAccessProfileNetworkParams) (*InlineResponse2003, error) {
    path := "/v1/NetworkAccessProfiles/{NetworkAccessProfileSid}/Networks"
    path = strings.Replace(path, "{"+"NetworkAccessProfileSid"+"}", networkAccessProfileSid, -1)
...
*/
func (c *DefaultApiService) ListSim(params *ListSimParams) (*InlineResponse2005, error) {
    path := "/v1/Sims"
...
*/
func (c *DefaultApiService) ListUsageRecord(params *ListUsageRecordParams) (*InlineResponse2006, error) {
