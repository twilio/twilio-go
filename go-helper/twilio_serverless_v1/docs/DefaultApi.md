...
> InlineResponse2001 ListAsset(ctx, serviceSid, optional)
...
> InlineResponse2002 ListAssetVersion(ctx, serviceSid, assetSid, optional)
...
> InlineResponse2003 ListBuild(ctx, serviceSid, optional)
...
> InlineResponse2005 ListDeployment(ctx, serviceSid, environmentSid, optional)
...
> InlineResponse2004 ListEnvironment(ctx, serviceSid, optional)
...
> InlineResponse2008 ListFunction(ctx, serviceSid, optional)
...
> InlineResponse2009 ListFunctionVersion(ctx, serviceSid, functionSid, optional)
...
> InlineResponse2006 ListLog(ctx, serviceSid, environmentSid, optional)
...
> InlineResponse2007 ListVariable(ctx, serviceSid, environmentSid, optional)
