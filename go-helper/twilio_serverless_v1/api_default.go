...
*/
func (c *DefaultApiService) ListAsset(serviceSid string, params *ListAssetParams) (*InlineResponse2001, error) {
    path := "/v1/Services/{ServiceSid}/Assets"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListAssetVersion(serviceSid string, assetSid string, params *ListAssetVersionParams) (*InlineResponse2002, error) {
...
*/
func (c *DefaultApiService) ListBuild(serviceSid string, params *ListBuildParams) (*InlineResponse2003, error) {
    path := "/v1/Services/{ServiceSid}/Builds"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListDeployment(serviceSid string, environmentSid string, params *ListDeploymentParams) (*InlineResponse2005, error) {
    path := "/v1/Services/{ServiceSid}/Environments/{EnvironmentSid}/Deployments"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"EnvironmentSid"+"}", environmentSid, -1)
...
*/
func (c *DefaultApiService) ListEnvironment(serviceSid string, params *ListEnvironmentParams) (*InlineResponse2004, error) {
    path := "/v1/Services/{ServiceSid}/Environments"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListFunction(serviceSid string, params *ListFunctionParams) (*InlineResponse2008, error) {
    path := "/v1/Services/{ServiceSid}/Functions"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListFunctionVersion(serviceSid string, functionSid string, params *ListFunctionVersionParams) (*InlineResponse2009, error) {
...
*/
func (c *DefaultApiService) ListLog(serviceSid string, environmentSid string, params *ListLogParams) (*InlineResponse2006, error) {
...
*/
func (c *DefaultApiService) ListVariable(serviceSid string, environmentSid string, params *ListVariableParams) (*InlineResponse2007, error) {
    path := "/v1/Services/{ServiceSid}/Environments/{EnvironmentSid}/Variables"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"EnvironmentSid"+"}", environmentSid, -1)
