...
*/
func (c *DefaultApiService) ListAlphaSender(serviceSid string, params *ListAlphaSenderParams) (*InlineResponse2001, error) {
    path := "/v1/Services/{ServiceSid}/AlphaSenders"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListPhoneNumber(serviceSid string, params *ListPhoneNumberParams) (*InlineResponse2002, error) {
    path := "/v1/Services/{ServiceSid}/PhoneNumbers"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListShortCode(serviceSid string, params *ListShortCodeParams) (*InlineResponse2003, error) {
    path := "/v1/Services/{ServiceSid}/ShortCodes"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
