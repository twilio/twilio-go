...
*/
func (c *DefaultApiService) ListAssistant(params *ListAssistantParams) (*InlineResponse20023, error) {
    path := "/understand/Assistants"
...
*/
func (c *DefaultApiService) ListAuthorizationDocument(params *ListAuthorizationDocumentParams) (*InlineResponse2007, error) {
    path := "/HostedNumbers/AuthorizationDocuments"
...
*/
func (c *DefaultApiService) ListAvailableAddOn(params *ListAvailableAddOnParams) (*InlineResponse20019, error) {
...
*/
func (c *DefaultApiService) ListAvailableAddOnExtension(availableAddOnSid string, params *ListAvailableAddOnExtensionParams) (*InlineResponse20020, error) {
...
*/
func (c *DefaultApiService) ListCertificate(fleetSid string, params *ListCertificateParams) (*InlineResponse2003, error) {
    path := "/DeployedDevices/Fleets/{FleetSid}/Certificates"
    path = strings.Replace(path, "{"+"FleetSid"+"}", fleetSid, -1)
...
*/
func (c *DefaultApiService) ListCommand(params *ListCommandParams) (*InlineResponse20031, error) {
    path := "/wireless/Commands"
...
*/
func (c *DefaultApiService) ListDay(resourceType string, params *ListDayParams) (*InlineResponse200, error) {
...
*/
func (c *DefaultApiService) ListDependentHostedNumberOrder(signingDocumentSid string, params *ListDependentHostedNumberOrderParams) (*InlineResponse2008, error) {
...
*/
func (c *DefaultApiService) ListDeployment(fleetSid string, params *ListDeploymentParams) (*InlineResponse2004, error) {
    path := "/DeployedDevices/Fleets/{FleetSid}/Deployments"
    path = strings.Replace(path, "{"+"FleetSid"+"}", fleetSid, -1)
...
*/
func (c *DefaultApiService) ListDevice(fleetSid string, params *ListDeviceParams) (*InlineResponse2005, error) {
    path := "/DeployedDevices/Fleets/{FleetSid}/Devices"
    path = strings.Replace(path, "{"+"FleetSid"+"}", fleetSid, -1)
...
*/
func (c *DefaultApiService) ListDocument(serviceSid string, params *ListDocumentParams) (*InlineResponse20011, error) {
    path := "/Sync/Services/{ServiceSid}/Documents"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListDocumentPermission(serviceSid string, documentSid string, params *ListDocumentPermissionParams) (*InlineResponse20012, error) {
...
*/
func (c *DefaultApiService) ListExportCustomJob(resourceType string, params *ListExportCustomJobParams) (*InlineResponse2001, error) {
    path := "/BulkExports/Exports/{ResourceType}/Jobs"
    path = strings.Replace(path, "{"+"ResourceType"+"}", resourceType, -1)
...
*/
func (c *DefaultApiService) ListField(assistantSid string, taskSid string, params *ListFieldParams) (*InlineResponse20029, error) {
    path := "/understand/Assistants/{AssistantSid}/Tasks/{TaskSid}/Fields"
    path = strings.Replace(path, "{"+"AssistantSid"+"}", assistantSid, -1)
    path = strings.Replace(path, "{"+"TaskSid"+"}", taskSid, -1)
...
*/
func (c *DefaultApiService) ListFieldType(assistantSid string, params *ListFieldTypeParams) (*InlineResponse20024, error) {
    path := "/understand/Assistants/{AssistantSid}/FieldTypes"
    path = strings.Replace(path, "{"+"AssistantSid"+"}", assistantSid, -1)
...
*/
func (c *DefaultApiService) ListFieldValue(assistantSid string, fieldTypeSid string, params *ListFieldValueParams) (*InlineResponse20025, error) {
    path := "/understand/Assistants/{AssistantSid}/FieldTypes/{FieldTypeSid}/FieldValues"
    path = strings.Replace(path, "{"+"AssistantSid"+"}", assistantSid, -1)
    path = strings.Replace(path, "{"+"FieldTypeSid"+"}", fieldTypeSid, -1)
...
*/
func (c *DefaultApiService) ListFleet(params *ListFleetParams) (*InlineResponse2002, error) {
    path := "/DeployedDevices/Fleets"
...
*/
func (c *DefaultApiService) ListHostedNumberOrder(params *ListHostedNumberOrderParams) (*InlineResponse2009, error) {
    path := "/HostedNumbers/HostedNumberOrders"
...
*/
func (c *DefaultApiService) ListInstalledAddOn(params *ListInstalledAddOnParams) (*InlineResponse20021, error) {
    path := "/marketplace/InstalledAddOns"
...
*/
func (c *DefaultApiService) ListInstalledAddOnExtension(installedAddOnSid string, params *ListInstalledAddOnExtensionParams) (*InlineResponse20022, error) {
...
*/
func (c *DefaultApiService) ListKey(fleetSid string, params *ListKeyParams) (*InlineResponse2006, error) {
    path := "/DeployedDevices/Fleets/{FleetSid}/Keys"
    path = strings.Replace(path, "{"+"FleetSid"+"}", fleetSid, -1)
...
*/
func (c *DefaultApiService) ListModelBuild(assistantSid string, params *ListModelBuildParams) (*InlineResponse20026, error) {
    path := "/understand/Assistants/{AssistantSid}/ModelBuilds"
    path = strings.Replace(path, "{"+"AssistantSid"+"}", assistantSid, -1)
...
*/
func (c *DefaultApiService) ListQuery(assistantSid string, params *ListQueryParams) (*InlineResponse20027, error) {
    path := "/understand/Assistants/{AssistantSid}/Queries"
    path = strings.Replace(path, "{"+"AssistantSid"+"}", assistantSid, -1)
...
*/
func (c *DefaultApiService) ListRatePlan(params *ListRatePlanParams) (*InlineResponse20032, error) {
    path := "/wireless/RatePlans"
...
*/
func (c *DefaultApiService) ListSample(assistantSid string, taskSid string, params *ListSampleParams) (*InlineResponse20030, error) {
    path := "/understand/Assistants/{AssistantSid}/Tasks/{TaskSid}/Samples"
    path = strings.Replace(path, "{"+"AssistantSid"+"}", assistantSid, -1)
    path = strings.Replace(path, "{"+"TaskSid"+"}", taskSid, -1)
...
*/
func (c *DefaultApiService) ListService(params *ListServiceParams) (*InlineResponse20010, error) {
    path := "/Sync/Services"
...
*/
func (c *DefaultApiService) ListSim(params *ListSimParams) (*InlineResponse20033, error) {
    path := "/wireless/Sims"
...
*/
func (c *DefaultApiService) ListSyncList(serviceSid string, params *ListSyncListParams) (*InlineResponse20013, error) {
    path := "/Sync/Services/{ServiceSid}/Lists"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListSyncListItem(serviceSid string, listSid string, params *ListSyncListItemParams) (*InlineResponse20014, error) {
    path := "/Sync/Services/{ServiceSid}/Lists/{ListSid}/Items"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"ListSid"+"}", listSid, -1)
...
*/
func (c *DefaultApiService) ListSyncListPermission(serviceSid string, listSid string, params *ListSyncListPermissionParams) (*InlineResponse20015, error) {
...
*/
func (c *DefaultApiService) ListSyncMap(serviceSid string, params *ListSyncMapParams) (*InlineResponse20016, error) {
    path := "/Sync/Services/{ServiceSid}/Maps"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
...
*/
func (c *DefaultApiService) ListSyncMapItem(serviceSid string, mapSid string, params *ListSyncMapItemParams) (*InlineResponse20017, error) {
    path := "/Sync/Services/{ServiceSid}/Maps/{MapSid}/Items"
    path = strings.Replace(path, "{"+"ServiceSid"+"}", serviceSid, -1)
    path = strings.Replace(path, "{"+"MapSid"+"}", mapSid, -1)
...
*/
func (c *DefaultApiService) ListSyncMapPermission(serviceSid string, mapSid string, params *ListSyncMapPermissionParams) (*InlineResponse20018, error) {
...
*/
func (c *DefaultApiService) ListTask(assistantSid string, params *ListTaskParams) (*InlineResponse20028, error) {
    path := "/understand/Assistants/{AssistantSid}/Tasks"
    path = strings.Replace(path, "{"+"AssistantSid"+"}", assistantSid, -1)
