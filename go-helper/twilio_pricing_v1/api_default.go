...
*/
func (c *DefaultApiService) ListMessagingCountry(params *ListMessagingCountryParams) (*InlineResponse200, error) {
...
*/
func (c *DefaultApiService) ListPhoneNumberCountry(params *ListPhoneNumberCountryParams) (*InlineResponse2001, error) {
...
*/
func (c *DefaultApiService) ListVoiceCountry(params *ListVoiceCountryParams) (*InlineResponse2002, error) {
