...
*/
func (c *DefaultApiService) ListBundle(params *ListBundleParams) (*InlineResponse200, error) {
    path := "/v2/RegulatoryCompliance/Bundles"
...
*/
func (c *DefaultApiService) ListEndUser(params *ListEndUserParams) (*InlineResponse2004, error) {
    path := "/v2/RegulatoryCompliance/EndUsers"
...
*/
func (c *DefaultApiService) ListEndUserType(params *ListEndUserTypeParams) (*InlineResponse2003, error) {
...
*/
func (c *DefaultApiService) ListEvaluation(bundleSid string, params *ListEvaluationParams) (*InlineResponse2001, error) {
    path := "/v2/RegulatoryCompliance/Bundles/{BundleSid}/Evaluations"
    path = strings.Replace(path, "{"+"BundleSid"+"}", bundleSid, -1)
...
*/
func (c *DefaultApiService) ListItemAssignment(bundleSid string, params *ListItemAssignmentParams) (*InlineResponse2002, error) {
    path := "/v2/RegulatoryCompliance/Bundles/{BundleSid}/ItemAssignments"
    path = strings.Replace(path, "{"+"BundleSid"+"}", bundleSid, -1)
...
*/
func (c *DefaultApiService) ListRegulation(params *ListRegulationParams) (*InlineResponse2005, error) {
...
*/
func (c *DefaultApiService) ListSupportingDocument(params *ListSupportingDocumentParams) (*InlineResponse2007, error) {
    path := "/v2/RegulatoryCompliance/SupportingDocuments"
...
*/
func (c *DefaultApiService) ListSupportingDocumentType(params *ListSupportingDocumentTypeParams) (*InlineResponse2006, error) {
