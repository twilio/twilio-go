...
* @param optional nil or *CreateAuthorizationDocumentParams - Optional Parameters:
...
* @param FleetSid
* @param optional nil or *CreateCertificateParams - Optional Parameters:
...
* @param FleetSid
* @param optional nil or *CreateDeviceParams - Optional Parameters:
...
* @param optional nil or *CreateHostedNumberOrderParams - Optional Parameters:
...
* @param optional nil or *CreateInstalledAddOnParams - Optional Parameters:
...
* @param FleetSid
* @param optional nil or *CreateKeyParams - Optional Parameters:
...
* @param optional nil or *FetchBrandsInformationParams - Optional Parameters:
* @param "IfNoneMatch" (string) - Standard `If-None-Match` HTTP header. For more information visit: https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-None-Match.
...
* @param optional nil or *FetchCpsParams - Optional Parameters:
* @param "XXcnamSensitivePhoneNumber" (string) - Phone number used to retrieve its corresponding CPS.
...
* @param optional nil or *FetchCurrentCallParams - Optional Parameters:
* @param "XXcnamSensitivePhoneNumberFrom" (string) - The originating Phone Number, given in [E.164 format](https://www.twilio.com/docs/glossary/what-e164). This phone number should be a Twilio number, otherwise it will return an error with HTTP Status Code 400.
* @param "XXcnamSensitivePhoneNumberTo" (string) - The terminating Phone Number, given in [E.164 format](https://www.twilio.com/docs/glossary/what-e164).
...
* @param SimSid
* @param optional nil or *FetchUsageParams - Optional Parameters:
* @param "End" (string) -
* @param "Start" (string) -
...
* @param optional nil or *ListAuthorizationDocumentParams - Optional Parameters:
* @param "Email" (string) - Email that this AuthorizationDocument will be sent to for signing.
 ...
 */
func (c *DefaultApiService) ListAuthorizationDocument(params *ListAuthorizationDocumentParams) (*ListAuthorizationDocumentResponse, error) {
	path := "/HostedNumbers/AuthorizationDocuments"
...
* @param optional nil or *ListAvailableAddOnParams - Optional Parameters:
* @param "PageSize" (int32) - How many resources to return in each list page. The default is 50, and the maximum is 1000.
* @return ListAvailableAddOnResponse
 */
func (c *DefaultApiService) ListAvailableAddOn(params *ListAvailableAddOnParams) (*ListAvailableAddOnResponse, error) {
...
* @param optional nil or *ListAvailableAddOnExtensionParams - Optional Parameters:
* @param "PageSize" (int32) - How many resources to return in each list page. The default is 50, and the maximum is 1000.
* @return ListAvailableAddOnExtensionResponse
 */
func (c *DefaultApiService) ListAvailableAddOnExtension(AvailableAddOnSid string, params *ListAvailableAddOnExtensionParams) (*ListAvailableAddOnExtensionResponse, error) {
...
* @param FleetSid
* @param optional nil or *ListCertificateParams - Optional Parameters:
 ...
 */
func (c *DefaultApiService) ListCertificate(FleetSid string, params *ListCertificateParams) (*ListCertificateResponse, error) {
	path := "/DeployedDevices/Fleets/{FleetSid}/Certificates"
	path = strings.Replace(path, "{"+"FleetSid"+"}", FleetSid, -1)
...
* @param optional nil or *ListDependentHostedNumberOrderParams - Optional Parameters:
* @param "Status" (string) - Status of an instance resource. It can hold one of the values: 1. opened 2. signing, 3. signed LOA, 4. canceled, 5. failed. See the section entitled [Status Values](https://www.twilio.com/docs/api/phone-numbers/hosted-number-authorization-documents#status-values) for more information on each of these statuses.
 ...
 */
func (c *DefaultApiService) ListDependentHostedNumberOrder(SigningDocumentSid string, params *ListDependentHostedNumberOrderParams) (*ListDependentHostedNumberOrderResponse, error) {
 ...
 */
func (c *DefaultApiService) ListDeployment(FleetSid string, params *ListDeploymentParams) (*ListDeploymentResponse, error) {
	path := "/DeployedDevices/Fleets/{FleetSid}/Deployments"
	path = strings.Replace(path, "{"+"FleetSid"+"}", FleetSid, -1)
...
* @param FleetSid
* @param optional nil or *ListDeviceParams - Optional Parameters:
 ...
 */
func (c *DefaultApiService) ListDevice(FleetSid string, params *ListDeviceParams) (*ListDeviceResponse, error) {
	path := "/DeployedDevices/Fleets/{FleetSid}/Devices"
	path = strings.Replace(path, "{"+"FleetSid"+"}", FleetSid, -1)
...
* @param optional nil or *ListHostedNumberOrderParams - Optional Parameters:
 ...
 */
func (c *DefaultApiService) ListHostedNumberOrder(params *ListHostedNumberOrderParams) (*ListHostedNumberOrderResponse, error) {
	path := "/HostedNumbers/HostedNumberOrders"
...
* @param optional nil or *ListInstalledAddOnParams - Optional Parameters:
* @param "PageSize" (int32) - How many resources to return in each list page. The default is 50, and the maximum is 1000.
* @return ListInstalledAddOnResponse
 */
func (c *DefaultApiService) ListInstalledAddOn(params *ListInstalledAddOnParams) (*ListInstalledAddOnResponse, error) {
	path := "/marketplace/InstalledAddOns"
...
* @param optional nil or *ListInstalledAddOnExtensionParams - Optional Parameters:
* @param "PageSize" (int32) - How many resources to return in each list page. The default is 50, and the maximum is 1000.
* @return ListInstalledAddOnExtensionResponse
 */
func (c *DefaultApiService) ListInstalledAddOnExtension(InstalledAddOnSid string, params *ListInstalledAddOnExtensionParams) (*ListInstalledAddOnExtensionResponse, error) {
 ...
 */
func (c *DefaultApiService) ListKey(FleetSid string, params *ListKeyParams) (*ListKeyResponse, error) {
	path := "/DeployedDevices/Fleets/{FleetSid}/Keys"
	path = strings.Replace(path, "{"+"FleetSid"+"}", FleetSid, -1)
...
* @param AssistantSid
* @param optional nil or *UpdateAssistantFallbackActionsParams - Optional Parameters:
...
* @param AssistantSid
* @param optional nil or *UpdateAssistantInitiationActionsParams - Optional Parameters:
...
* @param Sid
* @param optional nil or *UpdateAuthorizationDocumentParams - Optional Parameters:
* @param "AddressSid" (string) - A 34 character string that uniquely identifies the Address resource that is associated with this AuthorizationDocument.
* @param "CcEmails" ([]string) - Email recipients who will be informed when an Authorization Document has been sent and signed
* @param "ContactPhoneNumber" (string) - The contact phone number of the person authorized to sign the Authorization Document.
* @param "ContactTitle" (string) - The title of the person authorized to sign the Authorization Document for this phone number.
...
* @param FleetSid
* @param Sid Provides a 34 character string that uniquely identifies the requested Certificate credential resource.
* @param optional nil or *UpdateCertificateParams - Optional Parameters:
* @param "DeviceSid" (string) - Provides the unique string identifier of an existing Device to become authenticated with this Certificate credential.
* @param "FriendlyName" (string) - Provides a human readable descriptive text for this Certificate credential, up to 256 characters long.
* @return PreviewDeployedDevicesFleetCertificate
 */
...
* @param FleetSid
* @param Sid Provides a 34 character string that uniquely identifies the requested Deployment resource.
* @param optional nil or *UpdateDeploymentParams - Optional Parameters:
...
* @param FleetSid
* @param Sid Provides a 34 character string that uniquely identifies the requested Device resource.
* @param optional nil or *UpdateDeviceParams - Optional Parameters:
* @param "DeploymentSid" (string) - Specifies the unique string identifier of the Deployment group that this Device is going to be associated with.
* @param "Enabled" (bool) -
* @param "FriendlyName" (string) - Provides a human readable descriptive text to be assigned to this Device, up to 256 characters long.
* @param "Identity" (string) - Provides an arbitrary string identifier representing a human user to be associated with this Device, up to 256 characters long.
...
* @param Sid
* @param optional nil or *UpdateHostedNumberOrderParams - Optional Parameters:
...
* @param optional nil or *UpdateInstalledAddOnParams - Optional Parameters:
...
* @param optional nil or *UpdateInstalledAddOnExtensionParams - Optional Parameters:
