...
type ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile struct {
	...
	AddressRequirements  *IncomingPhoneNumberMobileAddressRequirement `json:"AddressRequirements,omitempty"`
	...
	EmergencyStatus      *IncomingPhoneNumberMobileEmergencyStatus    `json:"EmergencyStatus,omitempty"`
	...
	VoiceReceiveMode     *IncomingPhoneNumberMobileVoiceReceiveMode   `json:"VoiceReceiveMode,omitempty"`
