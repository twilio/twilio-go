...
------------ | ------------- | ------------- | -------------
**AvailablePhoneNumbers** | Pointer to [**[]ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine**](ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine.md) |  | [optional] 
...
### NewListAvailablePhoneNumberMachineToMachineResponse
...
### NewListAvailablePhoneNumberMachineToMachineResponseWithDefaults
...
GetAvailablePhoneNumbersOk returns a tuple with the AvailablePhoneNumbers field if it's non-nil, zero value otherwise
