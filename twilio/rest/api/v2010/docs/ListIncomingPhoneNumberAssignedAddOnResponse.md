...
------------ | ------------- | -------------
**AssignedAddOns** | Pointer to [**[]ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn**](ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn.md) |  | [optional] 
...
### NewListIncomingPhoneNumberAssignedAddOnResponse
...
### NewListIncomingPhoneNumberAssignedAddOnResponseWithDefaults
...
GetAssignedAddOns returns the AssignedAddOns field if non-nil, zero value otherwise.
...
GetAssignedAddOnsOk returns a tuple with the AssignedAddOns field if it's non-nil, zero value otherwise
...
SetAssignedAddOns sets AssignedAddOns field to given value.
