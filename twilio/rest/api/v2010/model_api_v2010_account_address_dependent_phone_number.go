...
type ApiV2010AccountAddressDependentPhoneNumber struct {
	...
	AddressRequirements  *DependentPhoneNumberAddressRequirement `json:"AddressRequirements,omitempty"`
	ApiVersion           *string                                 `json:"ApiVersion,omitempty"`
	Capabilities         *map[string]interface{}                 `json:"Capabilities,omitempty"`
	DateCreated          *string                                 `json:"DateCreated,omitempty"`
	DateUpdated          *string                                 `json:"DateUpdated,omitempty"`
	EmergencyAddressSid  *string                                 `json:"EmergencyAddressSid,omitempty"`
	EmergencyStatus      *DependentPhoneNumberEmergencyStatus    `json:"EmergencyStatus,omitempty"`
