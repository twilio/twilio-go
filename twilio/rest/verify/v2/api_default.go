...
//
// @param: "AuthPayload" (string) - Optional payload used to verify the Challenge upon creation. Only used with a Factor of type `totp` to carry an OTP used in the verification.
//
...
//
// @param: "ConfigAlg" (string) - The algorithm used to derive the TOTP codes. Can be `sha1`, `sha256` or `sha512`. Defaults to `sha1`
//
...
//
// @param: "ConfigCodeLength" (int32) - Number of digits for generated TOTP codes. Must be between 3 and 8, inclusive. The default value is defined at the service level in the property totp.code_length. If not configured defaults to 6
//
...
//
// @param: "ConfigSkew" (int32) - The number of time-steps, past and future, that are valid for validation of TOTP codes. Must be between 0 and 2, inclusive. The default value is defined at the service level in the property totp.skew. If not configured defaults to 1
//
// @param: "ConfigTimeStep" (int32) - Defines how often, in seconds, are TOTP codes generated. i.e, a new TOTP code is generated every time_step seconds. Must be between 20 and 60 seconds, inclusive. The default value is defined at the service level in the property totp.time_step. If not configured defaults to 30 seconds
//
// @param: "FactorType" (string) - The Type of this Factor. Currently `push` and `totp` are supported. For `totp` to work, you need to contact Twilio sales first to have the Verify TOTP feature enabled for your Twilio account.
//
