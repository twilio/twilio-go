...
* @param "ConfigCodeLength" (int32) - Number of digits for generated TOTP codes. Must be between 3 and 8, inclusive. Defaults to 6
...
* @param "ConfigSkew" (int32) - The number of time-steps, past and future, that are valid for validation of TOTP codes. Must be between 0 and 2, inclusive. Defaults to 1
