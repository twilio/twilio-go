...
type ProxyV1Service struct {
	...
	GeoMatchLevel           *ServiceGeoMatchLevel           `json:"GeoMatchLevel,omitempty"`
	InterceptCallbackUrl    *string                         `json:"InterceptCallbackUrl,omitempty"`
	Links                   *map[string]interface{}         `json:"Links,omitempty"`
	NumberSelectionBehavior *ServiceNumberSelectionBehavior `json:"NumberSelectionBehavior,omitempty"`
